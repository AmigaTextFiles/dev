...
LONG  __cmsBuildRGB2XYZtransferMatrix(LPMAT3 , LPcmsCIExyY , LPcmsCIExyYTRIPLE ) =
...
LONG  __cmsTakeCreationDateTime(struct tm *, cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-418(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsCloseProfile(cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-52(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsWhitePointFromTemp(int , LPcmsCIExyY ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-190(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIsTag(cmsHPROFILE , icTagSignature ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-430(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetPropertyHex(LCMSHANDLE , const char *, int ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-820(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetDataDbl(LCMSHANDLE , const char *, const char *, double ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-892(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIsIntentSupported(cmsHPROFILE , int , int ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-478(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetComment(LCMSHANDLE , const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-802(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetDataRowColDbl(LCMSHANDLE , int , int , double ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-868(12)\n"
	"\tmtlr\t0\n"
...
const UBYTE * __cmsTakeProfileID(cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-412(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsAddTag(cmsHPROFILE , icTagSignature , void *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-616(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsNamedColorInfo(cmsHTRANSFORM , int , char *, char *, char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-604(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsTakeColorants(LPcmsCIEXYZTRIPLE , cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-358(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsSmoothGamma(LPGAMMATABLE , double ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-310(12)\n"
	"\tmtlr\t0\n"
...
LONG  ___cmsSaveProfileToMem(cmsHPROFILE , void *, size_t *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-640(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetDataRowCol(LCMSHANDLE , int , int , const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-862(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsTakeCalibrationDateTime(struct tm *, cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-424(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetPropertyUncooked(LCMSHANDLE , const char *, const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-826(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SaveToFile(LCMSHANDLE , const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-784(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsAdaptToIlluminant(LPcmsCIEXYZ , LPcmsCIEXYZ , LPcmsCIEXYZ , LPcmsCIEXYZ ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-196(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsTakeIluminant(LPcmsCIEXYZ , cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-352(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetData(LCMSHANDLE , const char *, const char *, const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-886(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetSheetType(LCMSHANDLE , const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-796(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsTakeMediaWhitePoint(LPcmsCIEXYZ , cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-340(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetPropertyDbl(LCMSHANDLE , const char *, double ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-814(12)\n"
	"\tmtlr\t0\n"
...
LONG  ___cmsSaveProfile(cmsHPROFILE , const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-634(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsTakeCharTargetData(cmsHPROFILE , char **, size_t *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-442(12)\n"
	"\tmtlr\t0\n"
...
void  __cmsEvalLUT(LPLUT , UWORD *, UWORD *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-712(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetPropertyStr(LCMSHANDLE , const char *, const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-808(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsIT8SetDataFormat(LCMSHANDLE , int , const char *) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-904(12)\n"
	"\tmtlr\t0\n"
...
LONG  __cmsTakeMediaBlackPoint(LPcmsCIEXYZ , cmsHPROFILE ) =
	"\tlis\t11,LittleCMSBase@ha\n"
	"\tlwz\t12,LittleCMSBase@l(11)\n"
	"\tlwz\t0,-346(12)\n"
	"\tmtlr\t0\n"
