...
void ScintillaBase::AutoCompleteStart(int lenEntered, const char *list) {
	...
	QSPoint pt = LocationFromPosition(sel.MainCaret() - lenEntered);
...
void ScintillaBase::CallTipShow(QSPoint pt, const char *defn) {
	ac.Cancel();
	pt.y += vs.lineHeight;
...
void ScintillaBase::ContextMenu(QSPoint pt) {
	if (displayPopupMenu) {
...
void ScintillaBase::ButtonDown(QSPoint pt, unsigned int curTime, bool shift, bool ctrl, bool alt) {
	CancelModes();
