...
//    Some optimisations
#define HEX_8000_DIV_EIGHT_MUL_FOURTEEN 896//(57344*4)   //0x8000 / 8 * 14
#define HEX_1000_MUL_ONE_POINT_SEVEN 6963.2     //0x1000 * 1.7
#define HEX_1000_MUL_ZERO_POINT_SEVEN_THREE 2990.08      //0x1000 * 0.73
#define HEX_TEN_THOUSAND_MUL_HEX_TEN_THOUSAND 0x10000*0x10000//4294967296
#define UPDATE_576 567000.0                      //576.0 * 1000.0
#define UPDATE_128 128000.0                      //128.0 * 1000.0
#define UPDATE_64 64000.0                        //64.0 * 1000.0
#define SEVEN_DIV_EIGHT 0.875                    //7/8
#define ADD_FOUR_ADD_EIGHTEEN +22                //+4+18
#define EIGHTEEN_DIV_THIRTY_TWO 0.5625           //18/32
#define SIXTEEN_MUL_EIGHTEEN 288                 //16*18
#define SIXTEEN_DIV_FOURTEEN 1.1428571428571428571428571428571  //16/14
#define EIGHT_MUL_EIGHT      64                  //8*8
#define FOURTEEN_DIV_EIGHT 1.75//14/8
...
typedef struct {
	...
	short chanbuf[HEX_8000_DIV_EIGHT_MUL_FOURTEEN];
