...
/* Amiga - this is nasty workaround for 'ixemul' 'fopen()' that 
 * distinguishes between "/doesnotexist" == 6 and "doesnotexist" == 2, 
 * this is the main reason for most proggies to fail, cuz they mosty 
 * expect error code 2 == ENOENT. Im however afraid that this may
 * fix one problem and cause another, but for now lets deal with
 * that this way...
*/
  if (err == ENXIO)
  {
