...
#  define _Locale_CNTRL 040
#  define _Locale_UPPER 01
#  define _Locale_LOWER 02
#  define _Locale_DIGIT 04
#  define _Locale_XDIGIT (_Locale_DIGIT | 0100)
#  define _Locale_PUNCT 020
#  define _Locale_SPACE 010
#  define _Locale_PRINT (_Locale_PUNCT | _Locale_UPPER | _Locale_LOWER | _Locale_DIGIT | 0200)
#  define _Locale_ALPHA (_Locale_UPPER | _Locale_LOWER)
