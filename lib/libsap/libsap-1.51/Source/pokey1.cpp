...
POKEY_WRITE_FUNC
{
	...
	switch( address )
	{
		...
		case 0x01:
			...
			Channel0Distortion = channelsDistorionTable0[ (value>>5)&7 ];
			if( !(value&0x10) )
				SetupChannels01;
			break;
		case 0x02:
		...
		case 0x03:
			...
			Channel1Distortion = channelsDistorionTable1[ (value>>5)&7 ];
			if( !(value&0x10) )
				SetupChannels01;
			break;
		case 0x04:
		...
		case 0x05:
			...
			Channel2Distortion = channelsDistorionTable2[ (value>>5)&7 ];
			if( !(value&0x10) )
				SetupChannels23;
			break;
		case 0x06:
		...
		case 0x07:
			...
			Channel3Distortion = channelsDistorionTable3[ (value>>5)&7 ];
			if( !(value&0x10) )
				SetupChannels23;
			break;
		case 0x08:
