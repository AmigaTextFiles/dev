...
#if CAIRO_HAS_AROS_SURFACE
    { "aros", CAIRO_SURFACE_TYPE_AROS, CAIRO_CONTENT_COLOR, 0,
      _cairo_boilerplate_aros_create_surface,
      cairo_surface_write_to_png,
      _cairo_boilerplate_aros_cleanup},
    { "aros", CAIRO_SURFACE_TYPE_AROS, CAIRO_CONTENT_COLOR_ALPHA, 0,
      _cairo_boilerplate_aros_create_surface,
      cairo_surface_write_to_png,
      _cairo_boilerplate_aros_cleanup},
};
