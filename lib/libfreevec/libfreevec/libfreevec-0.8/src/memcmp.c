...
inline int memcmp(void *src1pp, const void *src2pp, size_t len) {
    ...
    if (len < sizeof(uint32_t)) {
        ...
        if (len >= ALTIVECWORD_SIZE) {
            ...
            if (((uint32_t)(src2) % 16) == 0) {
                ...
                MYMEMCMP_SINGLE_ALTIVEC_WORD_ALIGNED(src1, src1l, src2, src2l, src2offset4);
                src1l += 4;
                ...
                MYMEMCMP_SINGLE_ALTIVEC_WORD_UNALIGNED(src1, src1l, src2, src2l, src2offset4);
                src1l += 4;
                src2 += ALTIVECWORD_SIZE;
                len -= ALTIVECWORD_SIZE;
                src2l = (uint32_t *)(src2 -src2offset4);
        ...
        if (len >= 4*ALTIVECWORD_SIZE) {
            if (((uint32_t)(src2) % ALTIVECWORD_SIZE) == 0) {
                MYMEMCMP_LOOP_QUADWORD_ALTIVEC_ALIGNED(src1, src1l, src2, src2l, src2offset4);
                src2l = (uint32_t *)(src2 -src2offset4);
            } else {
                MYMEMCMP_LOOP_QUADWORD_ALTIVEC_UNALIGNED(src1, src1l, src2, src2l, src2offset4);
                src2l = (uint32_t *)(src2 -src2offset4);
            }
        }
        if (len >= ALTIVECWORD_SIZE) {
