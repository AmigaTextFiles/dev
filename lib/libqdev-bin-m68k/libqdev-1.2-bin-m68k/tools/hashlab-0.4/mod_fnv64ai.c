 ...
 * mod_fnv64ai.hl
 *
 * I must say that even forced 32bit hashing is very strong in
 * this routine! Its simply the best!
*/

#define MOD_XXX_VERSION    5
#define MOD_XXX_REVISION   0
#define MOD_XXX_STRING     "mod_fnv64ai.hl"
...
LONG _HASHLAB_MODULERFUNC(void *ptr, VUQ128 *vu, UBYTE *str)
{
  ...
  txt_fnv64ihash((VUQUAD *)&vu->vulo_hi, str);
