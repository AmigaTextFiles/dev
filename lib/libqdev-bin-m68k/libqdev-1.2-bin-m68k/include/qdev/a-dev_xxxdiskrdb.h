 ...
 * --- VERSION --------------------------------------------------------
 *
 * $VER: a-dev_xxxdiskrdb.h 1.00 (26/12/2010)
 * AUTH: megacz
 *
 * --- COMMENT --------------------------------------------------------
 *
...
#ifndef ___XXXDISKRDB_H_INCLUDED___
#define ___XXXDISKRDB_H_INCLUDED___

#define QDEV_DEV_PRV_RDBBUFLEN (RDB_LOCATION_LIMIT * 512)

#endif /* ___XXXDISKRDB_H_INCLUDED___ */
