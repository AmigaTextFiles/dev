 ...
 * --- VERSION --------------------------------------------------------
 *
 * $VER: a-dos_xxxdevice.h 1.03 (22/09/2011)
 * AUTH: megacz
 *
 * --- COMMENT --------------------------------------------------------
 *
...
#ifndef ___XXXDEVICE_H_INCLUDED___
#define ___XXXDEVICE_H_INCLUDED___

#define QDEV_DOS_PRV_NAMELEN 32



struct dos_mde_wrap
{
  struct DosList mw_dol;                        /* DosList wrapped          */
  UBYTE          mw_name[QDEV_DOS_PRV_NAMELEN]; /* Name of the handler      */
};

#endif /* ___XXXDEVICE_H_INCLUDED___ */
