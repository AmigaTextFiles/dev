 ...
 * --- VERSION --------------------------------------------------------
 *
 * $VER: a-nfo_waitback.h 1.02 (22/12/2010)
 * AUTH: megacz
 *
 * --- COMMENT --------------------------------------------------------
 *
...
#ifndef ___WAITBACK_H_INCLUDED___
#define ___WAITBACK_H_INCLUDED___

#define QDEV_NFO_PRV_WBKONESEC     50
#define QDEV_NFO_PRV_WBKLOOPDLY    10
#define QDEV_NFO_PRV_WBKTIMEFCT     \
       (QDEV_NFO_PRV_WBKONESEC /    \
        QDEV_NFO_PRV_WBKLOOPDLY)

#endif /* ___WAITBACK_H_INCLUDED___ */
