 ...
 * --- VERSION --------------------------------------------------------
 *
 * $VER: i-txt_quickhash.h 1.00 (25/12/2010) QHASH
 * AUTH: megacz
 *
 * --- COMMENT --------------------------------------------------------
 *
...
#ifndef ___QUICKHASH_H_INCLUDED___
#define ___QUICKHASH_H_INCLUDED___

#define QDEV_TXT_PRV_HASHBASE  37

#endif /* ___QUICKHASH_H_INCLUDED___ */
