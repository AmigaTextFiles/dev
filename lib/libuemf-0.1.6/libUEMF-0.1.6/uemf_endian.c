...
PU_EMRSETPIXELV pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSETPIXELV)(record);
...
PU_EMRSETMAPPERFLAGS pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSETMAPPERFLAGS)(record);
...
PU_EMRSETCOLORADJUSTMENT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSETCOLORADJUSTMENT)(record);
...
PU_EMRSETWORLDTRANSFORM pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSETWORLDTRANSFORM)(record);
...
PU_EMRMODIFYWORLDTRANSFORM pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRMODIFYWORLDTRANSFORM)(record);
...
PU_EMRSELECTOBJECT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSELECTOBJECT)(record);
   U_swap4(&(pEmr->ihObject),1);            // ihObject
} 

// U_EMRCREATEPEN            38
void U_EMRCREATEPEN_swap(char *record, int torev){
PU_EMRCREATEPEN pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRCREATEPEN)(record);
...
PU_EMRCREATEBRUSHINDIRECT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRCREATEBRUSHINDIRECT)(record);
...
PU_EMRDELETEOBJECT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRDELETEOBJECT)(record);
   U_swap4(&(pEmr->ihObject),1);            // ihObject
} 
...
PU_EMRROUNDRECT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRROUNDRECT)(record);
   rectl_swap(&(pEmr->rclBox),1);           // rclBox
...
PU_EMRCREATEPALETTE pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRCREATEPALETTE)(record);
...
PU_EMRSETPALETTEENTRIES pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSETPALETTEENTRIES)(record);
...
PU_EMREXTFLOODFILL pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMREXTFLOODFILL)(record);
...
void U_EMRPOLYDRAW16_swap(char *record, int torev){
   int count=0;
   PU_EMRPOLYDRAW16 pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRPOLYDRAW16)(record);
   if(torev){
      count = pEmr->cpts;
   }
   rectl_swap(&(pEmr->rclBounds),1);        // rclBounds
...
PU_EMREXTCREATEPEN pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMREXTCREATEPEN)(record);
   if(torev && pEmr->cbBmi){
...
PU_EMRCREATECOLORSPACE pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRCREATECOLORSPACE)(record);
...
PU_EMRPIXELFORMAT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRPIXELFORMAT)(record);
...
void U_EMRSMALLTEXTOUT_swap(char *record, int torev){
   int roff=0;
   int fuOptions=0;
   PU_EMRSMALLTEXTOUT pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRSMALLTEXTOUT)(record);
   if(torev){
...
void U_EMRGRADIENTFILL_swap(char *record, int torev){
   ...
   int nGradObj=0;
   int ulMode=0;
   PU_EMRGRADIENTFILL pEmr;
   core5_swap(record, torev);
  pEmr = (PU_EMRGRADIENTFILL)(record);
   if(torev){
...
PU_EMRCREATECOLORSPACEW pEmr;
   core5_swap(record, torev);
   pEmr = (PU_EMRCREATECOLORSPACEW)(record);
   U_swap4(&(pEmr->ihCS),1);                // ihCS
