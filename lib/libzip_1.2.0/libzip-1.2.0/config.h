...
#define SIZEOF_LONG sizefo(long)

/* The size of `long long', as computed by sizeof. */
#undef SIZEOF_LONG_LONG sizeof(long long)

/* The size of `off_t', as computed by sizeof. */
#undef SIZEOF_OFF_T sizeof(off_t)

/* The size of `short', as computed by sizeof. */
#undef SIZEOF_SHORT sizeof(short)

/* The size of `size_t', as computed by sizeof. */
#undef SIZEOF_SIZE_T sizeof(size_t)
