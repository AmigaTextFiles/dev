...
\+& |typedef_like| |exp| |cast| |semi| & |decl|\hfill$T\.\ EC$ &
\&{typedef} \&{int}$(*x)()$\cr
\+& |typedef_like| |int_like| |decl| & |decl|\hfill$T\. ID$ &
\&{typedef} \&{int} $(*x)(\&{\#if}$\cr
\+& |typedef_like| |exp| |exp| |lpar| & |exp| |lpar|\hfill$T\.\ E\.\ E$  &
\&{typedef} \&{void} $(*x)(\,)$\cr
\+& |int_like| |base| |int_like| |lbrace| & |exp| |lbrace|\hfill
$E=I\.\ B\.\ I$ & \&D : \&C $\{$\cr
\+& |int_like| |lproc| & |lproc|\hfill & \&{shared} {\bf\#include}\cr
\yskip
\yskip
\yskip
\parindent=0pt
