...
#pragma tagcall(DOSBase, 0xe4, AllocDosObjectTags(d1,d2)) // New
...
#pragma tagcall(DOSBase, 0x15c, FWritef(d1,d2,d3)) // New
#pragma amicall(DOSBase, 0x162, VFPrintf(d1,d2,d3))
#pragma tagcall(DOSBase, 0x162, FPrintf(d1,d2,d3)) // New
...
#pragma tagcall(DOSBase, 0x1f2, CreateNewProcTags(d1)) // New
...
#pragma tagcall(DOSBase, 0x25e, SystemTags(d1,d2)) // New
...
#pragma tagcall(DOSBase, 0x300, NewLoadSegTags(d1,d2)) // New
...
#pragma tagcall(DOSBase, 0x3ba, Printf(d1,d2)) // New
