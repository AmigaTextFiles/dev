...
/*
**  $VER: graphics_lib.h 10.2 (29.12.95)
...
#pragma tagcall(GfxBase, 0x2c4, VideoControlTags(a0,a1)) // New
...
#pragma tagcall(GfxBase, 0x324, WeighTAMatchTags(a0,a1,a2)) // New
#pragma amicall(GfxBase, 0x32a, EraseRect(a1,d0,d1,d2,d3))
#pragma amicall(GfxBase, 0x330, ExtendFont(a0,a1))
#pragma tagcall(GfxBase, 0x330, ExtendFontTags(a0,a1)) // New
...
#pragma tagcall(GfxBase, 0x348, ObtainBestPen(a0,d1,d2,d3,a1)) // New
...
#pragma tagcall(GfxBase, 0x3a2, GetExtSprite(a2,a1)) // New
...
#pragma tagcall(GfxBase, 0x3fc, AllocSpriteData(a2,a1)) // New
#pragma amicall(GfxBase, 0x402, ChangeExtSpriteA(a0,a1,a2,a3))
#pragma tagcall(GfxBase, 0x402, ChangeExtSprite(a0,a1,a2,a3)) // New
#pragma amicall(GfxBase, 0x408, FreeSpriteData(a2))
#pragma amicall(GfxBase, 0x40e, SetRPAttrsA(a0,a1))
#pragma tagcall(GfxBase, 0x40e, SetRPAttrs(a0,a1)) // New
#pragma amicall(GfxBase, 0x414, GetRPAttrsA(a0,a1))
#pragma tagcall(GfxBase, 0x414, GetRPAttrs(a0,a1)) // New
#pragma amicall(GfxBase, 0x41a, BestModeIDA(a0))
#pragma tagcall(GfxBase, 0x41a, BestModeID(a0)) // New
#pragma amicall(GfxBase, 0x420, WriteChunkyPixels(a0,d0,d1,d2,d3,a2,d4)) // New in V40
