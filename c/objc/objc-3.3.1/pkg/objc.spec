...
%prep
%setup -q
# Setup makefiles, take care of lib64
...
HDRDIR=$RPM_BUILD_ROOT%{_includedir}

rm -rf $RPM_BUILD_ROOT
mkdir -p $INSTALLDIR
mkdir -p $MANDIR
make INSTALLDIR=$INSTALLDIR BINDIR=$BINDIR LIBDIR=$LIBDIR MANDIR=$MANDIR HDRDIR=$HDRDIR install
...
%{_bindir}/cvtimport
%{_bindir}/postlink
%{_prefix}/lib/objcrt.a
%{_prefix}/lib/objpak.a
%{_prefix}/lib/cakit.a
%{_prefix}/lib/_prelink.o
%{_prefix}/lib/_predll.o
%{_prefix}/lib/objchelp.txt
%{_prefix}/lib/objcdlso.ld
