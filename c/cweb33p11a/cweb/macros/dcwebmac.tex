...
% For German users this may be a convenience.
% Comment the next two lines if you don't have it.
\input german.sty
...
% save current category code of `@'.  This code becomes active only
% when `german.sty' is not loaded at the beginning of this file.
\ifx\germanTeX\else
