								-*-Web-*-
This file, CWEBMANA.CH, is part of CWEB (Version 3.3 [p11]).  It is a
changefile written by Andreas Scherer for CWEBMAN.TEX, Version 3.3, that
...
Run WMERGE with masterfile CWEBMAN.TEX and changefile CWEBMANA.CH
...
a14	03 Dec 1994	AS	Update for CWEB 3.3.
------------------------------------------------------------------------------
...
@y
\def\runninghead{{\tentt CWEB} USER MANUAL (VERSION 3.3 [p11])}
@z
------------------------------------------------------------------------------
@x l.51
\vskip 18pt\centerline{(Version 3.0)}
@y
\vskip 18pt\centerline{(Version 3.3 [p11])}
@z
------------------------------------------------------------------------------
@x l.60
...
@y
  \.{ { }\\vskip 15pt \\centerline\{(Version 3.3 [p11])\}{ }\\vfill\}}\cr}$$
@z
------------------------------------------------------------------------------
