%
% CWEB $VER: cct.w 1.3 (24.8.1994)
%
% SYNOPSIS: This CWEB file contains two programs!  The first program `cct'
% is a simple tool for translating `text files' between various systems
% with different `character code tables'.  The second program `cctsetup'
...
\TEX/ macro files \.{ecma94.tex}, \.{hp8.tex}, \.{mac8.tex}, and
\.{pc850.tex} in the \.{macros} subdirectory of \.{CWEB}.  There may
...
are supported, just as in \.{ecma94.tex}.
