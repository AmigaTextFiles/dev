								-*-Web-*-
This file, CWEBMANA.CH, is part of CWEBBIN (Version 3.4 [p12]).  It is a
changefile written by Andreas Scherer for CWEBMAN.TEX, Version 3.4, that
...
@y
\def\runninghead{{\tentt CWEB} USER MANUAL (VERSION 3.4 [p13])}
@z
------------------------------------------------------------------------------
@x l.51
\vskip 18pt\centerline{(Version 3.0)}
@y
\vskip 18pt\centerline{(Version 3.4 [p13])}
@z
------------------------------------------------------------------------------
@x l.873
...
@y
  \.{ { }\\vskip 15pt \\centerline\{(Version 3.4 [p13])\}{ }\\vfill\}}\cr}$$
@z
------------------------------------------------------------------------------
