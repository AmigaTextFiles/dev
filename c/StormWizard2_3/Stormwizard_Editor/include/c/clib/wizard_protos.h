...
LONG WZ_EasyRequest(APTR surface,struct Window *win,ULONG id,Tag Tag1, ...);
...
struct Gadget *WZ_NewObjectA(APTR surface, ULONG clas, struct TagItem *tags);
struct Gadget *WZ_NewObject(APTR surface, ULONG clas, Tag Tag1, ... );
