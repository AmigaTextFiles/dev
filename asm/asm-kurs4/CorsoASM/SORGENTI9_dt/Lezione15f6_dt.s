...
; Lezione15f6.s		Drücken Sie die rechte Taste, um BRDRSPRT zu aktivieren
				; was die Visualisierung des Sprites außerhalb des Videofensters
				; ermöglicht, absichtlich enger definiert als normal.
...
Waity1:
	...
	move.w	sprite_y(pc),d0		; Parameter der universellen Routine
	move.w	sprite_x(pc),d1		; vorbereiten
	lea	MIOSPRITE64,a1			; Adresse sprite
	moveq	#52,d2				; Höhe sprite
	bsr.w	UniMuoviSprite64F	; ruft die universelle Routine auf
...
Aspetta:
	...
	bne.s	NonScambiareRes		; Wenn nicht, ändern Sie nicht

	bchg.b	#1,BplCon3			; Wenn ja, ändern Sie das BRDRSPRT.
...
Stellen Sie einfach das magische Bit ein und die Sprites können sich wirklich 
unabhängig vom Bildschirm bewegen, da sie am Ende des Videofenster nicht
"geschnitten" werden und angezeigt werden, auch wenn die Bitebenen deaktiviert
sind! Eine Befreiung der Sprites von der Sklaverei von bplcon0 und 
diwstart / diwstop!