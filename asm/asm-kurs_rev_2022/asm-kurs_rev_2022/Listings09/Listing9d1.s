...
; Listing9d1.s	 SCHLEIFE MIT EINEM BLITT VON 6 ZEILEN HÖHE UND MODULO
...
START:
	...
	;move.w	#(150-6)-1,d7		; -6 weil die Figur 6 Zeilen hoch ist,
								...
								; wo es stehen bleibt.
	move.w	#150,d7				; AdÜ: nicht verwirren lassen...
...
;	 /__I__\
	...
	move.l	a0,$54(a5)			; BLTDPT  (Ziel: Zeilen des Bildschirms)
...
In diesem Listing sehen wir ein Beispiel für Animationen mit dem Blitter.
Ganz einfach: Sie zeichnen die Figur mit dem Blitter bei jedem vertical blank
immer an einer Stelle tiefer und tiefer.
Die Position der Figur wird durch die Adresse bestimmt, die in das
BLTDPT-Register geschrieben wird. Beachten Sie, dass der Wert der in dieses
Register geschrieben wird mit jedem frame geändert wird:
...
Die Figur "zieht eine Spur", weil wir die Figur nicht jedes Mal löschen.
