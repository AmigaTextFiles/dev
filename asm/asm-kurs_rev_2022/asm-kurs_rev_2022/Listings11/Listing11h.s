...
nonSwappare:
	bsr.w	PrintCarattere		; Druckejeweils ein Zeichen
...
makecop:
	...
	and.w	#$00f,d4			; Wähle nur die BLAUE Komponente
	cmp.w	#$00f,d4			; ist es maximal?
	beq.S	endcop				; wenn ja, endcop!
	move.w	d2,d4				; Ansonsten sehen wir das Grün:
	and.w	#$0f0,d4			; Wähle nur die grüne Komponente.
	cmp.w	#$0f0,d4			; ist es maximal?
	beq.S	endcop				; wenn ja, endcop!
	move.w	d2,d4
	and.w	#$f00,d4			; Wähle nur die rote Komponente.
...
PRINTcarattere:
	...
	beq.s	FineTesto			; Wenn ja, beende ohne zu drucken
...
TESTO:	     ;		  1111111111222222222233333333334
	...
	dc.b	'                                        ',0 ; 13
	dc.b	'    basta cambiare solo la cop2 a cui   ',0 ; 14	ändere einfach den cop2 an dem
	dc.b	'                                        ',0 ; 15
	dc.b	'    puntare ogni frame, per DynamiCop!  ',0 ; 16   Punkt in jeden frame, für DynamiCop!
	dc.b	'                                        ',0 ; 17
...
BPLPOINTERS:
	...
	dc.w	$180,COLSTART		; COLOR0 - Farbe "Anfang"
