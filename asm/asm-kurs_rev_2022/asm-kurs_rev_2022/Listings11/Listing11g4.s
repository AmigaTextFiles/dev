...
; Diese Routine fügt Farben zyklisch aus der Tabelle in die beiden Zeilen 
...
; Zeit zum Lesen von 4 Pixel pro Word benötigt, das heißt 8 Pixel für jede 
...
; Theoretisch würden wir einen 54 * 8 = 432 Pixel breiten (Monitor erlaubt)
; machen. Beachten Sie, dass wir uns auf 8 Pixel LOWRES beziehen. Bei HIRES
; bleibt die Größe unverändert und erscheint natürlich in 16 Pixel Abstand.
; 
; 
...
LineCop:
	lea	TabellaColori(PC),a0	; Adresse Farbtabelle
	lea	FineTabColori(PC),a3	; Ende Farbtabelle
...
CSalta:
	...
	move.l	#FineTabColori-TabellaColori,ColBarraBassOffset ; andernfalls
								...
								; (seit diese Bar rückwärts fließt!)
	lea	FineTabColori-2(PC),a3
MettiColori:
	addq.w	#2,a1				; überspringe die dc.w $180
	addq.w	#2,a2				; überspringe die dc.w $180
