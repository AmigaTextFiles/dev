...
ClearScreen:
	lea	BITPLANE4+100*40,a1		; Adresse Bereich der gelöscht werden soll
								; (Bitebene 4)
...
Colours:
	dc.w	$0180,$000			; Farben von 0-7 alle dunkel. Auf diese Weise werden
								...
								; der entworfenen Maske dunkler gefärbt
...
Bitebene bewegt, als wäre es ein Bob. Es wird auf einer Bitebene getrennt 
von der Abbildung gezeichnet. Wir müssen uns nicht um den Hintergrund
kümmern. Es ist im Grunde derselbe Trick, wie der in Listing9i4.s, das 
...
die Palette der 3-farbigen Figur, das heißt, die Werte, die wir normalerweise
in die COLOR00-COLOR07-Register schreiben würden. Sie werden diesmal in den
...
Weise werden die Pixel des Bildes, über die vierte Bitebene eingestellt.
Bei 0 erscheinen sie alle dunkler (wir könnten sie alle sogar schwarz machen).
...
Nachteil: Wir verwenden 4 Bitebenen für ein 8-Farben-Bild. Im nächsten
Beispiel werden wir sehen, wie dieses Problem vermieden werden kann.