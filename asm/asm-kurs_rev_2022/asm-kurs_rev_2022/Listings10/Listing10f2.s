...
In diesem Beispiel lösen wir das Problem des Beispiels Listing10f1.s durch
...
der 2 Puffer sind in 2 Variablen enthalten. Die Variable draw_buffer enthält
die Adresse des Puffers, der zum Zeichnen verwendet wird. Die Routinen, die
den Bildschirm ändern (Bildschirm löschen und Objekt zeichnen) lesen die
Pufferadresse aus draw_buffer und führen ihre Operationen darauf aus. Die
Variable view_buffer enthält die aktuelle Pufferadresse die angezeigt wird.
...
wird (der, dessen Adresse in view_buffer gespeichert ist). In der Tat, um
...
blank modifiziert wird, was von der ScambiaBuffer-Routine erledigt wird.
