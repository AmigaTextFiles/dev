...
; Listing10c1.s		BLITT, in dem wir die Maske einer Zeichnung aufbauen
		; abwechselnd die Maustasten drücken, um die Blitts zu sehen
...
;****************************************************************************
; Diese Routine führt ein ODER zwischen der Quelle und dem Ziel durch. Wir
; verwenden die Kanäle B, C und D. Die Quelle wird über den Kanal C gelesen.
...
der Ebenen der Figur durchzuführen. In diesem Beispiel führen wir diese
...
einfachen Kopie der ersten Ebene der Figur. Als zweiten Schritt führen wir das
ODER zwischen der zweiten Ebene und dem Ziel durch. Das Ziel enthält die erste
Ebene. In der Praxis führen wir ein OR zwischen der Ebene 1 und der Ebene 2
aus. Als dritten Schritt führen wir das ODER zwischen der Ebene 3 und dem Ziel
durch. Das Ziel enthält das OR von Ebene 1 und Ebene 2. Als Ergebnis erhalten
wir das OR aller 3 Ebenen. Wenn wir eine Figur mit mehr als 3 Ebenen hätten,
hätten wir das gleiche Verfahren auch für die anderen Bitebenen wiederholen
müssen. Der Blitt wird mit 3 Kanälen gemacht. Die Ebenen der Figur werden durch
den Kanal C gelesen, stattdessen wird das Ziel durch den Kanal B gelesen und
dann über den Kanal D neu geschrieben. Der LF-Wert wird berechnet für das ODER
der Kanäle B und C.