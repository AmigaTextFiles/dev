...
; Parameter für die Routine Hintergrund wiederherstellen
	...
	bsr.s	Animazione			; verschiebt die frames in der Tabelle
...
; Blitter Modulo Berechnung
	...
	addq.w	#2,d0				; Blitt ist ein größeres Wort
...
; Er hat die gleichen Abmessungen wie ein Blitt: Höhe 30 Zeilen,
...
In diesem Beispiel präsentieren wir eine universelle Routine zum Zeichnen von
Bobs. Die Routine behandelt Bobs unterschiedlicher Größe. Die Position, die
Dimension und die Adressen der Figur und der Bobmaske werden als Parameter
übergeben. Basierend auf den Parametern werden alle Werte berechnet, die in die
...
Wiederherstellungsroutinen des Hintergrunds geändert, um veränderliche
Rechtecke zu bearbeiten. Achten Sie darauf, dass der von Ihnen verwendete
Rettungspuffer der Routine groß genug ist, um das Rechteck aufzunehmen. Mit
diesen Routinen ist es möglich, einen animierten Bob in Kombination mit der
...
teilweise einnimmt. Für den Rest wird es zurückgesetzt.