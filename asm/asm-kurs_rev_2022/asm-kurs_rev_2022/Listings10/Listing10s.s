...
; Listing10s.s		Korrektes Füllen eines geschlossenen Polygons
...
In diesem Beispiel sehen wir, wie das Problem der geschlossenen Linien gelöst
werden kann. Wie wir in der Lektion erklärt haben, ändern wir die 
...
um den Verfolgungseffekt aufzuheben. Zu diesem Zweck sind weitere Berechnungen
zur Ermittlung der Bitanzahl und der richtige Adresse notwendig. Tatsächlich
arbeitet das BCHG im Gegensatz zum Blitter mit einem Byte. Wenn nötig, müssen
Sie auf das untere Byte des Wortes von der Adresse zeigen. Desweiteren ist es
auch notwendig (mit dem NOT) die Bitnummerierung zu invertieren, weil das BCHG
die Bits von rechts nach links nummeriert. Stattdessen werden die Koordinaten
von links nach rechts nummeriert. Die anderen Routinen sind identisch.