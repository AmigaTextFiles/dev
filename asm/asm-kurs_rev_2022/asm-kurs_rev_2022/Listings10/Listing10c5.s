...
; Listing10c5.s		Reflektoreffekt auf interleaved Bildschirm
...
ClearScreen:
	lea	BITPLANE1+100*40*5,a1	; Adresse Bereich der gelöscht werden soll
...
WBlit1:
	...
	move.w	#(64*39*5)+20,$58(a5)	; BLTSIZE (Blitter starten !)
	rts
...
WBlit2:
	...
	move.w	#(64*39*5)+4,$58(a5)	; BLTSIZE (Blitter starten!)
								; Breite 4 word, Höhe 39 Zeilen, 5 planes
	rts						
...
Figura:
	incbin	"/Sources/lava320x56x5.rawblit"

;*****************************************************************************

; Dies ist die Maske. Im interleaved Format bestehend aus 5 Bitebenen
...
In diesem Beispiel realisieren wir den "Reflektor"-Effekt mit einem interleaved
Bildschirm. Die Technik ist die gleiche wie im Listing10c4.s. Der einzige
Unterschied ist dieses Mal, das wir einen interleaved Bildschirm verwenden.
Daher können wir die Ebene zusammen blitten. Diese Tatsache (die wie wir
wissen, die Geschwindigkeit erhöht) schafft uns aber Probleme mit der Maske. In
der Tat, wenn wir alle Ebenen in einem abarbeiten, brauchen wir eine Maske für
jede Ebene. In diesem Fall besteht unsere Maske aus 5 Bitebenen die alle gleich
sind. Da es interleaved ist, würde man die Maske einer Bitebene nehmen und jede
Reihe 5 mal wiederholen. In diesem Fall zwingt uns also das interleaved Format
eine Maske aus 5 Ebenen zu verwenden, die mehr Speicherplatz beansprucht als
eine Maske aus einer einzigen Bitebene. 
