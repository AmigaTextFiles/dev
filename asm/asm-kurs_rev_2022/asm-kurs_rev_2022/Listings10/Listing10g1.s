...
; Parameter für das Zeichnen von Routinen
	...
	bsr.s	BlitRett			; die Zeichenroutine ausführen
...
zu zeichnen. Das heißt mit einem sich wiederholenden grafischen Muster. Wir
benutzen eine Routine mit Parameterübergabe, die ein Rechteck zeichnet, mit den
...
von X (die Höhe) einem Vielfachen von 16 angenähert. 
Das "Muster" wird auch als Parameter in einem Register übergeben. Auf diese
Weise können wir alle "Muster", die wir wollen mit nur einer Routine zeichnen.
...
Sie müssen den gleichen LF-Wert verwenden, der auch bei der normalen Kopie von
A nach D verwendet wird, aber Sie müssen Kanal A nicht aktivieren. Daher ist
...
in die Ausgabe kopiert wird, wird in das Register BLTADAT geschrieben.