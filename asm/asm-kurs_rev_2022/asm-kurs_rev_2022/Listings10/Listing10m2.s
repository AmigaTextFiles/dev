...
; Listing10m2.s		Universalroutine Bob - Version interleaved
...
; Berechnung Dimension Blitt
	...
	mulu	#2,d3				; Multipliziere die Höhe mit der Anzahl der Ebenen
								; (für interleaved Bildschirm)
								; In diesem Fall haben wir 2 Bitplanes
								; Man könnte ASL benutzen, aber im Allgemeinen
								; (zB 3 Bitplanes) muss das MULU benutzt werden
...
; Er hat die gleichen Abmessungen wie eine Blitt: Höhe 30 Zeilen, 
; Breite 3 Wörter, 2 Bitebenen
...
Zeichnen von Bobs. Das Programm ist mit Listing10m1.s identisch mit dem
Unterschied das ein rawblit Bildschirm verwendet wird und als Ergebnis, wie Sie
wissen, ändern sich die Formeln für die Berechnung von Werten, die in die
Registern geschrieben werden müssen ein wenig.
In diesem Fall verwenden wir kein Hintergrundbild, welches die Routinen
speichern und wiederherstellen. Sie können sich ein Hintergrundbild (in
Rawblit-Version) zeichnen und es sich ohne es zu ändern in die Quelle legen!
