...
; Listing10e6.s		Optimierte Version von Listing10c4.s (Reflektoreffekt)
...
;***************************************************************************
; Diese Routine löscht den Teil des Bildschirms, der von dem Blitt
; betroffen ist
;***************************************************************************
...
WBlit2b:
	...
	add.w	#56*40,a0			; Adresse nächste bitplane Figur
	add.w	#256*40,a1			; Adresse nächste bitplane Ziel
	dbra	d7,Drawloop
	rts
...
Dieses Beispiel ist die optimierte Version von Listing10c4.s. Die Optimierungen
