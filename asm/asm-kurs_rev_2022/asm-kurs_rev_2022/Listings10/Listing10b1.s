...
; Listing9b1.s		Beispiel für OR zwischen 2 Kanälen
...
mouse1:
	...
	bsr.s	BlitOR				; ODER zwischen den 2 Figuren ausführen
...
WBlit2:
	...
	move.l	#$0dfc0000,$40(a5)	; BLTCON0 und BLTCON1
								...
								; führe ein ODER zwischen A und B aus (LF=$FC)
	move.w	#0,$64(a5)			; BLTAMOD (=0)
...
einfacher Blitt, welcher das OR zwischen den 2 Kanälen A und B unter Verwendung
des Wertes von LF wie in der Lektion berechnet durchführt. Als Übung können Sie
...
um das OR zwischen A und C durchzuführen. Die Berechnung von LF ist einfach:
...
LF = $FA. Wiederholen Sie diese Übung, um das ODER zwischen den Kanälen B
und C zu bilden.