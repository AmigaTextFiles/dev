...
; Listing10d1r.s	BOB rawblit mit Hintergrundwiederherstellung.
...
Waity1:
	...
	bsr.w	RipristinaSfondo	; Hintergrund wiederherstellen
...
NoMinX:
	cmp.w	#319-32,ogg_x		; Überprüfe die rechte Kante. In X_OGG
...
WBlit2:
	...
	move.l	#figura,$4c(a5)		; BLTBPT  ((Figur Bob)
	move.w	#(64*11*3)+3,$58(a5)	; BLTSIZE (Blitter starten !)
...
; Dies sind die Daten, aus denen sich die Bob-Grafik zusammensetzt.
; Der Bob ist im interleaved Format, 32 Pixel breit (2 Wörter)
; 11 Zeilen hoch und wird von 3 Bitebenen gebildet
...
BITPLANE:
	incbin	"/Sources/amiga.rawblit"		; hier laden wir die Figur
...
; Er hat die gleichen Abmessungen wie ein Blitt: Höhe 11 Zeilen,
; Breite 3 Wörter, 3 Bitebenen
...
In diesem Beispiel handelt es sich um die Rawblit-Version von Listing10d1.s.
