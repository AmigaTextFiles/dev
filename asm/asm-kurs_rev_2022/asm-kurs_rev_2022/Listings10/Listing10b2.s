...
; Listing10b2.s		Beispiel für AND zwischen den Kanälen A und B
...
mouse1:
	...
	bsr.s	BlitAND				; AND zwischen den 2 Figuren ausführen
...
WBlit1:
	...
	move.w	#(64*71)+5,$58(a5)	; BLTSIZE (Blitter starten !)
								; Breite 5 word, Höhe 71 Zeilen
	rts						 

;****************************************************************************
; diese Routine führt das AND zwischen 2 Figuren auf dem Bildschirm aus
;****************************************************************************
...
WBlit2:
	...
	move.l	#$0dc00000,$40(a5)	; BLTCON0 und BLTCON1
								; benutze A, B und D
								; führe ein AND zwischen A und B aus (LF=$C0)
	move.w	#0,$64(a5)			; BLTAMOD (=0)
...
In diesem Beispiel führen wir ein AND zwischen 2 Figuren aus. Das Beispiel ist
identisch mit Listing10b1.s. Der einzige Unterschied ist ein anderer LF-Wert.
Der LF-Wert wird berechnet, indem die Minterme entsprechend der Kombinationen
der Eingänge mit A = 1 und gleichzeitig B = 1 eingestellt werden. Dies sind nur
2 Kombinationen, die zu LF = $C0 führen.