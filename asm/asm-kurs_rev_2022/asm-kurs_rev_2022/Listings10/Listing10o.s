...
; Listing10o.s		Füllen eines Polygons
; Wechseln Sie mit den Maustasten
...
fatto_bltcon1:
	...
	move.w	#28,$64(a5)			; BLTAMOD Breite 6 words (40-12=28)
	...
	move.w	#(64*56)+6,$58(a5)	; BLTSIZE (Blitter starten!)
								; Breite 6 words
...
In diesem Beispiel sehen wir die Funktionsweise des Füllmodus. Als erstes
verfolgen wir (mit dem Blitter) Linien auf dem Bildschirm. Dann füllen wir das
Rechteck auf dem Bildschirm. Wie Sie sehen können werden die durch die Linien
begrenzten Bereiche ausgefüllt. Die Füllroutine liest das Quellrechteck von
einer festen Position des Bildschirms (wo wir ursprünglich die Linien verfolgt
haben) während das Ziel variabel ist und über einen Parameter übergeben wird.
Die Abmessungen des Rechtecks sind festgelegt und wurden entsprechend
berechnet. Sie umschließen alle gezeichneten Linien. Die Füllroutine wird auch
so parametriert, dass alle Arten von Füllungen: inklusive, exklusiv und mit
FILL_CARRYIN bei 0 oder bei 1 ausgeführt werden. Durch sorgfältige Beobachtung
der erzeugten Bilder (insbesondere des Rechtecks) sehen sie die Unterschiede
zwischen den Füllungsarten.
