...
Largh_plasm	equ	36				; Plasmabreite ausgedrückt
...
Alt_plasm	equ	235				; Plasmahöhe ausgedrückt
								; als Anzahl der Zeilen

NuovaRigaR	equ	6				; Wert hinzufügen zum Index R in der
...
NuovoFrameR	equ	2				; Wert abziehen vom Index R in der
...
NuovaRigaB	equ	-12				; wie "NuovaRigaR" aber für Komponente B
NuovoFrameB	equ	-6				; wie "NuovoFrameR" aber für Komponente B

NuovaRigaO	equ	12				; wie "NuovaRigaR" aber für Oszillation
NuovoFrameO	equ	-4				; wie "NuovoFrameR" aber für Oszillation
...
; Der Effekt wird durch Ändern des Hardware-Scroll-Werts in jeder Zeile
...
InitPlasma:
	...
	move.l	#$3e43FFFE,d0		; lädt die erste wait-Anweisung in D0.
								...
								; horizontal $42
	move.w	#$184,d1			; setzt die erste Hälfte einer Anweisung in D1
								; "copper move" in COLOR02 (=$dff184)
	move.w	#$186,d4			; setzt die erste Hälfte einer Anweisung in D4
...
; liest und ändert den Index Komponente B
	...
	moveq	#Largh_plasm-1,d2	; die Schleife wird NICHT über die Breite durchgehend
...
; Diese Tabelle enthält die Werte der Schwingungen (Scrollwerte von
; Bitebene 1)
...
geschrieben werden muss, da die Farbe 0 (Hintergrund) nicht berührt wird. Auf
diese Weise können wir ein schmaleres Plasma verwenden, als es im Beispiel
