...
; Zeiger auf unsere 3 bitplanes:
	...
	move.l	#BitMap,d0			; Adressen bitplanes
	move.w	d0,onelo
	swap	d0
	move.w	d0,onehi
	swap	d0
...
******************************************************************************
; Routine, die den Joystick liest und die Effektwerte ändert, 
; Ändern der beiden Variablen RotationSpeed und Tightness
******************************************************************************
...
toobig:
	addq.w	#1,slow				; wir verlangsamen die Geschwindigkeitsänderung ein wenig.
	cmp.w	#3,slow				; sind wir angekommen 3?
	bne.s	too					; Wenn noch nicht warten
	clr.w	slow				; Setzen Sie die langsame Var zurück
...
; Auch Feuer = 0 oder 1, wenn der Feuerknopf gedrückt wird.
...
nofire:
	clr.w	StickX				; Variablen zurücksetzen
	clr.w	StickY
...
******************************************************************************
; Routine, die den Effekt für den Bildschirm verschiebt
******************************************************************************
