...
lobj01:
	dc.w	5						; box (6 face)
	dc.w	3, 1,5, 5,6, 6,2, 2,1	; face1 (4 points)
	dc.w	3, 0,4, 4,5, 5,1, 1,0	; face2
	dc.w	3, 3,7, 7,4, 4,0, 0,3	; face3
	dc.w	3, 2,6, 6,7, 7,3, 3,2	; face4
	dc.w	3, 4,7, 7,6, 6,5, 5,4	; face5
	dc.w	3, 0,1, 1,2, 2,3, 3,0	; face6
...
c1:
	move.l	d1,d4
;	lsl.l	#5,d4		;32 screen
	mulu	#40,d4		;40 screen
