...
*
* Binary Version: 1.21
* Source Version: 1.21 (opensource release)
* Project	: Asm-Pro (OpenSource Edition)
*
...
.SameSrc
	...
	lsl.l	#2,d0
	add.l	d0,(DEBUG_END-DT,a4)		; +4 bytes per line (text ptr)
.NoDebug
...
.CE2E8
	...
	add.l	(CURRENT_ABS_ADDRESS-DT,a4),d0
	move.l	d0,(a0)
.CE30C	move.l	a6,(DATA_LINE_START_PTR-DT,a4)
