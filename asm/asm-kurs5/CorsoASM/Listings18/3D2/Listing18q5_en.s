...
;*  Date:  01/10/1991                           *
;************************************************
; ATTENTION: since the rotated object is a cube and given that
; in a cube you can see at most 3 faces at the same time,
; routines have been simplified to be faster
...
POLY1:
	dc.w	0,1						; the first word indicates the number of
	dc.w	1,3						; single angle
	dc.w	2,0
	dc.w	3,2
	dc.w	1
