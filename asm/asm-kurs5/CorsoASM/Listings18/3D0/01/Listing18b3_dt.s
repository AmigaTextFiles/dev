...
NonAllontana:
	...
	SUBQ.W	#2,ZADD				; Translation der Annäherung an uns
...
TRLOOP:
	...
	move.w	D0,(A1)+			; X speichern in PuntiXYZtraslati
	move.w	D1,(A1)+			; Y speichern in PuntiXYZtraslati
	move.w	D2,(A1)+			; Z speichern in PuntiXYZtraslati
...
; Quellkoordinaten:
	...
	LEA	PuntiXYZtraslati(PC),A0		; Koordinate X	
	LEA	PuntiXYZtraslati+2(PC),A1	; Koordinate Y
	LEA	PuntiXYZtraslati+4(PC),A2	; Koordinate Z
...
; Als Ziel überschreiben wir den Puffer der verschobenen Punkte
