...
;********** Initialisierung **********
	...
	; Speicher in CHIP zuordnen, der für die Bitebene auf 0 gesetzt ist (für Erstellung) (back buffer)
...
_moveBobNoOverflowY:
	...
	or.w #$0FF2,d0
	move.w d0,BLTCON0(a5)		; ASH3-0=Verschiebung, USEA=1, USEB=0, USEC=1, USED=1, D=A+bC
	lsr.w #3,d1
	and.b #$FE,d1
	move.w bobY,d0
	mulu #DISPLAY_DEPTH*(DISPLAY_DX>>3),d0
