...
_clearBPLCON1Done:
	...
	addq.b #2,d1				; Fügen Sie die erste gezoomte Gruppe sowie eine Gruppe hinzu,
								; in der die verschobenen Pixel gejagt werden.
	add.b d1,d0
	add.b d0,d0
...
; braucht es nicht wie oben eine Grenzübertrittskontrolle auf A3?
	...
	move.w d1,d0
	addq.b #1,d1				; Eine Gruppe hinzufügen, in der verschobene Pixel gejagt werden sollen
...
zoomSteps:		
	; Für ein 306 Pixel breites Bild: # der zu löschenden Spalten (also # der gezoomten Gruppen),
	; anzuwendende Linksverschiebung, Index der ersten verwendeten Gruppe, # der nicht gezoomten
	; Gruppen links von den gezoomten Gruppen, # der nicht gezoomten Gruppen rechts von den gezoomten Gruppen.
