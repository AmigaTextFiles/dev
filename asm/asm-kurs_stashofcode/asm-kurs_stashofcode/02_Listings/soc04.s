...
; Hardware-Interrupts und DMAs abschneiden
...
_copperListRows:
	move.l #$00000000,(a0)+
	move.w #DISPLAY_DX>>3,d1	; 41 MOVE pro Zeile nicht 40 ...
_copperListCols:
	move.w #COLOR01,(a0)+
	move.w #$0000,(a0)+
...
; Timer und Offset, um die Werte von BLTCON0 zu durchlaufen und die 256 Kombinationen von Intervallen zu testen
	...
	move.w #(256-1)<<1,d7		; Offset in bltcon0
	swap d7
	move.w #1,d7				; Timer
...
; Sinusförmige Startversätze in Bauteilen
...
; COmposantes (7.5+7.5*sin*cos ou l'angle de sin démarre à 50 et progresse de 12 et l'angle de cos démarre à 0 et progresse de 20) : pas convaincant du tout !
