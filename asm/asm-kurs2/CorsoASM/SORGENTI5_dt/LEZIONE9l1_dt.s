...
; Lezione9l1.s	Kopie eines Rechtecks zwischen 2 überlappenden Bereichen
...
; zu den Koordinaten X2 = 64, Y2 = 40 (Ziel)
; Beachten Sie, dass die Quelle und das Ziel sich überschneiden, und das Ziel
; höher liegt, d.h. an einer niedrigeren Adresse.
;****************************************************************************
...
; Laden Sie die Quell- und Zieladressen in 2 Register
	...
	move.l	#bitplane+((20*3*40)+64/16)*2,d2	; Adresse Ziel
...
In diesem Beispiel kopieren wir ein Rechteck zwischen zwei überlappenden 
Zonen. WEIL die Adresse des Ziels kleiner als die der Quelle ist (auf
dem Bildschirm befindet sich das Ziel höher) können wir sicher die Techniken
verwenden, die wir bisher verwendet haben. (Kopie eines Rechtecks auf
interleaved Bildschirm). In der Tat sind die Routinen dieses Beispiels 
identisch mit diejenigen, die im Beispiel lesson9g2.s zu sehen sind.
