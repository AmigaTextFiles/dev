...
; Lezione9b2.s	 Schleife einer gezeichneten Linie
...
;	  /      \
	...
	move.w	#$05CC,$40(a5)		; BLTCON0 (Erstellen Sie eine Kopie von B nach D)
	...
	move.w	#64*1+10,$58(a5)	; BLTSIZE (Blitter starten!)
					; jetzt statt 8 Wörter, wie in
					; vorheriges Beispiel, Block von 10 Wörtern

	add.w	#40,a0		; Lass uns zum nächsten Blitt gehen
						; Linie in der nächsten Schleife.
	dbra	d7,blitloop
...
Dieses Beispiel ist eine Variation des Beispiels lesson9b1.s.
Beachten Sie, wie die Daten kopiert werden, indem wir die Zieladresse 
in verschiedenen Bereichen des Bildschirms ändern. Jede Blittata wird um 
eine Zeile weiter gemacht (auf dem Bildschirm niedriger) als die 
vorherige. Dies wird erreicht, indem die Zieladresse immer um 40 
(= Anzahl Bytes für jede Zeile) erhöht wird.

Beachten Sie eine sehr wichtige Sache: Immer, bevor eine Blittata gestartet 
wird, das der vorherige Blitter-Block mit der Waitblit-Schleife beendet ist.
