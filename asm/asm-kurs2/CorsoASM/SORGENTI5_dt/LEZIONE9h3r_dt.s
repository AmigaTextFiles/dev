...
; Lezione9h3r.s	Wir lassen ein Bild erscheinen
		; immer eine Pixelspalte gleichzeitig 
		; Rechte Taste um den Blitt zu starten, links um zu beenden.	
		; Hinweis: Bild in RAWBLIT (oder interleaved, wenn Sie bevorzugen).
...
; zu einem 20 Wort breiten Bildschirm. Also ist das Modulo 2 * (20-1) = 38 = $26.
; Da die 2 Register aufeinanderfolgende Adressen haben, braucht man nur eine
; Anweisung anstatt 2 verwenden:

	move.l #$00260026,$64(a5)	; bltamod und bltdmod 

; wir blitten eine 256 Spalten hohes Wort "Spalte" (den ganzen Bildschirm)
...
Dieses Beispiel ist die RawBlit-version von lesson9h3.s. Vergleichen Sie 
die Unterschiede in den Formeln zur Berechnung der zu schreibenden Werte
in den Blitter-Registern.
