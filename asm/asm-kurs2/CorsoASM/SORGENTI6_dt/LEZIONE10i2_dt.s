...
; Lezione10i2.s		1-Pixel-Sinus-Scroller
...
mouse:
	...
	MOVE.L	#$10800,d2			; Linie zu warten = $108
Waity1:
...
Sine:
	...
	move.l	SinusPtr(pc),a3	; Adresse ersten Sinuswert (* 42)
	subq.w	#2,a3			; Ändere den ersten Wert
	cmp.l	#Sinustab,a3	; wenn wir am Anfang der Tabelle stehen
	bhs.s	nostartptr		; fang wieder vom ende an an
...
waitblit_sine:
	...
	ror.w	#1,d5			; zum nächsten "Scheibe" bewegt
...
hinsehen werden Sie bemerken, das die Ränder der Buchstaben beim 
Sinuslauf viel weniger gezackt sind. Die "Sinus" -Routine ist der von
Lektion10i1.s sehr ähnlich. Die Unterschiede bestehen in der Tatsache,
dass wir jetzt ein Pixel breite Scheiben haben . D.h in einem Wort 
16 "Scheiben" anstatt 8. Das bedeutet natürlich, das die Maske sich jedes 
Mal um 1 Pixel anstatt um 2 drehen muss. Beachten Sie auch, dass wir 
eine andere Tabelle verwenden. In der Tat, wenn wir die gleichen 
Sinuslauf genommen hätten wären wir näher gekommen.
Um den Scroller etwas abwechslungsreicher zu gestalten, lesen wir die 
Tabellenwerte jedes Mal ab einem anderen Wert. Dazu verwenden wir einen 
Zeiger auf die den ersten zu lesenden Wert, der bei jedem Lesen geändert
wird.