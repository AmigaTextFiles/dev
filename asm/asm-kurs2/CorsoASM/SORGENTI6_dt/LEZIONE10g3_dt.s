...
mouse1:
	...
	moveq	#16-1,d6	; Wiederholen Sie für jede Pixelspalte
...
Waity1:
	...
	asr.w	#1,d5		; Berechne die Maske für die nächste
						; blittata. Ein Pixel mehr passieren
						; als Inhalt						
...
Waity2:
	...
	lsr.w	#1,d5		; Berechne die Maske für die nächste
						; blittata. Ein Pixel weniger passieren
						; als Inhalt						
...
als wäre es ein venezianischer Vorhang, der geöffnet oder geschlossen ist. Mach 
es zuerst um es zu betrachten, um zu verstehen, was es ist, dann lies die
Erklärung nochmal !
Diesen Effekt erhalten wir durch eine Technik, die der im Beispiel lesson9h3.s
...
Lektion 9h3, können wir BLTAFWM / BLTALWM nicht verwenden, um die Maske zu 
erhalten, weil wir die Maske auf alle Wörter in der Figur anwenden müssen, nicht
nur am Anfang und am Ende. Dazu machen wir ein AND zwischen dem Kanal
A und Kanal B, wir halten Kanal B deaktiviert und verwenden BLTBDAT als Maske.
Die Maske wird so variiert, bis das Bild fortlaufend durchgehend angezeigt wird
und dann wird es wieder geändert, um allmählich das ganze Bild zu löschen.