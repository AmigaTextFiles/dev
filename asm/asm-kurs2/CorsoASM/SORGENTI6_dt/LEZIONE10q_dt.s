...
; Lezione10q.s	Füllen eines Polygons mit Linien mit einer Neigung <von 45 Grad
...
WaitLine:
	...
	or.w	#$0003,d5	; Bit 0 0 (aktiver Zeilenmodus), und					
...
BITPLANE:
	dcb.b	40*256,0	; bitplane lowres
...
von weniger als 45 Grad begrenzt. Beim Verwenden des Linienzeichnungsmodus
mit Füllung sind wir in der Lage, korrekt zu füllen.
Um Linien zu zeichnen, benutzen wir die "DrawLineFill" Routine, die identisch
ist zur "DrawLine" Routine, bis auf die Tatsache das wir das entsprechende 
Bit von BLTCON1 setzen um diesen speziellen Modus zu verwenden.
Wie Sie vor dem Füllen sehen können, erzeugt diese spezielle Art Linien,
die für jede horizontale Linie immer ein einzelnes Pixel haben. Wenn die 
Steigung der Linien> 45 Grad wäre, hätten sie identische Linien zu normalen.