...
; Lezione10u2.s  Effekte mit Linien
...
NonCambia:
	...
	bsr.w	MuoviPunti	; Ändern Sie die Koordinaten der ersten Punkte
						; der Linie
...
; Zeichne die Linie
	...
	movem.l	d0-d7,-(a7)		; Speichern Sie die Register
	...
	bsr.w	Drawline
	movem.l	(a7)+,d0-d7		; Lesen Sie die Register
...
In diesem Beispiel fügen wir dem Programm lesson10u1.s weitere Zeilen hinzu
um komplexere Effekte zu machen. Zum Zeichnen der Linien werden die 
Koordinaten der Werte immer aus der Tabelle gelesen. Zur Berechnung der 
neuen Koordinaten werden die Indexe zu den Werten in jeder Zeile hinzugefügt.
Diese Werte sind in den Variablen "NextAdd" enthalten. Durch Drücken der 
rechten Taste können Sie außerdem alle Werte der Variablen ändern. Auf
diese Weise können Sie einfach durch das variieren der Parameter neue
Effekte erhalten.
