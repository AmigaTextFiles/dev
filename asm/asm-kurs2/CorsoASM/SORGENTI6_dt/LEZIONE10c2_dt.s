...
; Lezione10c2.s	BLITTATA, in dem wir die Maske einer Zeichnung aufbauen
...
WBlit2:
	...
	move.l	a2,$50(a5)		; BLTAPT  Zeiger Ziel
...
verwenden dabei eine andere Technik als in Lektion 10c1.s. Dieses Mal führen
wir tatsächlich nur eine Blittata aus, indem wir alle Kanäle benutzen.
Da unsere Figur 3 Bit-Ebenen hat, können wir sie gleichzeitig durch die 
Kanäle A, B und C lesen und über das OR durch Kanal D schreiben.
Dies ist das erste Beispiel, in welchem wir alle Blitter-Kanäle gleichzeitig
aktivieren. Beachten Sie, dass die Bits 8 bis 11 von BLTCON0 tatsächlich 
alle auf 1 gesetzt sind. Der Wert von LF wird auf die übliche Weise berechnet.
Die Einstellung wird vorgenommen für alle Minterms, die den Eingabekombinationen 
...
Beachten Sie, dass diese Technik, anders als in Lektion 10c1.s nur angewendet 
werden kann, wenn die Figur 3 Bit-Ebenen hat.