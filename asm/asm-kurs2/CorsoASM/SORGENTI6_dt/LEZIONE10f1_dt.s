...
; Lezione10f1.s	 Viele BOBs mit "falschem" Hintergrund. Es gibt einen 
...
In diesem Beispiel bewegen sich 6 Bobs auf einem Hintergrund. Wir verwenden 
den Trick des gefälschten Hintergrunds. Da wir aber die 6 Bobs alle in den
gleichen Ebenen bewgen, müssen wir sie noch mit der Technik der der Bitplane
-Maske und des "Cookie-Cuts" blitten, sonst würden sie sich nicht richtig 
überlappen. 
Die Technik des gefälschten Hintergrunds erlaubt uns jedoch das Speichern und
Wiederherstellen des Hintergrunds zu vermeiden, da der Hintergrund alleine 
durch Nullen gebildet wird. Für das Löschen der in den alten Positionen
bewegten Bobs ist es daher ausreichend, die den Bobs gewidmeten Bitplanes vor 
dem Start zu löschen um sie neu zu gestalten.
Um die Bobs zu bewegen und zu zeichnen, verwenden wir parametrische Routinen
die in der Lage sind, alle Bobs zu behandeln, die wir wollen. Anstatt die 
Parameter durch CPU-Register zu übergeben verwenden wir "Datenstrukturen",
dh wir sammeln die Geschwindigkeits- und Positionsdaten jedes Bob in 
zusammenhängenden Adressen, immer in der gleichen Reihenfolge. Die Routinen
"durchlaufen" die Register A4 die Adresse der Datenstruktur. 
Auf diese Weise wissen die Routinen, dass sich die Bob-Daten an der von A4 
angegebenen Adresse und in den nachfolgenden Adressen befinden. Wie Sie sehen
können, zeichnet dieses Programm die Bobs nicht richtig. Für die Erklärung
des Problems und für die Lösung sehen Sie sich die Lektion an.