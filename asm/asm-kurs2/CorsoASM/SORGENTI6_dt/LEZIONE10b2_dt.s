...
; Lezione10b2.s	 Beispiel für AND zwischen den Kanälen A und B
...
mouse1:
	...
	bsr.s	BlitAND		; Führe das AND zwischen den 2 Figuren aus
...
;****************************************************************************
; diese Routine führt das AND von 2 Figuren auf dem Bildschirm aus
;****************************************************************************
...
In diesem Beispiel führen wir ein AND zwischen 2 Figuren aus. Das Beispiel 
ist identisch mit der Lektion 10b1.s. Der einzige Unterschied ist ein anderer
LF-Wert. Der Wert von LF wird berechnet, indem die Minterme entsprechend 
der Kombinationen der Eingänge mit A = 1 und gleichzeitig B = 1 eingestellt 
werden. Dies sind nur 2 Kombinationen, die zu LF = $C0 führen.