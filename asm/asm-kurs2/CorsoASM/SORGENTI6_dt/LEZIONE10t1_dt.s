...
; Lezione10t1.s	Zeichne eine 2 Pixel breite Linie
...
; Stellen Sie BLTADAT auf Doppellinien ein.
;******************************************************************************
...
;	`._.-(,_..'--(,_..'`-.;.'
	...
	move.w	#$C000,$74(a5)	; BLTADAT = $C000 - Doppellinien
...
In diesem Beispiel sehen wir, wie es möglich ist, eine 2 Pixel breite Linien zu 
zeichnen. Es verläuft genau wie die normalen Linien, initialisiert aber BLTADAT
mit dem Wert von $C000.