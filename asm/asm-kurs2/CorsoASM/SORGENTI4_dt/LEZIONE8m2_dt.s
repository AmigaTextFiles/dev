...
; Lezione8m2.s - Punktdruckroutine (Plot), verwendet in einer Schleife für
			; Linien machen.
...
CalcolaLinea:
	...
	cmp.w	#255,d1			; Wir sind am unteren Bildschirmrand??
	blo.s	NonFinito
	addq.w	#1,Coeff		; Addiere 1 zum Winkelkoeffizienten
	cmp.w	#8,Coeff		; Wir haben bereits 7 Zeilen gemacht?
	beq.s	Finito			; Wenn ja, gehen wir raus!
	clr.w	Miox			; Und beginnen mit 0 für die neue Zeile mit
							; anderer Neigung
	moveq	#0,d1
NonFinito:
	move.w	d1,MioY
...
In diesem Beispiel wird die Schleife, die eine Linie erstellt, in eine andere Schleife 
eingefügt. Ändern Sie den Winkelkoeffizienten, der jetzt ein Wort höher ist, um 
verschiedene Linien zu zeichnen. Was niemand verbietet, ist einen "ADDQ" zu machen.
