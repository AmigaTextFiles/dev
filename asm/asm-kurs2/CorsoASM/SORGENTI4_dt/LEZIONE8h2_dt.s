...
; Lezione8h2.s		8 * 8-Scrolltext-Routine, die nur bplcon1 verwendet
					; zu scrollen. Original von Lorenzo Di Gaetano.
...
;	Zeiger auf bitplanes in copperlist
	...
	move.w	d0,6(a1)	; Kopieren Sie das Wort LOW der Bitplane-Adresse
	swap	d0			; Vertausche die 2 Wörter von d0 (zB: 1234> 3412)
	move.w	d0,2(a1)	; Kopieren Sie das Wort HIGH der Bitplane-Adresse
	...
	clr.w	ContaScroll	; Setzen Sie den Scroll-Zähler zurück
	bsr.w	Print		; Drucken Sie das erste Mal
...
; 2 Zeichen (16 Pixel) weiter links (dies natürlich alle 16)
*****************************************************************************
...
; Andernfalls starten wir von $FF aus neu und drucken den Text 2 Zeichen weiter!
	...
	bsr.s	Print			; und drucken Sie den ScrollText 2 weitere Zeichen
	rts						; vorwärts, dh 2 * 8 = 16 Pixel vor.
...
NonRipartire:
	...
	move.l	d1,a2
	add.l	#Fonts,a2		; Finden Sie die Schriftart in der Schriftart
	move.b	(a2)+,(a0)
	move.b	(a2)+,42(a0)	; 42, um den dfstart zu kompensieren und dann zu gehen
