...
; Lezione8m3.s - Punktdruckroutine (Plot), verwendet in einer Schleife zur
		; Berechnnung von y = x * x, dh einer Kurve ähnlich dem
		; Fall eines Steins in einen Erdrutsch (Gleichnis!)
...
CalcolaPotenza:
	...
	move.w	Miox(PC),d1
	Mulu.w	d1,d1		; y=m*x
	lsr.w	#3,d1		; Erweitern wir die Parabel ein wenig
...
Leider arbeiten wir nur mit ganzen Zahlen und Pixeln zwischen einem Punkt und einem 
anderen die gebrochen sind, sind nicht verfügbar. Jedenfalls besser als nichts!
Diesen Kurventyp erhalten wir durch das Zuweisen des Ergebnisses der 
Berechnung des Quadrats von x an y. Auf diese Weise haben wir:
