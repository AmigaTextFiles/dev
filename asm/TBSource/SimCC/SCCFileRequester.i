...
FRFlags:	dc.l	FRQABSOLUTEXYM			;frq_Flags
		dc.w	3,1				;frq_DirNamesColor,FileNamesColor
...
FRDir:		dc.b	"SimCity_1.1:"
		dcb.b	118,0			;DSIZE(-'SimCity 1.1:')+1
		ds.l	0

FRFile:		dcb.b	30,0			;FSIZE
		ds.l	0

FRPathName:	dc.b	"SimCity_1.1:SomeWhere"
		dcb.b	110,0			;DSIZE(-'SimCity 1.1:SomeWhere')
		dcb.b	30,0			;FSIZE
		dcb.b	2,0			;+2

SimDiskName:	dc.b	"SimCity_1.1:",0
PoCDiskName:	dc.b	"PoC:",0
OilDiskName:	dc.b	"O.I.Games:",0
RRTDiskName:	dc.b	"RDISKB:",0
