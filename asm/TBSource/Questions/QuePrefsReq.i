...
FileRequest2:	dc.w	$2				;MUST BE REQVERSION !!!
FRTitle:	dc.l	0				;frq_Title
		dc.l	FRDir				;frq_Dir
		dc.l	FRFile				;frq_File
		dc.l	FRPathName2			;frq_PathName
		dc.l	0				;frq_Window
...
FRDir:		dc.b	"ENVARC:"
		dcb.b	132-7,0			;DSIZE+2
		ds.l	0

FRFile:		dc.b	"Questions.prefs"
		dcb.b	32-15,0			;FSIZE+2
		ds.l	0

FRPathName2:	dc.b	"ENVARC:Questions.prefs"
		dcb.b	130-7,0			;DSIZE
		dcb.b	30-15,0			;FSIZE
		dcb.b	2,0			;+2
