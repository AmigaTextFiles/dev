...
; Lezione11d.s - Verwendung von COPER- und VERTB-Interrupt per Level 3 ($6c).
...
können. Wenn diese Reihenfolge geändert wird, z.B. entfernen Sie eine Routine, 
wird ein "Durchlaufen" der Routinen passieren. 

Versuchen Sie es zum Beispiel diese Änderung:

nointVERTB:
	btst.b	#4,$dff01f	; INTREQR - COPER zurücksetzen?
	beq.s	NointCOPER	; wenn ja, ist es kein COPER int!
	addq.b	#1,Attuale
	cmp.b	#5,Attuale	; ** ÄNDERUNG ** -> 5 und nicht 6 !!!!!!!!!

Auf diese Weise sehen Sie einen Farbfluss. Hier ist es wenig, daher ist
der Effekt ein wenig zu schnell, aber denken Sie an die Nützlichkeit, wenn Sie 
