...
; Lezione11n1.s - Timing Routine, mit der Sie eine bestimmte Anzahl von 
...
CIAMIC:
 ...
 ;	lea	$bfe001,a4				; CIAA base (wenn Sie die B verwenden möchten)
	...
	andi.b   #%11000000,d0		; setzt i zurück Bit 0-5
		;andi.b   #%00000000,d0		; alles zurücksetzen - Anmerkung vom Übersetzer
	...
	move.b  #%01111110,$d00(a4)	; ICR - löscht die interrupts CIA
		;move.b  #%01111111,$d00(a4)	; ICR - löscht die interrupts CIA - Anmerkung vom Übersetzer
