...
; Lezione11g5.s -  Verwendung der Coppereigenschaft,  einen "MOVE"
...
START:
	bsr.w	FaiCopper	; Erstellen Sie die copperlist...
...
******************************************************************************
; Routine, die die copperliste erstellt. Um eine horizontale Linie zu 
; ziehen sind 52 copper-MOVEs erforderlich. In diesem Fall nehmen wir
; alternativ 32 MOVE pro Farbe, damit sie keine exakte Linie beenden,
...
COP0:
	...
	DBRA	d7,COP0			; mach die ganze "Zeile" (nicht 1 ganze ...)
...
COP1:
	...
	DBRA	d7,COP1			; mach die ganze "Zeile" (nicht 1 ganze ...)
	DBRA	d6,MAIN0		; Machen Sie alle "Webarten".
	RTS
...
SYNC0:
	MOVE.W	0(A0,D5.W),0(A0,D6.W)	; vorherige Farbe in der "nach" Farbe
	SUBQ.W	#4,D6					; Berechnen Sie den nächsten Farboffset
	SUBQ.W	#4,D5					; Berechnen Sie den nächsten Farboffset
...
Eine andere Verwendung der Besonderheit des copper 8 Pixel vorwärts
bewegen ist folgender. Wir können sehen, das wir diesen Effekt auch
erhalten wenn Dutzende von COLOR0 unten platziert sind. Dadurch 
ändern sie die Wartezeit vor "ihnen" um alle nach unten zu verschieben.
