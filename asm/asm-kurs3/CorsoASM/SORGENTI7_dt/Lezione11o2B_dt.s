...
DosLoad:
	...
	bsr.w	mt_init			; Die geladene Musik wird abgespielt
...
; Wir laden die Datei hoch
	...
	MOVE.L	#mt_data1,D2	; Adresse Ziel in d2
;	MOVE.L	D2,#buffer
...
; Öffnen Sie die Datei dos.lib. Es lohnt sich, den ganzen Weg anzugeben.

Filename:
	dc.b	"assembler2:sorgenti4/mod.fairlight",0	; Pfad+Name file
	even

*****************************************************************************
; Interruptroutine, die beim Laden ausgeführt werden soll. Die Routinen dafür
; werden in diesem Interrupt abgelegt und auch während des 
