...
; Lezione11g1.s -  Verwendung der Coppereigenschaft,  einen "MOVE"
...
LINSTART	EQU	$A041fffe	; ändern sie "$a0", um in einer
...
colcon2:
	...
	dbra	d1,colcon1		; Wiederholen Sie das für die Anzahl 
...
mit WAIT MOVE eingefügt wird. Es dauert einige Zeit, um jeden einzelnen auszuführen.
Genau gesagt 8 Pixel lowres. In der Tat, wenn Sie die Auflösung hires einstellen,
ändert sich nichts, nur Sie können über "16" Pixel-hires sprechen... (aber es 
ist nutzlos) Wenn Sie wollen, können Sie mit einem "Klick" die horizontale Breite
mit einem Lineal messen und Sie werden bemerken das es immer das gleiche ist.
Außerdem ist es eine nützliche Tatsache für Effekte wie PLASMA oder das in diesem 
Beispiel gezeigte. Es ist eine Einschränkung in dem Sinne, dass wenn man die
ganze Palette wechseln will braucht jede Zeile "etwas Zeit" und es würde sich 
nicht vollständig in der mittleren Zeile oder sogar in der darunter liegenden 
Zeile ändern.
