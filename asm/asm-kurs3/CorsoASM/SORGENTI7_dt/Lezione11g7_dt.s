...
; Lezione11g7.s -  Verwendung der Coppereigenschaft,  einen "MOVE"
...
PLASMA2:
	...
	ADD.B	0(A1,D4.w),D0	; den wenig vermasselt richtigen zweiten Werte
	ADD.B	0(A1,D5.w),D0	; die 3 Variablen
	BCLR.L	#0,D0			; Wir brauchen das niedrige Stück nicht
	ADD.W	D3,D0			; Fügen Sie die minimale Wartezeit hinzu
	ADD.W	#$0100,D3		; und verschieben Sie die minimale Wartezeit um eine Zeile darunter
	MOVE.W	D0,(A0)			; Setzen Sie das geänderte WAIT 
...
PLASMZONE:
	...
	dc.l	$1800FF0	; Color0 gelb (cornicina)
	dc.l	$D311FFFE	; Wait $d3
	dc.l	$1800000	; Color0 schwarz
	dc.l	$FFFFFFFE	; Endecopperlist
