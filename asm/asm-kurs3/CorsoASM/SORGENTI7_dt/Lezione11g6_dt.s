...
; Lezione11g6.s -  Verwendung der Coppereigenschaft,  einen "MOVE"
...
COP0:
	...
	DBRA	d7,COP0				; Machen Sie eine Linie mit 32 color0...
	MOVE.L	#$01800505,(A0)+	; COLOR0 setzen
	ADDI.L	#$01020000,D2		; Warten Sie 1 Zeile darunter und 2 weitere nach vorne
...
MOVE0:
	MOVE.W	2(A0),-2(A0)	; Kopieren Sie die 32 Farben der Zeile
	...
	DBRA	d6,MOVE1	; Wir führen alle Linien
	RTS
