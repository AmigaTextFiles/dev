...
; Lezione11i1.s	- Vollbild-Farbscrolling PAL
...
MakeCop:
	...
	move.l	#$1f07fffe,d0		; WAIT-Anweisung, erste Zeile $1f
								; dh WAIT starten
	move.l	#$0007fffe,d1		; Letzte NTSC-Zeile für die copperlist
								; dh endgültiges WAIT
	bsr.w	FaiColors			; Machen Sie dieses Stück copperliste
	...
	move.l	#$3707fffe,d1		; Letzte Zeile am unteren Bildschirmrand
								; dh endgültiges WAIT
	bsr.s	FaiColors2			; Machen Sie das PAL-Stück aus der copperlist
...
FaiColors2:
	move.l	d0,(a0)+		; Geben Sie die WAIT in die coplist
	move.w	#$0180,(a0)+	; Geben Sie das Register COLOR0 ein 
...
labelok:
	addi.l	#$01000000,d0	; Erhöhen Sie die Y-Position von WAIT
...
ColorScrollPAL:
	...
	bsr.s	scroll			; Scrollen Sie durch den NTSC-Teil des Bildschirms
	...
	bsr.s	scroll			; Scrollen Sie durch den PAL-Teil des Bildschirms
	...
	bne.s	NonRipartire		; Wenn Sie noch nicht aus der Routine sind
...
scroll:
	move.w	(a0)+,(a1)		; Kopieren Sie die Farbe aus der Tabelle in die
							; copperlist
