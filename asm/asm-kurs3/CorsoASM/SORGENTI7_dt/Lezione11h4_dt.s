...
; Lezione11h4.s	BAR WELCHE UNTER VERWENDUNG DES WAIT MASKING RAUF UND RUNTER GEHT

; Dieses Listing ist mit einer Ausnahme von Lektion3d.s identisch
...
BARRA:
	dc.w	$3407,$FFFE	; wir warten auf Zeile $79 (WAIT NORMAL!)
...
und fügen die anderen Paare von $80fe hinzu dann können wir bei der ersten Wartezeit
viele Zeilen "erhalten". Trotz allem ist es ein wenig gewöhnungsbedürftig, weil 
es einige Einschränkungen gibt, zum Beispiel funktioniert es nicht für Zeilen
nach 127 ($7f). Versuchen sie die maximal erreichbare Zeile zu ändern:
