 ...
 *
 * Modified 25-Sep-96 by Lars Malmborg
 *  Use SAS/C's ability to declare register parameters for call-back hooks
 *  instead of extra assembler "HookEntry".
 */
...
__saveds __asm LONG stdio_stream(register __a0 struct Hook *hook,
 ...
 *
 * Iffparse.library calls this code via struct Hook
 */
