...
extern int yydirset(int i, int j);
extern void yyerror(char *fmt,...);
void yymallocerror(void );
extern int yylex(void);
extern int next_lexval(void);
extern int confilter(int n,int p1,int p2);
extern int init_dirsets(void) ;
extern int first_lexval(void);
extern int init_lexelem(void);
extern int YYSTART (void);
PRIVATE int clearhash (void);

/*============================================================================*/
/* PRINT ROUTINES                                                             */
/*============================================================================*/

PRIVATE void print_item(int p)
/*
...
PUBLIC void yymallocerror(void )
{
