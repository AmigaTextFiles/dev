...
;
;	$Id: sms_crt0.asm,v 0.9 2009/02/21 13:46:35 dom Exp $
;
...
;-------
	...
	XDEF	pause_flag	;This alternates between 0 and 1 every time pause is pressed
...
.int_RASTER	
	...
	ld	a, ($BF)	;Acknowledges the interrupt
...
pause_flag		ds.b	1	;This alternates between 0 and 1 every time pause is pressed
}
