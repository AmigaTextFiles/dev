...
OBJECTS = avra.o device.o parser.o expr.o mnemonic.o directiv.o macro.o file.o map.o

OBJ_ALL = $(OBJECTS) args.o stdextra.o

DISTFILES = *.c *.h README Makefile.* COPYING avra.1 avra.txt strip-headers TODO

ARCHFILES = $(DISTFILES)

BINFILES = avra README COPYING avra.1 avra.txt
