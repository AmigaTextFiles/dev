...
{\em valid for: all processors, {\tt CONSTANT} only for KCPSM}
...
%%-----------
\begin{quote}
ai) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
ak) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
an) ST6210/ST6215$\rightarrow$ST6220/ST6225
\end{quote}
...
%%-----------
\begin{quote}
ap) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
as) 320C25 $\rightarrow$ 320C26 $\rightarrow$ 320C28
\end{quote}
...
%%-----------
\begin{quote}
au) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
ay) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bc) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
\begin{quote}
\begin{tabbing}
bi) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
stored as-is.  Instead, the structure's name is prepended to them, liked
with a special character.  By default, this is the underbasr (\_).  This
behaviour however may be modified with two arguments passed to the
\tty{STRUCT} statement:
\begin{itemize}
...
\item{\tty{DOTS} instructs AS to use the dot as connectin character
...
symbol has the nsme {\tt LEN}, which is being extended with the
...
\errentry{2020}{invalid combination of prefixes}
               ...
               {none}
\errentry{2030}{constants cannot be modifed}
               {error}
...
Oliver Thamm, Thorsten Thiele, John Weinrich.
