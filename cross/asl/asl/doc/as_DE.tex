...
\item{Motorola 6800, 6805, 68HC08, 6809, 68(HC)11(K4), 68HC12, 68HC16 sowie Hitachi 6301}
\item{Hitachi 6309}
...
'tempor"are Symbole' bleiben.  AS kennt zwei unterschiedliche Typen von
tempor"aren Symbolen, solche {\em mit Namen} und {\em namenlose}:
...
{\em G"ultigkeit: alle Prozessoren, {\tt CONSTANT} nur KCPSM}
...
%%-----------
\begin{quote}
ay) 370C010, 370C020, 370C030, 370C040 und 370C050
\end{quote}
...
\errentry{2020}{ung"ultige Pr"afix-Kombination}
	        ...
	        Maschinenkode darstellbar.}
               {keines}
\errentry{2030}{Konstanten k"onnen nicht ver"andert werden}
               {Fehler}
