 ...
 *
 *      $Id: data.c 1.11 1999/03/22 21:27:18 djm8 Exp $
 */
...
char amivers[] = "$VER: sccz80 v1.10b0.52 (22.3.99)";
char titlec[] = "Small-C/Plus v1.1b0.52 - z80 Crosscompiler\n";
char Banner[]  = "* * * * *  Small-C/Plus Z88 * * * * *" ;
char Version[] = "  Version: v1.10b0.52 Date: 22/3/99 ";
...
char    Filename[FILENAME_MAX+1] ;          /* output file name */
...
char    dosigned, doheader,fnflags,mathz88,compactcode;
