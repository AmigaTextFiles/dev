...
;
; Thanks to Anton Reinauer for help with optimising the assembly code.
;
...
Function .b ConnectTCP{host$,port.w}
  ...
  Else
    GetReg a0,SocketBase.l        ; put SocketBase.l in a0
    MOVE.l a0,bsdsocketaddress    ; store the bsdcoket.lib address
