...
{
    {LISTVIEW_KIND,25,7, {0,0,0,0,NULL,NULL,GID_CACHEABLE,PLACETEXT_ABOVE | NG_HIGHLABEL},cacheabletags,GS_DefaultTags},
    {LISTVIEW_KIND,25,7, {0,0,0,0,NULL,NULL,GID_CURRENTLYCACHED,PLACETEXT_ABOVE | NG_HIGHLABEL},currentlycachedtags,GS_DefaultTags},
    ...
    {BUTTON_KIND,   0,0, {0,0,0,0,"Re_move", NULL, GID_REMOVE, PLACETEXT_IN}, NULL, GS_DefaultTags},
    {BUTTON_KIND,   0,0, {0,0,0,0,"_Purge", NULL, GID_PURGE, PLACETEXT_IN}, NULL, GS_DefaultTags},
    {BUTTON_KIND,   0,0, {0,0,0,0,"_Edit...", NULL, GID_EDIT, PLACETEXT_IN}, NULL, GS_DefaultTags},
    {BUTTON_KIND,   0,0, {0,0,0,0,"_Stats...", NULL, GID_STATS, PLACETEXT_IN}, NULL, GS_DefaultTags},
    ...
    {BUTTON_KIND,   0,0, {0,0,0,0,"_Use", NULL, GID_USE, PLACETEXT_IN}, NULL, GS_DefaultTags | GS_BoldLabel},
    ...
    GUIL_HorizGroup, 1,
        ...
        GUIL_VertGroup, 1,
            ...
            GUIL_VertGroup, 0,
                ...
                GUIL_FrameHeadline, "Cacheable Devices",
        ...
        GUIL_VertGroup, 1,
            ...
            GUIL_VertGroup, 1,
                GUIL_Flags, GUILF_PropShare | GUILF_EqualWidth,
                GUIL_FrameType, GUILFT_Ridge,
                GUIL_FrameHeadline, "Currently Cached",
...
static const char ver[] = "$VER: PowerCache2 1.0 " __AMIGADATE__;

/* Now, some globals used by Generic.o during the call to GF_CreateGUIA() */

int DEMO_InitialOrientation = GUIL_VertGroup;

STRPTR DEMO_WindowTitle = "PowerCache GUI (2)";
STRPTR DEMO_AppID       = "PowerCache2";

STRPTR DEMO_Version     = "1.0",
       DEMO_LongDesc    = "Demo program - The GUI from PowerCache (2)",
