...
\subsection{Group.mui/MUIA\_Group\_ActivePage}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_ActivePage]  -- (V5 ) [ISG], LONG
\end{description}
...
PageGroup,
   Child, Page\_0\_Object,
   Child, Page\_1\_Object,
   Child, Page\_2\_Object,
   Child, Page\_3\_Object,
   End;
...
\subsection{Group.mui/MUIA\_Group\_Child}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_Child]  -- (V4 ) [I..], Object *
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_ChildList}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_ChildList]  -- (V4 ) [..G], struct List *
\end{description}
...
OM\_ADDMEMBER/OM\_REMMEMBER methods instead!
...
\subsection{Group.mui/MUIA\_Group\_Columns}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_Columns]  -- (V4 ) [IS.], LONG
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_Horiz}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_Horiz]  -- (V4 ) [I..], BOOL
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_HorizSpacing}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_HorizSpacing]  -- (V4 ) [IS.], LONG
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_LayoutHook}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_LayoutHook]  -- (V11) [I..], struct Hook *
\end{description}
...
As soon as you specify a MUIA\_Group\_LayoutHook, the
...
to a struct MUI\_LayoutMsg. The lm\_Type field of
this structure determines which kind of action MUI
wants you to perform (see below), the lm\_Children
...
If lm\_Type == MUILM\_ASKMINMAX, MUI wants you to
...
the structure lm\_MinMax of the MUI\_LayoutMsg and
exit your hook with a return value of 0.

If lm\_Type == MUILM\_LAYOUT, MUI has already placed
...
MUI\_Layout() to tell the child where it should
...
lm\_Layout.Width and lm\_Layout.Height to the width
...
\end{flushleft}
\item[\bf SEE ALSO]
muimaster.library/MUI\_Layout()
\end{deflist}


\subsection{Group.mui/MUIA\_Group\_PageMode}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_PageMode]  -- (V5 ) [I..], BOOL
\end{description}
...
which one can be adjusted with the MUIA\_Group\_ActivePage
attribute.
...
\subsection{Group.mui/MUIA\_Group\_Rows}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_Rows]  -- (V4 ) [IS.], LONG
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_SameHeight}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_SameHeight]  -- (V4 ) [I..], BOOL
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_SameSize}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_SameSize]  -- (V4 ) [I..], BOOL
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_SameWidth}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_SameWidth]  -- (V4 ) [I..], BOOL
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_Spacing}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_Spacing]  -- (V4 ) [IS.], LONG
\end{description}
...
\subsection{Group.mui/MUIA\_Group\_VertSpacing}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
\begin{description}
\item[MUIA\_Group\_VertSpacing]  -- (V4 ) [IS.], LONG
\end{description}
...
\subsection{Group.mui/MUIM\_Group\_ExitChange}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
MUIM\_Group\_ExitChange (V11)
...
\end{flushleft}
\item[\bf FUNCTION]
Terminates MUIM\_Group\_InitChange state.

\item[\bf SEE ALSO]
MUIM\_Group\_InitChange
\end{deflist}


\subsection{Group.mui/MUIM\_Group\_InitChange}
\rule{\textwidth}{1mm}
\vspace{0.5cm}
\begin{deflist}{MMMMMMMM}
\item[\bf NAME]
MUIM\_Group\_InitChange (V11)
...
children at will. If you're done, use MUIM\_Group\_ExitChange
