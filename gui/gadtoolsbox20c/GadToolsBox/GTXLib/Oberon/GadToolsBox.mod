(* ------------------------------------------------------------------------
  ...
  :History.       v1.3 [jan] 29-Mar-93 (Library version bump to 39)
  :Copyright.     FD
  :Language.      Oberon
...
gtxbase.h    (Release: 1.0, Revision: 39.1)
...
PROCEDURE TagInArray* {base, -30} (Tag{0}: u.Tag; TagList{8}: ARRAY OF u.TagItem): LONGINT;
