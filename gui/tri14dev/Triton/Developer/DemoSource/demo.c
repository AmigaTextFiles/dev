...
ProjectDefinition(about_trwintags)
{
  ...
  VertGroupA, Space,  CenteredText3("Triton Demo 1.4"),
              SpaceS, CenteredText("� 1993-1995 by Stefan Zeiger"),
...
int main(void)
{
  if(TR_OpenTriton(TRITON14VERSION,
		   ...
		   TRCA_Version,"1.4",TAG_END))
  {
    do_main();
    TR_CloseTriton();
    return 0;
  } else puts("Can't open triton.library v5+.");
