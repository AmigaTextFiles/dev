...
{
    {STRING_KIND,  20,0, {0,0,0,0,NULL,NULL,GID_NAME,PLACETEXT_LEFT},NULL,GS_DefaultTags},
    {LISTVIEW_KIND,20,4, {0,0,0,0,NULL, NULL, GID_ADDRESS, PLACETEXT_LEFT}, addrlisttags, GS_DefaultTags},
    ...
    {STRING_KIND,   0,0, {0,0,0,0,"_BBS Name",NULL,GID_BBSNAME,PLACETEXT_LEFT},NULL,GS_DefaultTags},
...
ULONG DEMO_LayoutList[] =
{
    ...
    GUIL_VertGroup, 1,
        ...
        GUIL_VertGroup, 1,
            ...
            GUIL_FrameType, GUILFT_Ridge,
            GUIL_FrameHeadline, "Outbound bundling",
...
static const char ver[] = "$VER: System2 1.0 " __AMIGADATE__;

/* Now, some globals used by Generic.o during the call to GF_CreateGUIA() */

int DEMO_InitialOrientation = GUIL_HorizGroup;

STRPTR DEMO_WindowTitle = "Spot/System GUI (2)";
STRPTR DEMO_AppID       = "Spot.System2";

STRPTR DEMO_Version     = "1.0",
       DEMO_LongDesc    = "Demo program - The 'System' GUI of Spot (2)",
