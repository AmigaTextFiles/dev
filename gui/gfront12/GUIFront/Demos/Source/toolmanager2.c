...
static const char ver[] = "$VER: ToolManager2 1.0 " __AMIGADATE__;

/* Now, some globals used by Generic.o during the call to GF_CreateGUIA() */

int DEMO_InitialOrientation = GUIL_VertGroup;

STRPTR DEMO_WindowTitle = "ToolManager GUI (2)";
STRPTR DEMO_AppID       = "ToolManager2";

STRPTR DEMO_Version     = "1.0",
       DEMO_LongDesc    = "Demo program - Toolmanager prefs editor (2)",
