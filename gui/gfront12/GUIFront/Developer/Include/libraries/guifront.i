...
; V38
GUI_GroupMask           EQU TAG_USER+18     ; Group masking bits
GUI_GadgetMask          EQU TAG_USER+19     ; Gadget masking bits
GUI_LockGUI             EQU TAG_USER+20     ; Like GF_LockGUI()
...
; V38
GUIL_GadgetMask         EQU 11          ; Set current gadget masking value
GUIL_GroupMask          EQU 12          ; Set masking value for current group
...
PRF_PubScreenType           EQU TAG_USER+22     ; (UWORD)
PRF_PubScreenName           EQU TAG_USER+23     ; (UWORD)
...
PSA_DisplayID       EQU TAG_USER      ; (ULONG)
PSA_Width           EQU TAG_USER+1    ; (UWORD)
PSA_Height          EQU TAG_USER+2    ; (UWORD)
PSA_Depth           EQU TAG_USER+3    ; (UWORD)
PSA_Overscan        EQU TAG_USER+4    ; (UWORD)
PSA_Draggable       EQU TAG_USER+5    ; (BOOL)
PSA_Interleaved     EQU TAG_USER+6    ; (BOOL)
PSA_AutoScroll      EQU TAG_USER+7    ; (BOOL)
PSA_LeaveOpen       EQU TAG_USER+8    ; (BOOL)
PSA_ShowTitle       EQU TAG_USER+9    ; (BOOL)
PSA_Behind          EQU TAG_USER+10   ; (BOOL)
PSA_Quiet           EQU TAG_USER+11   ; (BOOL)
PSA_SharePens       EQU TAG_USER+12   ; (BOOL)
PSA_Exclusive       EQU TAG_USER+13   ; (BOOL)
PSA_MakeDefault     EQU TAG_USER+14   ; (BOOL)
PSA_PopPubScreen    EQU TAG_USER+15   ; (BOOL)
PSA_Shanghai        EQU TAG_USER+16   ; (BOOL)
PSA_ScreenTitle     EQU TAG_USER+17   ; (char *) (max 139 chars)
PSA_ScreenFont      EQU TAG_USER+18   ; (char *) (max 50 chars)
PSA_ScreenFontSize  EQU TAG_USER+19   ; (UWORD)
