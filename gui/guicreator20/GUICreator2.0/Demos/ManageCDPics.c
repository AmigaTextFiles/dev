...
struct Gadget *CreateGadgetsManageCDPicsWindow(struct Gadget **gadgetlist,struct NewGadget newgad[],struct Gadget *wingads[],struct ManageCDPicsWindowData *gadgetdata)
{
	...
	if (gadget)
		{
		wingads[LVID_CD]=gadget=CreateGadget(LISTVIEW_KIND,gadget,&newgad[LVID_CD],GA_Disabled,gadgetdata->gd_Disabled_CD,GTLV_Labels,(ULONG)gadgetdata->gd_Labels_CD,GTLV_ReadOnly,FALSE,GTLV_Selected,gadgetdata->gd_Selected_CD,GTLV_ShowSelected,NULL,GTLV_Top,gadgetdata->gd_Top_CD,LAYOUTA_Spacing,0,TAG_END);
		wingads[LVID_Category]=gadget=CreateGadget(LISTVIEW_KIND,gadget,&newgad[LVID_Category],GA_Disabled,gadgetdata->gd_Disabled_Category,GTLV_Labels,(ULONG)gadgetdata->gd_Labels_Category,GTLV_ReadOnly,FALSE,GTLV_Selected,gadgetdata->gd_Selected_Category,GTLV_ShowSelected,NULL,GTLV_Top,gadgetdata->gd_Top_Category,LAYOUTA_Spacing,0,TAG_END);
		wingads[LVID_Picture]=gadget=CreateGadget(LISTVIEW_KIND,gadget,&newgad[LVID_Picture],GA_Disabled,gadgetdata->gd_Disabled_Picture,GTLV_Labels,(ULONG)gadgetdata->gd_Labels_Picture,GTLV_ReadOnly,FALSE,GTLV_Selected,gadgetdata->gd_Selected_Picture,GTLV_ShowSelected,NULL,GTLV_Top,gadgetdata->gd_Top_Picture,LAYOUTA_Spacing,0,TAG_END);
		...
		wingads[TXID_Text]=gadget=CreateGadget(TEXT_KIND,gadget,&newgad[TXID_Text],GA_Disabled,gadgetdata->gd_Disabled_Text,GTTX_Border,TRUE,GTTX_CopyText,TRUE,GTTX_Text,(ULONG)gadgetdata->gd_Text_Text,TAG_END);
		wingads[LAID_Gadget9]=gadget=CreateGadget(TEXT_KIND,gadget,&newgad[LAID_Gadget9],GT_Underscore,'_',GTTX_Border,FALSE,TAG_END);
		wingads[STID_String]=gadget=CreateGadget(STRING_KIND,gadget,&newgad[STID_String],GA_Disabled,gadgetdata->gd_Disabled_String,GA_TabCycle,TRUE,GTST_MaxChars,64,GTST_String,(ULONG)gadgetdata->gd_String_String,GA_TabCycle,TRUE,STRINGA_ExitHelp,TRUE,STRINGA_Justification,GACT_STRINGLEFT,STRINGA_ReplaceMode,TRUE,TAG_END);
		...
		wingads[CYID_ToShow]=gadget=CreateGadget(CYCLE_KIND,gadget,&newgad[CYID_ToShow],GA_Disabled,gadgetdata->gd_Disabled_ToShow,GTCY_Labels,(ULONG)gadgetdata->gd_Labels_ToShow,GTCY_Active,gadgetdata->gd_Active_ToShow,TAG_END);
								...
								while (running && (imessage=GT_GetIMsg(win->UserPort)))
									...
									switch(idcmpclass)
										...
										case IDCMP_NEWSIZE:
											...
											GT_GetGadgetAttrs(wingads[LVID_CD],win,NULL,GA_Disabled,(ULONG)&longpointer1,GTLV_Labels,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Disabled_CD=(longpointer1 == 0)?FALSE:TRUE;
											gadgetdata.gd_Labels_CD=(struct List *)longpointer2;
											GT_GetGadgetAttrs(wingads[LVID_CD],win,NULL,GTLV_Top,(ULONG)&longpointer1,GTLV_Selected,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Top_CD=longpointer1;
											gadgetdata.gd_Selected_CD=longpointer2;
											GT_GetGadgetAttrs(wingads[LVID_Category],win,NULL,GA_Disabled,(ULONG)&longpointer1,GTLV_Labels,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Disabled_Category=(longpointer1 == 0)?FALSE:TRUE;
											gadgetdata.gd_Labels_Category=(struct List *)longpointer2;
											GT_GetGadgetAttrs(wingads[LVID_Category],win,NULL,GTLV_Top,(ULONG)&longpointer1,GTLV_Selected,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Top_Category=longpointer1;
											gadgetdata.gd_Selected_Category=longpointer2;
											GT_GetGadgetAttrs(wingads[LVID_Picture],win,NULL,GA_Disabled,(ULONG)&longpointer1,GTLV_Labels,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Disabled_Picture=(longpointer1 == 0)?FALSE:TRUE;
											gadgetdata.gd_Labels_Picture=(struct List *)longpointer2;
											GT_GetGadgetAttrs(wingads[LVID_Picture],win,NULL,GTLV_Top,(ULONG)&longpointer1,GTLV_Selected,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Top_Picture=longpointer1;
											gadgetdata.gd_Selected_Picture=longpointer2;
											GT_GetGadgetAttrs(wingads[TXID_Text],win,NULL,GA_Disabled,(ULONG)&longpointer1,GTTX_Text,(ULONG)&stringpointer,TAG_END);
											gadgetdata.gd_Disabled_Text=(longpointer1 == 0)?FALSE:TRUE;
											strcpy(gadgetdata.gd_Text_Text,stringpointer);
											GT_GetGadgetAttrs(wingads[STID_String],win,NULL,GA_Disabled,(ULONG)&longpointer1,GTST_String,(ULONG)&stringpointer,TAG_END);
											gadgetdata.gd_Disabled_String=(longpointer1 == 0)?FALSE:TRUE;
											strcpy(gadgetdata.gd_String_String,stringpointer);
											GT_GetGadgetAttrs(wingads[CYID_ToShow],win,NULL,GA_Disabled,(ULONG)&longpointer1,GTCY_Active,(ULONG)&longpointer2,TAG_END);
											gadgetdata.gd_Disabled_ToShow=(longpointer1 == 0)?FALSE:TRUE;
											gadgetdata.gd_Active_ToShow=longpointer2;
											GT_GetGadgetAttrs(wingads[CYID_ToShow],win,NULL,GTCY_Labels,(ULONG)&longpointer1,TAG_END);
											gadgetdata.gd_Labels_ToShow=(char * *)longpointer1;
											GT_GetGadgetAttrs(wingads[BTID_SavePrefs],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
											gadgetdata.gd_Disabled_SavePrefs=(longpointer1 == 0)?FALSE:TRUE;
											GT_GetGadgetAttrs(wingads[BTID_Show],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
										...
										case IDCMP_VANILLAKEY:
											switch(messagecode)
												{
												case 'c':
													GT_GetGadgetAttrs(wingads[LVID_CD],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
													if (longpointer1 == 0)
														{
														GT_GetGadgetAttrs(wingads[LVID_CD],win,NULL,GTLV_Selected,(ULONG)&longpointer1,TAG_END);
														GT_SetGadgetAttrs(wingads[LVID_CD],win,NULL,GTLV_Selected,longpointer1+1,TAG_END);
														GT_GetGadgetAttrs(wingads[LVID_CD],win,NULL,GTLV_Selected,(ULONG)&longpointer2,TAG_END);
												...
												case 'C':
													...
													break;
												case 'a':
													GT_GetGadgetAttrs(wingads[LVID_Category],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
													if (longpointer1 == 0)
														{
														GT_GetGadgetAttrs(wingads[LVID_Category],win,NULL,GTLV_Selected,(ULONG)&longpointer1,TAG_END);
														GT_SetGadgetAttrs(wingads[LVID_Category],win,NULL,GTLV_Selected,longpointer1+1,TAG_END);
														GT_GetGadgetAttrs(wingads[LVID_Category],win,NULL,GTLV_Selected,(ULONG)&longpointer2,TAG_END);
														if (longpointer2 != longpointer1)
															{
												...
												case 'A':
													...
													break;
												case 'p':
													GT_GetGadgetAttrs(wingads[LVID_Picture],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
													if (longpointer1 == 0)
														{
														GT_GetGadgetAttrs(wingads[LVID_Picture],win,NULL,GTLV_Selected,(ULONG)&longpointer1,TAG_END);
														GT_SetGadgetAttrs(wingads[LVID_Picture],win,NULL,GTLV_Selected,longpointer1+1,TAG_END);
														GT_GetGadgetAttrs(wingads[LVID_Picture],win,NULL,GTLV_Selected,(ULONG)&longpointer2,TAG_END);
														if (longpointer2 != longpointer1)
															{
												...
												case 'P':
													...
													break;
												case 'v':
													GT_GetGadgetAttrs(wingads[STID_String],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
													if (longpointer1 == 0) ActivateGadget(wingads[STID_String],win,NULL);
													break;
												case 't':
													GT_GetGadgetAttrs(wingads[CYID_ToShow],win,NULL,GA_Disabled,(ULONG)&longpointer1,TAG_END);
													if (longpointer1 == 0)
														{
														ShowGadget(win,wingads[CYID_ToShow],GADGET_DOWN);
														Delay(5);
														ShowGadget(win,wingads[CYID_ToShow],GADGET_UP  );
														GT_GetGadgetAttrs(wingads[CYID_ToShow],win,NULL,GTCY_Active,(ULONG)&longpointer1,TAG_END);
