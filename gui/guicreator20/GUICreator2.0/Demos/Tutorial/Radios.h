...
#define MXID_Radio1                    1
#define LAID_Gadget2                   2
#define MXID_Radio2                    3
...
extern void MXRadio1Clicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
extern void MXRadio2Clicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
