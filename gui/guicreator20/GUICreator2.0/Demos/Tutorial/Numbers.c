...
struct WindowData
	{
	BOOL    gd_Disabled_NBNumber1;
	LONG    gd_Number_NBNumber1;
	BOOL    gd_Disabled_NBNumber2;
	LONG    gd_Number_NBNumber2;
	BOOL    gd_Disabled_NBNumber3;
	LONG    gd_Number_NBNumber3;
	};
...
struct Gadget *CreateGadgetsWindow(struct Gadget **gadgetlist,struct NewGadget newgad[],struct Gadget *wingads[],struct WindowData *gadgetdata)
{
	...
	if (gadget)
		{
		wingads[NBID_Number1]=gadget=CreateGadget(NUMBER_KIND,gadget,&newgad[NBID_Number1],GA_Disabled,gadgetdata->gd_Disabled_NBNumber1,GTNM_Number,gadgetdata->gd_Number_NBNumber1,GTNM_Border,TRUE,GTNM_Justification,GTJ_RIGHT,TAG_END);
		wingads[NBID_Number2]=gadget=CreateGadget(NUMBER_KIND,gadget,&newgad[NBID_Number2],GA_Disabled,gadgetdata->gd_Disabled_NBNumber2,GTNM_Number,gadgetdata->gd_Number_NBNumber2,GTNM_Border,FALSE,GTNM_Justification,GTJ_LEFT,TAG_END);
		wingads[NBID_Number3]=gadget=CreateGadget(NUMBER_KIND,gadget,&newgad[NBID_Number3],GA_Disabled,gadgetdata->gd_Disabled_NBNumber3,GTNM_Number,gadgetdata->gd_Number_NBNumber3,GTNM_Border,TRUE,GTNM_Justification,GTJ_CENTER,TAG_END);
		return gadget;
		}
	else return NULL;
}
...
void HandleWindow(struct Screen *customscreen,LONG left,LONG top,APTR userdata)
{
	...
	if (visualinfo)
		...
		struct BevelFrame bevels[] = {
			XPOS(1),YPOS(1),XSIZE(24),YSIZE(11),"Numbers",3,
			};
		struct NewGadget newgad[] = {
			XPOS(3),YPOS(3),XSIZE(20),YSIZE(2),NULL,&textattr, NBID_Number1,PLACETEXT_LEFT,visualinfo,NULL,
			XPOS(3),YPOS(6),XSIZE(20),YSIZE(2),NULL,&textattr, NBID_Number2,PLACETEXT_LEFT,visualinfo,NULL,
			XPOS(3),YPOS(9),XSIZE(20),YSIZE(2),NULL,&textattr, NBID_Number3,PLACETEXT_LEFT,visualinfo,NULL,
			};
