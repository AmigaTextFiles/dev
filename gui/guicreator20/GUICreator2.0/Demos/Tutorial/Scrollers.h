...
#define SCID_Scroller1                 1
#define LAID_Gadget2                   2
#define SCID_Scroller2                 3
#define LAID_Gadget3                   4
#define SCID_Scroller3                 5
...
extern void SCScrollerClicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
extern void SCScroller2Clicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
extern void SCScroller3Clicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
