...
struct WindowData
	{
	BOOL    gd_Disabled_CBCheckbox1;
	BOOL    gd_Checked_CBCheckbox1;
	BOOL    gd_Disabled_CBCheckbox2;
	BOOL    gd_Checked_CBCheckbox2;
	BOOL    gd_Disabled_CBCheckbox3;
	BOOL    gd_Checked_CBCheckbox3;
	};
...
void HandleGadgetsWindow(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,struct WindowData *gadgetdata,APTR userdata)
{
	switch(gadgetid)
		{
		case CBID_Checkbox1:
			CBCheckbox1Clicked(win,wingads,gadgetid,messagecode,userdata);
			break;
		case CBID_Checkbox2:
			CBCheckbox2Clicked(win,wingads,gadgetid,messagecode,userdata);
			break;
		case CBID_Checkbox3:
			CBCheckbox3Clicked(win,wingads,gadgetid,messagecode,userdata);
			break;
		};
}
...
struct Gadget *CreateGadgetsWindow(struct Gadget **gadgetlist,struct NewGadget newgad[],struct Gadget *wingads[],struct WindowData *gadgetdata)
{
	...
	if (gadget)
		...
		wingads[CBID_Checkbox1]=gadget=CreateGadget(CHECKBOX_KIND,gadget,&newgad[CBID_Checkbox1],GA_Disabled,gadgetdata->gd_Disabled_CBCheckbox1,GTCB_Scaled,TRUE,GTCB_Checked,gadgetdata->gd_Checked_CBCheckbox1,TAG_END);
		wingads[CBID_Checkbox2]=gadget=CreateGadget(CHECKBOX_KIND,gadget,&newgad[CBID_Checkbox2],GA_Disabled,gadgetdata->gd_Disabled_CBCheckbox2,GTCB_Scaled,TRUE,GTCB_Checked,gadgetdata->gd_Checked_CBCheckbox2,TAG_END);
		wingads[CBID_Checkbox3]=gadget=CreateGadget(CHECKBOX_KIND,gadget,&newgad[CBID_Checkbox3],GA_Disabled,gadgetdata->gd_Disabled_CBCheckbox3,GTCB_Scaled,TRUE,GTCB_Checked,gadgetdata->gd_Checked_CBCheckbox3,TAG_END);
		return gadget;
		}
	else return NULL;
}
...
void HandleWindow(struct Screen *customscreen,LONG left,LONG top,APTR userdata)
{
	...
	ULONG  height=12,width=21,maxheight=1024,maxwidth=1280;
	...
	if (visualinfo)
		...
		struct BevelFrame bevels[] = {
			XPOS(1),YPOS(1),XSIZE(19),YSIZE(10),"Checkboxes",3,
			};
		struct NewGadget newgad[] = {
			XPOS(3),YPOS(3),XSIZE(11),YSIZE(2),"Checkbox _1:",&textattr, LAID_Gadget1,PLACETEXT_IN,visualinfo,NULL,
			XPOS(3),YPOS(5),XSIZE(11),YSIZE(2),"Checkbox _2:",&textattr, LAID_Gadget2,PLACETEXT_IN,visualinfo,NULL,
			XPOS(3),YPOS(7),XSIZE(11),YSIZE(2),"Checkbox _3:",&textattr, LAID_Gadget3,PLACETEXT_IN,visualinfo,NULL,
			XPOS(15),YPOS(3),XSIZE(3),YSIZE(2),NULL,&textattr, CBID_Checkbox1,PLACETEXT_ABOVE,visualinfo,NULL,
			XPOS(15),YPOS(5),XSIZE(3),YSIZE(2),NULL,&textattr, CBID_Checkbox2,PLACETEXT_ABOVE,visualinfo,NULL,
			XPOS(15),YPOS(7),XSIZE(3),YSIZE(2),NULL,&textattr, CBID_Checkbox3,PLACETEXT_ABOVE,visualinfo,NULL,
			};
		...
		if (CreateGadgetsWindow(&gadgetlist,newgad,wingads,&gadgetdata) != NULL)
			...
			win=OpenWindowTags(NULL,WA_Activate,         TRUE,
						...
						WA_InnerWidth,       width,
						WA_IDCMP,            IDCMP_CLOSEWINDOW|IDCMP_NEWSIZE|IDCMP_VANILLAKEY|IDCMP_REFRESHWINDOW|IDCMP_GADGETUP|CHECKBOXIDCMP,
						WA_Left,             left,
						WA_Top,              top,
									...
									switch(idcmpclass)
										...
										case IDCMP_VANILLAKEY:
											switch(messagecode)
												{
												case '1':
													GT_GetGadgetAttrs(wingads[CBID_Checkbox1],win,NULL,GA_Disabled,(ULONG)&longpointer2,GTCB_Checked,(ULONG)&longpointer1,TAG_END);
													if (longpointer2 == 0)
														{
														GT_SetGadgetAttrs(wingads[CBID_Checkbox1],win,NULL,GTCB_Checked,(longpointer1 == 0)?TRUE:FALSE,TAG_END);
														HandleGadgetsWindow(win,wingads,CBID_Checkbox1,(longpointer1 == 0)?1:0,&gadgetdata,userdata);
														}
													break;
												case '2':
													GT_GetGadgetAttrs(wingads[CBID_Checkbox2],win,NULL,GA_Disabled,(ULONG)&longpointer2,GTCB_Checked,(ULONG)&longpointer1,TAG_END);
													if (longpointer2 == 0)
														{
														GT_SetGadgetAttrs(wingads[CBID_Checkbox2],win,NULL,GTCB_Checked,(longpointer1 == 0)?TRUE:FALSE,TAG_END);
														HandleGadgetsWindow(win,wingads,CBID_Checkbox2,(longpointer1 == 0)?1:0,&gadgetdata,userdata);
														}
													break;
												case '3':
													GT_GetGadgetAttrs(wingads[CBID_Checkbox3],win,NULL,GA_Disabled,(ULONG)&longpointer2,GTCB_Checked,(ULONG)&longpointer1,TAG_END);
													if (longpointer2 == 0)
														{
														GT_SetGadgetAttrs(wingads[CBID_Checkbox3],win,NULL,GTCB_Checked,(longpointer1 == 0)?TRUE:FALSE,TAG_END);
														HandleGadgetsWindow(win,wingads,CBID_Checkbox3,(longpointer1 == 0)?1:0,&gadgetdata,userdata);
														}
													break;
												case 27:
													running=FALSE;
