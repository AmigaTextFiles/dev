...
#define BTID_Enable                    0
#define BTID_Button                    1
#define BTID_Disable                   2
...
extern void BTEnableClicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
extern void BTDisableClicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
