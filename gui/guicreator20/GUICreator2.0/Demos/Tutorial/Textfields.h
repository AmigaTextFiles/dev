...
#define TFID_Textfield1                0
#define TFID_Textfield2                1
...
extern void TFTexfield1Clicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
