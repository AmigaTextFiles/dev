...
#define LVID_Listview1                 0
#define LVID_Listview2                 1
...
extern void LVListview1Clicked(struct Window *win,struct Gadget *wingads[],ULONG gadgetid,ULONG messagecode,APTR userdata);
