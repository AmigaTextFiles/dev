...
extern BOOL DisabledKeyPressed( struct Window *, struct Gadget **, struct IE_Data *, struct IntuiMessage * );
extern BOOL HandleWindow(struct Window *, struct Gadget **, struct GFInfo *, struct IE_Data  *);
...
extern BOOL DisabledClicked( struct Window *, struct Gadget **, struct IE_Data *, struct IntuiMessage * );
