(*  REVISION HEADER
**
**  Program         :   Include:PCQUtils/triton.i
...
**                      All Rights Reserved.
**
**                      This header is for fast testing of triton
**                      program. You get just what you need to test
**                      the gui with nodelists. That's all, if you
**                      need some intuition struff use the header
**                      libraries/triton.i instead.
**
...
TYPE TR_App = RECORD (* This structure is PRIVATE! *)
         ...
         tra_AppPort    : Address;    (* Application message port    *)
         tra_IdcmpPort  : Address;    (* IDCMP message port          *)
         ...
         tra_InputEvent : Address; (* For RAWKEY conversion   *)
     END; (* TR_App *)
     TR_AppPtr = ^TR_App;
...
TYPE TR_Project = RECORD                                       (* This structure is PRIVATE! *)
         ...
         trp_PropAttr                 : Address;    (* The proportional font            *)
                                                        (* attributes                       *)
         trp_FixedWidthAttr           : Address;    (* The fixed-width font             *)
                                                        (* attributes                       *)
         trp_PropFont                 : Address;    (* The proportional font            *)
         trp_FixedWidthFont           : Address;    (* The fixed-width font             *)
         ...
         trp_BackfillHook             : Address;        (* The backfill hook                *)
         trp_GadToolsGadgetList       : Address;      (* List of GadTools                 *)
                                                        (* gadgets                          *)
         trp_PrevGadget               : Address;      (* Previous gadget                  *)
         trp_NewGadget                : Address;   (* GadTools NewGadget               *)

         trp_InvisibleRequest         : Address;   (* The invisible blocking requester *)
         ...
         trp_QuickHelpWindow          : Address;      (* The QuickHelp window             *)
