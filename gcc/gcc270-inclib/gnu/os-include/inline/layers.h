...
#define BASE_EXT_DECL0 extern struct Library * LayersBase;
#endif
...
CreateBehindHookLayer (BASE_PAR_DECL struct Layer_Info *li,struct BitMap *bm,long x0,long y0,long x1,long y1,long flags,struct Hook *hook,struct BitMap *bm2)
{
  ...
  : "a0","a1","a2","a3","d0","d1","d2","d3","d4", "memory");
  return _res;
}
extern __inline struct Layer *
...
extern __inline void 
DoHookClipRects (BASE_PAR_DECL struct Hook *hook,struct RastPort *rport,struct Rectangle *rect)
{
  BASE_EXT_DECL
  register struct Library *a6 __asm("a6") = BASE_NAME;
  register struct Hook *a0 __asm("a0") = hook;
  register struct RastPort *a1 __asm("a1") = rport;
  register struct Rectangle *a2 __asm("a2") = rect;
...
extern __inline struct Hook *
InstallLayerInfoHook (BASE_PAR_DECL struct Layer_Info *li,struct Hook *hook)
{
  BASE_EXT_DECL
  register struct Hook * _res  __asm("d0");
  register struct Library *a6 __asm("a6") = BASE_NAME;
...
extern __inline struct Layer_Info *
...
extern __inline void 
SortLayerCR (BASE_PAR_DECL struct Layer *layer,long dx,long dy)
{
  BASE_EXT_DECL
  register struct Library *a6 __asm("a6") = BASE_NAME;
  register struct Layer *a0 __asm("a0") = layer;
