...
#define BASE_EXT_DECL0 extern struct DosLibrary * DOSBase;
#endif
...
extern __inline struct DosList *
...
extern __inline struct CommandLineInterface *
Cli (BASE_PAR_DECL0)
{
  BASE_EXT_DECL
...
extern __inline struct Process *
...
#define CreateNewProcTags(tags...) \
  ({ struct TagItem _tags[] = { tags }; CreateNewProc (_tags); })
#endif /* not NO_INLINE_STDARG */
...
extern __inline struct DateStamp *
...
extern __inline LONG 
DoPkt0 (BASE_PAR_DECL struct MsgPort *port,long action)
{
  BASE_EXT_DECL
  register LONG _res __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
...
extern __inline LONG 
DoPkt1 (BASE_PAR_DECL struct MsgPort *port,long action,long arg1)
{
  BASE_EXT_DECL
  register LONG _res __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
...
extern __inline LONG 
DoPkt2 (BASE_PAR_DECL struct MsgPort *port,long action,long arg1,long arg2)
{
  BASE_EXT_DECL
  register LONG _res __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
...
extern __inline LONG 
DoPkt4 (BASE_PAR_DECL struct MsgPort *port,long action,long arg1,long arg2,long arg3,long arg4)
{
  BASE_EXT_DECL
  register LONG _res __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
  ...
  __asm __volatile ("jsr a6@(-0xf0)"
  : "=r" (_res)
  : "r" (a6), "r" (d1), "r" (d2), "r" (d3), "r" (d4), "r" (d5), "r" (d6)
...
extern __inline LONG 
FPutC (BASE_PAR_DECL BPTR fh,long ch)
{
  BASE_EXT_DECL
  register LONG  _res  __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
  register BPTR d1 __asm("d1") = fh;
  register long d2 __asm("d2") = ch;
...
extern __inline LONG 
FindArg (BASE_PAR_DECL STRPTR keyword,STRPTR arg_template)
{
  BASE_EXT_DECL
  register LONG  _res  __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
  register STRPTR d1 __asm("d1") = keyword;
  register STRPTR d2 __asm("d2") = arg_template;
...
extern __inline struct Segment *
...
extern __inline struct LocalVar *
...
extern __inline struct DevProc *
...
#define NewLoadSegTags(a0, tags...) \
  ({ struct TagItem _tags[] = { tags }; NewLoadSeg ((a0), _tags); })
#endif /* not NO_INLINE_STDARG */
...
extern __inline BOOL 
SetOwner (BASE_PAR_DECL STRPTR name,long owner_info)
{
  BASE_EXT_DECL
  register BOOL  _res  __asm("d0");
  register struct DosLibrary *a6 __asm("a6") = BASE_NAME;
  register STRPTR d1 __asm("d1") = name;
  register long d2 __asm("d2") = owner_info;
...
#define SystemTags(a0, tags...) \
  ({ struct TagItem _tags[] = { tags }; SystemTagList ((a0), _tags); })
#endif /* not NO_INLINE_STDARG */
...
#define FPrintf(a0, a1, tags...) \
  ({ struct TagItem _tags[] = { tags }; VFPrintf ((a0), (a1), _tags); })
#endif /* not NO_INLINE_STDARG */
extern __inline void 
...
#define FWritef(a0, a1, tags...) \
  ({ struct TagItem _tags[] = { tags }; VFWritef ((a0), (a1), _tags); })
#endif /* not NO_INLINE_STDARG */
extern __inline LONG 
...
#define Printf(a0, tags...) \
  ({ struct TagItem _tags[] = { tags }; VPrintf ((a0), _tags); })
#endif /* not NO_INLINE_STDARG */
extern __inline LONG 
...
extern __inline struct DosPacket *
