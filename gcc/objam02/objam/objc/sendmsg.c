...
static void __objc_send_initialize(OCClass*);

static void __objc_install_dispatch_table_for_class (OCClass*);

/* Forward declare some functions */
static void __objc_init_install_dtable(id, SEL);
static id __objc_missing_method(id, SEL, ...);
static Method_t search_for_method_in_hierarchy (OCClass* class, SEL sel);
...
static void __objc_init_install_dtable(id receiver, SEL op)
{
  ...
  if(CLS_ISCLASS(receiver->class_pointer))
  ...
  else
    {
      ...
      assert(CLS_ISCLASS((OCClass*)receiver));
	...
	__objc_send_initialize((OCClass*)receiver);
      else
	CLS_SETINITIALIZED((OCClass*)receiver);
    }
...
void __objc_install_premature_dtable(OCClass* class)
{
...
static void __objc_send_initialize(OCClass* class)
{
  Method_t m;
...
static void
__objc_install_dispatch_table_for_class (OCClass* class)
{
  OCClass* super;
  MethodList_t mlist;
  int counter;
...
void __objc_update_dispatch_table_for_class (OCClass* class)
{
  OCClass* next;
  struct sarray* save;
...
void
class_add_method_list (OCClass* class, MethodList_t list)
{
  int i;
...
Method_t
class_get_instance_method(OCClass* class, SEL op)
{
...
static Method_t
search_for_method_in_hierarchy (OCClass* cls, SEL sel)
{
