...
#define HAVE_andsi3_imm (rs6000_gen_cell_microcode \
   && !any_mask_operand (operands[2], SImode))
#define HAVE_anddi3_imm ((rs6000_gen_cell_microcode \
   && !any_mask_operand (operands[2], DImode)) && (TARGET_POWERPC64))
...
#define HAVE_extenddftf2_vsx (TARGET_LONG_DOUBLE_128 && TARGET_VSX && !TARGET_IEEEQUAD)
...
#define HAVE_elf_base_low (TARGET_ELF && ! TARGET_64BIT && TARGET_BASEREL && amigaos_baserel_operand(operands[2]))
#define HAVE_elf_high (TARGET_ELF && ! TARGET_64BIT)
#define HAVE_elf_low (TARGET_ELF && ! TARGET_64BIT && !(TARGET_BASEREL && amigaos_baserel_operand(operands[2])))
...
static inline rtx gen_p8_fmrgow_di                (rtx, rtx);
static inline rtx
gen_p8_fmrgow_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_fmrgow_df                (rtx, rtx);
static inline rtx
gen_p8_fmrgow_df(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_fmrgow_dd                (rtx, rtx);
static inline rtx
gen_p8_fmrgow_dd(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_mtvsrwz_1                (rtx, rtx);
static inline rtx
gen_p8_mtvsrwz_1(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_mtvsrwz_2                (rtx, rtx);
static inline rtx
gen_p8_mtvsrwz_2(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_p8_mtvsrd_1                 (rtx, rtx);
static inline rtx
gen_p8_mtvsrd_1(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_mtvsrd_2                 (rtx, rtx);
static inline rtx
gen_p8_mtvsrd_2(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_ti              (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_ti(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v16qi           (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v16qi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v8hi            (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v8hi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v4si            (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v4si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v4sf            (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v4sf(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v2di            (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v2di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v2df            (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v2df(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_p8_xxpermdi_v1ti            (rtx, rtx);
static inline rtx
gen_p8_xxpermdi_v1ti(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_reload_macho_picbase        (rtx);
static inline rtx
gen_reload_macho_picbase(rtx ARG_UNUSED (a))
{
  return 0;
}
