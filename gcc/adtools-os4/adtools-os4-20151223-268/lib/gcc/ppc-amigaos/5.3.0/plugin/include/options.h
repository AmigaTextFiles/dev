...
#endif
#ifdef GENERATOR_FILE
extern int CHECK68KFUNCPTR;
#else
  int x_CHECK68KFUNCPTR;
#define CHECK68KFUNCPTR global_options.x_CHECK68KFUNCPTR
#endif
#ifdef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_use_dynld;
#define x_VAR_use_dynld do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define OPTION_MASK_FPRND (HOST_WIDE_INT_1 << 9)
#define OPTION_MASK_DFP (HOST_WIDE_INT_1 << 10)
#define OPTION_MASK_SOFT_FLOAT (HOST_WIDE_INT_1 << 11)
#define OPTION_MASK_HTM (HOST_WIDE_INT_1 << 12)
#define OPTION_MASK_ISEL (HOST_WIDE_INT_1 << 13)
#define OPTION_MASK_MFCRF (HOST_WIDE_INT_1 << 14)
#define OPTION_MASK_MFPGPR (HOST_WIDE_INT_1 << 15)
#define OPTION_MASK_MINIMAL_TOC (HOST_WIDE_INT_1 << 16)
#define OPTION_MASK_MULHW (HOST_WIDE_INT_1 << 17)
#define OPTION_MASK_MULTIPLE (HOST_WIDE_INT_1 << 18)
#define OPTION_MASK_NO_UPDATE (HOST_WIDE_INT_1 << 19)
...
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1 << 33)
#define OPTION_MASK_STRING (HOST_WIDE_INT_1 << 34)
#define OPTION_MASK_UPPER_REGS_DF (HOST_WIDE_INT_1 << 35)
#define OPTION_MASK_UPPER_REGS_SF (HOST_WIDE_INT_1 << 36)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1 << 37)
#define OPTION_MASK_VSX_TIMODE (HOST_WIDE_INT_1 << 38)
...
enum opt_code
{
  ...
  OPT_m32 = 1137,                            /* -m32 */
  OPT_m64 = 1138,                            /* -m64 */
  OPT_mabi_altivec = 1139,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1140,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1141,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1142,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1143,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1144,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1145,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1146,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1147,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1148,                       /* -mabi=spe */
  OPT_mads = 1149,                           /* -mads */
  OPT_maix_struct_return = 1150,             /* -maix-struct-return */
  OPT_malign_ = 1151,                        /* -malign- */
  OPT_malign_branch_targets = 1152,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1153,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1154,             /* -mallow-movmisalign */
  OPT_maltivec = 1155,                       /* -maltivec */
  OPT_maltivec_be = 1156,                    /* -maltivec=be */
  OPT_maltivec_le = 1157,                    /* -maltivec=le */
  OPT_malways_hint = 1158,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1159,       /* -mavoid-indexed-addresses */
  OPT_mbaserel = 1160,                       /* -mbaserel */
  OPT_mbig = 1161,                           /* -mbig */
  OPT_mbig_endian = 1162,                    /* -mbig-endian */
  OPT_mbit_align = 1163,                     /* -mbit-align */
  OPT_mbit_word = 1164,                      /* -mbit-word */
  OPT_mblock_move_inline_limit_ = 1165,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1166,                       /* -mbss-plt */
  OPT_mcall_ = 1167,                         /* -mcall- */
  OPT_mcheck68kfuncptr = 1168,               /* -mcheck68kfuncptr */
  OPT_mcmpb = 1169,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1170,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1171,                          /* -mcpu= */
  OPT_mcrt_ = 1172,                          /* -mcrt= */
  OPT_mcrypto = 1173,                        /* -mcrypto */
  OPT_mdebug_ = 1174,                        /* -mdebug= */
  OPT_mdirect_move = 1175,                   /* -mdirect-move */
  OPT_mdlmzb = 1176,                         /* -mdlmzb */
  OPT_mdouble_float = 1177,                  /* -mdouble-float */
  OPT_meabi = 1178,                          /* -meabi */
  OPT_mefficient_unaligned_vector = 1179,    /* -mefficient-unaligned-vector */
  OPT_memb = 1180,                           /* -memb */
  OPT_mfloat_gprs_ = 1181,                   /* -mfloat-gprs= */
  OPT_mfp_in_toc = 1182,                     /* -mfp-in-toc */
  OPT_mfprnd = 1183,                         /* -mfprnd */
  OPT_mfpu_ = 1184,                          /* -mfpu= */
  OPT_mfriz = 1185,                          /* -mfriz */
  OPT_mfull_toc = 1186,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1187, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1188,            /* -mgen-cell-microcode */
  OPT_mhard_dfp = 1189,                      /* -mhard-dfp */
  OPT_mhard_float = 1190,                    /* -mhard-float */
  OPT_mhtm = 1191,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1192,            /* -minsert-sched-nops= */
  OPT_misel = 1193,                          /* -misel */
  /* OPT_misel_no = 1194, */                 /* -misel=no */
  /* OPT_misel_yes = 1195, */                /* -misel=yes */
  OPT_mlittle = 1196,                        /* -mlittle */
  OPT_mlittle_endian = 1197,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1198,                  /* -mlong-double- */
  OPT_mlongcall = 1199,                      /* -mlongcall */
  OPT_mlra = 1200,                           /* -mlra */
  OPT_mmfcrf = 1201,                         /* -mmfcrf */
  OPT_mmfpgpr = 1202,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1203,                   /* -mminimal-toc */
  OPT_mmulhw = 1204,                         /* -mmulhw */
  OPT_mmultiple = 1205,                      /* -mmultiple */
  OPT_mmvme = 1206,                          /* -mmvme */
  OPT_mnewlib = 1207,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1208,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1209,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1210,                        /* -mno-toc */
  OPT_mno_traceback = 1211,                  /* -mno-traceback */
  OPT_mno_update = 1212,                     /* -mno-update */
  OPT_moptimize_swaps = 1213,                /* -moptimize-swaps */
  OPT_mpaired = 1214,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1215,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1216,                       /* -mpopcntb */
  OPT_mpopcntd = 1217,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1218,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1219,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1220,                 /* -mpower8-vector */
  /* OPT_mpowerpc = 1221, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1222,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1223,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1224,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1225,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1226,                     /* -mprototype */
  OPT_mquad_memory = 1227,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1228,            /* -mquad-memory-atomic */
  OPT_mrecip = 1229,                         /* -mrecip */
  OPT_mrecip_precision = 1230,               /* -mrecip-precision */
  OPT_mrecip_ = 1231,                        /* -mrecip= */
  OPT_mregnames = 1232,                      /* -mregnames */
  OPT_mrelocatable = 1233,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1234,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1235,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1236,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1237,                  /* -msched-epilog */
  OPT_msched_groups = 1238,                  /* -msched-groups */
  OPT_msched_prolog = 1239,                  /* -msched-prolog */
  OPT_msdata = 1240,                         /* -msdata */
  OPT_msdata_ = 1241,                        /* -msdata= */
  OPT_msecure_plt = 1242,                    /* -msecure-plt */
  OPT_mshlib = 1243,                         /* -mshlib */
  OPT_msim = 1244,                           /* -msim */
  OPT_msimple_fpu = 1245,                    /* -msimple-fpu */
  OPT_msingle_float = 1246,                  /* -msingle-float */
  OPT_msingle_pic_base = 1247,               /* -msingle-pic-base */
  OPT_msoft_float = 1248,                    /* -msoft-float */
  OPT_mspe = 1249,                           /* -mspe */
  /* OPT_mspe_no = 1250, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1251, */                 /* -mspe=yes */
  OPT_mstrict_align = 1252,                  /* -mstrict-align */
  OPT_mstring = 1253,                        /* -mstring */
  OPT_msum_in_toc = 1254,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1255,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1256,                   /* -mtls-markers */
  OPT_mtls_size_ = 1257,                     /* -mtls-size= */
  OPT_mtoc = 1258,                           /* -mtoc */
  OPT_mtraceback_ = 1259,                    /* -mtraceback= */
  OPT_mtune_ = 1260,                         /* -mtune= */
  OPT_mupdate = 1261,                        /* -mupdate */
  OPT_mupper_regs = 1262,                    /* -mupper-regs */
  OPT_mupper_regs_df = 1263,                 /* -mupper-regs-df */
  OPT_mupper_regs_sf = 1264,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1265,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1266,            /* -mvectorize-builtins */
  OPT_mvrsave = 1267,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1268, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1269, */              /* -mvrsave=yes */
  OPT_mvsx = 1270,                           /* -mvsx */
  OPT_mvsx_align_128 = 1271,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1272,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1273,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1274, */       /* -mvsx-scalar-memory */
  OPT_mvsx_timode = 1275,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1276,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1277,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1278,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1279,                     /* -mxl-compat */
  OPT_myellowknife = 1280,                   /* -myellowknife */
  OPT_n = 1281,                              /* -n */
  ...
  OPT_shared = 1316,                         /* -shared */
  OPT_shared_libgcc = 1317,                  /* -shared-libgcc */
  /* OPT_specs = 1318, */                    /* -specs */
  OPT_specs_ = 1319,                         /* -specs= */
  OPT_static = 1320,                         /* -static */
  OPT_static_libasan = 1321,                 /* -static-libasan */
  OPT_static_libgcc = 1322,                  /* -static-libgcc */
  OPT_static_libgcj = 1323,                  /* -static-libgcj */
  OPT_static_libgfortran = 1324,             /* -static-libgfortran */
  OPT_static_libgo = 1325,                   /* -static-libgo */
  OPT_static_liblsan = 1326,                 /* -static-liblsan */
  OPT_static_libmpx = 1327,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1328,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1329,               /* -static-libstdc++ */
  OPT_static_libtsan = 1330,                 /* -static-libtsan */
  OPT_static_libubsan = 1331,                /* -static-libubsan */
  /* OPT_std_c__03 = 1332, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1333, */                /* -std=c++0x */
  OPT_std_c__11 = 1334,                      /* -std=c++11 */
  OPT_std_c__14 = 1335,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1336, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1337, */                /* -std=c++1y */
  OPT_std_c__1z = 1338,                      /* -std=c++1z */
  OPT_std_c__98 = 1339,                      /* -std=c++98 */
  OPT_std_c11 = 1340,                        /* -std=c11 */
  ...
  OPT_std_gnu__98 = 1358,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1359,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1360, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1361, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1362,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1363,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1364, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1365, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1366,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1367, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1368, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1369, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1370,                     /* -std=legacy */
  OPT_symbolic = 1371,                       /* -symbolic */
  OPT_t = 1372,                              /* -t */
  OPT_time = 1373,                           /* -time */
  OPT_time_ = 1374,                          /* -time= */
