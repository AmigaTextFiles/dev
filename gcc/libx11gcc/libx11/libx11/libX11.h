...
enum {
 ...
 WIN_MAPMELATER = (1<<6),
 WIN_OBSCURED = (1<<7),
 WIN_PARENTCLEARED = (1<<8),
}; /* flags */

/* structure for both real windows and childrens */

typedef struct {
  char *name; /* children have name = NULL .. */
  int RelX,RelY;
  ...
  int parent; /* our parent window */
  int root; /* our root window */
  Window win;
  int flags;
  ...
  IMap_p mChildren; /* our children */
  IMap_p mMappedChildren; /* our mapped children */

} X11Window;

extern X11Window *X11Windows;

#define BITMAP_USED  (1<<0)
...
typedef struct {
  ...
  InternalXEvent *X11InternalEvents,*X11InternalEventsLast;
...
extern struct RastPort fillmaskrp,backfillrp2;
...
extern X11ActualWindow *X11ActualWindows;
#endif
...
#define X11ROOT 5
#define X11NONE 127
#define X11NONEWINDOW 126
#define X11NONESUBWINDOW 125
...
extern void init_backfillrp(int,int,int);
