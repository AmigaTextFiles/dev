echo Configuring GCC for Windows NT on Alpha
rem This batch file assumes a unix-type "sed" program

echo #include "alpha/xm-winnt.h" >config.h
echo #include "alpha/xm-winnt.h" >hconfig.h
echo #include "alpha/xm-winnt.h" >tconfig.h
echo #include "alpha/winnt.h" >tm.h

rem This batch file assumes a unix-type "sed" program

echo # Makefile generated by "config-nt.bat"> Makefile
echo all.nt: cpp.exe cc1.exe xgcc.exe ld.exe>> Makefile
sed -f config/alpha/config-nt.sed Makefile.in >> Makefile
...
sed -f config/alpha/config-nt.sed cp\make-lang.in >> Makefile
sed -f config/alpha/config-nt.sed cp\makefile.in > cp\Makefile
set LANG=%LANG% c++.&	
:no_cp
...
sed -f config/alpha/config-nt.sed ada\make-lang.in >> Makefile
sed -f config/alpha/config-nt.sed ada\makefile.in > ada\Makefile
set LANG=%LANG% ada.&	
:no_ada
...
sed -f config/alpha/config-nt.sed f\make-lang.in >> Makefile
sed -f config/alpha/config-nt.sed f\makefile.in > f\Makefile
set LANG=%LANG% f.&	
:no_f
