...
echo #include "i386/xm-winnt.h" >config.h
echo #include "i386/xm-winnt.h" >hconfig.h
echo #include "i386/xm-winnt.h" >tconfig.h
echo #include "i386/winnt.h" >tm.h
...
sed -f config/i386/config-nt.sed ada\make-lang.in >> Makefile
sed -f config/i386/config-nt.sed ada\makefile.in > ada\Makefile
set LANG=%LANG% ada.&	
:no_ada
...
sed -f config/i386/config-nt.sed f\make-lang.in >> Makefile
sed -f config/i386/config-nt.sed f\makefile.in > f\Makefile
set LANG=%LANG% f.&	
:no_f
