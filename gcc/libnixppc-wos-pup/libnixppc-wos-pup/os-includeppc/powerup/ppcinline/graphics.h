...
#define AddAnimOb(anOb, anKey, rp) \
	...
	, GRAPHICS_BASE_NAME, IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SetCollision(num, routine, gelsInfo) \
	...
	, GRAPHICS_BASE_NAME, void (*__fpt)(struct VSprite *vSprite, APTR), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
