...
**
**
**	Slightly modified by Sebastian Huebner <cyco@gmx.de>:
**
**	 - openGLWindowTagList, attachGLWindowTagList, attachGLWndToRPTagList:
**	   "struct TagList *" replaced by "struct TagItem *"
**	 - #define glProject glProject_stub
**	   #define glUnProject glUnProject_stub
**	   #define glFrustum glFrustum_stub
**
**	See GCC-CyberGL.guide for details!
*/

#ifndef  CLIB_CYBERGL_H
#define  CLIB_CYBERGL_H 1
