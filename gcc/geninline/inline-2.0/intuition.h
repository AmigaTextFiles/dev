...
AddClass (BASE_PAR_DECL struct IClass *class)
{
  BASE_EXT_DECL
  register struct IntuitionBase* a6 __asm("a6") = BASE_NAME;
  register struct IClass *a0 __asm("a0") = class;
...
BuildEasyRequestArgs (BASE_PAR_DECL struct Window *window,struct EasyStruct *easyStruct,unsigned long idcmp,APTR args)
{
  ...
  : "a0","a1","a3","d0","d1");
  *(char *)a0 = *(char *)a0;  *(char *)a1 = *(char *)a1;  *(char *)a3 = *(char *)a3;
  return _res;
}
static __inline struct Window *
...
static __inline APTR 
NewObjectA (BASE_PAR_DECL struct IClass *class,UBYTE *classID,struct TagItem *tagList)
{
  BASE_EXT_DECL
  register APTR  _res  __asm("d0");
  register struct IntuitionBase* a6 __asm("a6") = BASE_NAME;
