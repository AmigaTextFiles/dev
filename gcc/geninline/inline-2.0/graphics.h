...
AttemptLockLayerRom (BASE_PAR_DECL struct Layer *layer)
{
  ...
  register BOOL  _res  __asm("d0");
  register struct GfxBase* a6 __asm("a6") = BASE_NAME;
  register struct Layer *a5 __asm("a3") = layer;
  __asm __volatile ("movel a5,sp@-; movel a3,a5; jsr a6@(-0x28e); movel sp@+,a5"
  : "=r" (_res)
  : "r" (a6), "r" (a5)
  : "a0","a1","a3","d0","d1");
  *(char *)a5 = *(char *)a5;
...
LockLayerRom (BASE_PAR_DECL struct Layer *layer)
{
  ...
  register struct GfxBase* a6 __asm("a6") = BASE_NAME;
  register struct Layer *a5 __asm("a3") = layer;
  __asm __volatile ("movel a3,sp@-; movel a3,a5; jsr a6@(-0x1b6); movel sp@+,a5"
  : /* no output */
  : "r" (a6), "r" (a5)
  : "a0","a1","a3","d0","d1");
  *(char *)a5 = *(char *)a5;
...
static __inline void 
SetCollision (BASE_PAR_DECL unsigned long num,void (*routine)(),struct GelsInfo *gelsInfo)
{
  BASE_EXT_DECL
  register struct GfxBase* a6 __asm("a6") = BASE_NAME;
...
TextExtent (BASE_PAR_DECL struct RastPort *rp,STRPTR string,long count,struct TextExtent *textExtent)
{
  ...
  : "a0","a1","a2","d0","d1");
  *(char *)a1 = *(char *)a1;  *(char *)a0 = *(char *)a0;  *(char *)a2 = *(char *)a2;
  return _res;
}
static __inline ULONG 
TextFit (BASE_PAR_DECL struct RastPort *rp,STRPTR string,unsigned long strLen,struct TextExtent *textExtent,struct TextExtent *constrainingExtent,long strDirection,unsigned long constrainingBitWidth,unsigned long constrainingBitHeight)
{
  ...
  *(char *)a1 = *(char *)a1;  *(char *)a0 = *(char *)a0;  *(char *)a2 = *(char *)a2;  *(char *)a3 = *(char *)a3;
  return _res;
}
static __inline WORD 
...
UnlockLayerRom (BASE_PAR_DECL struct Layer *layer)
{
  ...
  register struct GfxBase* a6 __asm("a6") = BASE_NAME;
  register struct Layer *a5 __asm("a3") = layer;
  __asm __volatile ("movel a5,sp@-; movel a3,a5; jsr a6@(-0x1bc); movel sp@+,a5"
  : /* no output */
  : "r" (a6), "r" (a5)
  : "a0","a1","a3","d0","d1");
  *(char *)a5 = *(char *)a5;
