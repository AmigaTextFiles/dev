    ...
    if (ra = ReadArgs(TEMPLATE,arg,NULL))
    {
        if (MUIMasterBase = OpenLibrary("muimaster.library",19))
        {
            ...
            if (app = ApplicationObject,
                    MUIA_Application_Title,         "SpeedBar Demo2",
                    MUIA_Application_Version,       "$VER: SpeedBarDemo2 16.1 (3.12.2002)",
                    ...
                    SubWindow, win = WindowObject,
                        ...
                        MUIA_Window_Title,          "SpeedBar Demo2",
                        WindowContents, VGroup,
                            Child, sb = SpeedBarObject,
                                ...
                                MUIA_SpeedBar_Strip,            arg[0] ? (char *)arg[0] : "Main.toolbar",
