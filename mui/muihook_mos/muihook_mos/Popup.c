...
SAVEDS ASM LONG StrObjFunc(Object *pop __asm("a2"),Object *str __asm("a1"))
{
        char *x,*s;
        int i;
...
SAVEDS ASM VOID ObjStrFunc(Object *pop __asm("a2"),Object *str __asm("a1"))
{
        char *x;
        DoMethod(pop,MUIM_List_GetEntry,MUIV_List_GetEntry_Active,&x);
        set(str,MUIA_String_Contents,(int)x);
}


SAVEDS ASM VOID WindowFunc(Object *pop __asm("a2"),Object *win __asm("a1"))
{
        set(win,MUIA_Window_DefaultObject,(int)pop);
}
