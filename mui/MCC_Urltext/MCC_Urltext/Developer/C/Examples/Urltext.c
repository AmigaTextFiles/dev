                ...
                WindowContents, VGroup,
                    Child, VGroup,
                        ...
                        Child, HGroup,
                            Child, HSpace(0),
                            Child, ColGroup(3),
                                Child, u0 = urlTextObject(MUIMasterBase,"http://alfie.altervista.org","Alfie's home page",MUIV_Font_Big),
                                Child, HSpace(0),
                                Child, u1 = urlTextObject(MUIMasterBase,"http://alfie.altervista.org/rxmui","RxMUI home page",MUIV_Font_Normal),
                                Child, u2 = urlTextObject(MUIMasterBase,"http://www.egroups.com/group/rxmui","RxMUI mail list",MUIV_Font_Normal),
                                Child, HSpace(0),
