...
**************************************************************************
**
** $Id: MuiClasses.mod,v 1.10 1996/08/14 23:23:49 olf Exp olf $
**
**************************************************************************)

FROM    SYSTEM      IMPORT CAST, ADR, BYTE, ADDRESS, REG, SETREG, ASSEMBLE, LONGSET;
...
PROCEDURE muiPen(pen : LONGCARD) : LONGCARD;
    BEGIN
        RETURN CAST(LONGCARD,CAST(LONGSET,pen) * CAST(LONGSET,muipenMask));
    END muiPen ;
