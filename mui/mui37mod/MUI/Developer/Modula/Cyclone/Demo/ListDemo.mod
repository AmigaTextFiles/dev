...
CONST   True =1;
        ...
        *)
        ...
        e1   =ListContents{"this", "is the", "first"};
        e2   =ListContents{"this", "is the", "second"};
        e3   =ListContents{"yeah!", "the", "third"};
        e4   =ListContents{"and this", "is the", "fourth"};
        e5   =ListContents{"last", "but not", "least"};
...
BEGIN
    ...
    list:=MM.ListObject(TAG(buffer,
                ...
                80423E66H,                  ed.LTRUE,               (* missing in 1.4 *)
                (*MD.maListTitle,             ed.LTRUE,               (* give it titles *)*)
               tagEnd));
    ...
    set(listview, MD.maCycleChain, LONGINT(ed.LTRUE)) ;
