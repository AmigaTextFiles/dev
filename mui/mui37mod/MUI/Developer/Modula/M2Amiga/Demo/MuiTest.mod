...
(* Cycle Chain for Keyboard *)
            ...
            set(bt1,  MD.maCycleChain, LONGINT(TRUE)) ;
            set(bt2,  MD.maCycleChain, LONGINT(TRUE)) ;
            set(bt3,  MD.maCycleChain, LONGINT(TRUE)) ;
            set(bt4,  MD.maCycleChain, LONGINT(TRUE)) ;
            set(bt5,  MD.maCycleChain, LONGINT(TRUE)) ;
            set(bt6,  MD.maCycleChain, LONGINT(TRUE)) ;
            set(Dirs, MD.maCycleChain, LONGINT(TRUE)) ;
