...
/*FR* As SAS/C has a lot of custom functions some have to
      replicated so that the app will work with different
      compilers such as StormC */
