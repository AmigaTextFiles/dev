...
/*FR* Added StormC compability */
#ifdef __STORM__
VOID SAVEDS ASM ObjStrFunc(REG(a2) Object *pop,REG(a1) Object *str)
#else
...
#ifdef __STORM__
VOID SAVEDS ASM WindowFunc(REG(a2) Object *pop,REG(a1) Object *win)
#else
