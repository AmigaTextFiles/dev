...
closeFun(REG(a0) struct Hook *hook,REG(a1) Object *str,REG(a2) Object *cal)
{
    char buf[128];
...
struct Hook closeHook = {{NULL,NULL},(HOOKFUNC)closeFun,NULL,NULL};
                ...
                SubWindow, win = WindowObject,
                    ...
                    WindowContents, VGroup,
                        Child, pop = PopobjectObject,
                            MUIA_Popstring_String, str = TextObject, TextFrame, MUIA_Text_PreParse, "\33c", End,
