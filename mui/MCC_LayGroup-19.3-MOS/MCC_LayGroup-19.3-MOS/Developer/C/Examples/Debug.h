/***************************************************************************
 ...
 MUI Custom Class common debug system
 ...
 MUI Custom Class Common Support Site:
    http://sourceforge.net/projects/common-mcc

 USAGE:
    - Call SetupDebug with class name string ("TextEditor.mcc") and class
      version string (ex: "15.25")
    - Include this header file in class implementation files to call debug
      functions
...
// class name must be MUI custom class name (ex: "TextEditor.mcc")
// class version must be MUI custom class full version string (ex: "15.25")
void SetupDebug(const char *class_name, const char *class_version);
