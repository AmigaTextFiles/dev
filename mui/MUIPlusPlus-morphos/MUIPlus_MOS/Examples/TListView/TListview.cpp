...
DisplayPerson (void)
{
    ...
    Person *person = (Person *)REG_A1;
    char **column = (char **)REG_A2;
    column[0] = person->name;
    //printf("jep\n");
}

static const struct SDI_EmulLibEntry Gate_DisplayPerson  =
 {
    SDI_TRAP_LIB,
    0,
    (void(*)()) DisplayPerson
...
main (void)
{
    ...
    (
        ...
        SubWindow, (Object *)(window = CMUI_Window
        (
            MUIA_Window_Title, "Test Program For Template Listview class",
            MUIA_Window_ID, 10,
            WindowContents, (Object *)(CMUI_VGroup
            (
                Child, (Object *)(list = CTMUI_Listview<Person>
                (
                    MUIA_Listview_List, (Object *)( CMUI_List
                    (
    ...
    window.Notify(MUIA_Window_CloseRequest, TRUE,
