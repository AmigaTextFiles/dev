...
#include "main.h"
#include "reggae_mcc/reggae_mcc.h"
#include "mui_def.c"
...
ULONG sigs = 0;
		...
		MUIA_Application_Title  , "Reggae Viewer",
		...
		SubWindow, window = WindowObject,
			MUIA_Window_Title, "Reggae Viewer",
			...
			MUIA_Window_UseRightBorderScroller,TRUE,
			 ...
			 Child, zip = ReggaeObject,MUIA_REGGAE_PATH,"Israel.jpg",End,
