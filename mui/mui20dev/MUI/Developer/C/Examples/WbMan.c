	...
	wi_string_request = WindowObject,
		...
		WindowContents, VGroup,
			...
			Child, HGroup,
				...
				Child, bt_string_ok = KeyButton("Ok",'o'),
				Child, HSpace(0),
				Child, bt_string_cancel = KeyButton("Cancel",'c'),
				End,
			End,
		End;
		...
		WindowContents, VGroup,
			...
			Child, VGroup,
				...
				Child, VGroup,
					...
					Child, HGroup,
						GroupSpacing(0),
						Child, bt_edit_new = KeyButton("New",'n'),
						Child, bt_edit_copy = KeyButton("Copy",'y'),
						Child, bt_edit_remove = KeyButton("Remove",'r'),
						End,
					Child, HGroup,
						GroupSpacing(0),
						Child, bt_edit_activate = KeyButton("Activate",'a'),
						Child, bt_edit_deactivate = KeyButton("Deactivate",'d'),
						End,
			...
			Child, HGroup,
				MUIA_Group_SameSize, TRUE,
				Child, bt_edit_save = KeyButton("Save",'s'),
				Child, HSpace(0),
				Child, bt_edit_cancel = KeyButton("Cancel",'c'),
				End,
			End,
		End;
	...
	app = ApplicationObject,
		...
		SubWindow, wi_main = WindowObject,
			...
			WindowContents, VGroup,
				Child, VGroup,
					...
					Child, VGroup,
						...
						Child, HGroup,
							...
							Child, bt_toggle		= KeyButton("Toggle",'t'),
							Child, bt_deactivate	= KeyButton("Deactivate",'d'),
							End,
						Child, HGroup,
							GroupSpacing(0),
							Child, bt_edit			= KeyButton("Edit Tooltypes",'e'),
							End,
						End,
					End,
				Child, VSpace(2),
				Child, HGroup,
					MUIA_Group_SameSize, TRUE,
					Child, bt_perform = KeyButton("Perform",'p'),
					Child, HSpace(0),
