...
*/
	...
	AP_Demo = ApplicationObject,
		...
		MUIA_Application_Version       , "$VER: MUI-Demo 7.39 (10.02.94)",
		MUIA_Application_Copyright     , "Copyright ©1993, Stefan Stuntz",
