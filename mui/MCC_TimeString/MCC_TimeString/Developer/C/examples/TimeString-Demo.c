...
**
** $VER: TimeString-Demo.c 12.5 (26.12.97)
**
*/
 ...
 static ULONG Win_New(struct IClass *cl, Object *obj, struct opSet *msg)
  {
   Object *TimeString,*Hour,*Min,*Sec,*saveobj,*loadobj,*format,*MidnightSecs;

   obj = (Object *)DoSuperNew(cl,obj,
                              MUIA_Window_ID,			MAKE_ID('D','E','M','O'),
                              MUIA_Window_Title,		"TimeString-Demo",
                              MUIA_Window_ScreenTitle,		"TimeString-Demo V12.4",
   ...
   if (obj != NULL)
    {
     ...
     /*result =*/ get(TimeString,MUIA_Time_MidnightSecs,&secs);
     ...
     /*result =*/ DoMethod(TimeString,MUIM_Notify,MUIA_Time_Hour,MUIV_EveryTime,Hour,3,MUIM_NoNotifySet,MUIA_Numeric_Value,MUIV_TriggerValue);
     /*result =*/ DoMethod(TimeString,MUIM_Notify,MUIA_Time_Minute,MUIV_EveryTime,Min,3,MUIM_NoNotifySet,MUIA_Numeric_Value,MUIV_TriggerValue);
     /*result =*/ DoMethod(TimeString,MUIM_Notify,MUIA_Time_Second,MUIV_EveryTime,Sec,3,MUIM_NoNotifySet,MUIA_Numeric_Value,MUIV_TriggerValue);
     /*result =*/ DoMethod(TimeString,MUIM_Notify,MUIA_Time_MidnightSecs,MUIV_EveryTime,MidnightSecs,3,MUIM_NoNotifySet,MUIA_Numeric_Value,MUIV_TriggerValue);
     ...
     /*result =*/ DoMethod(MidnightSecs,MUIM_Notify,MUIA_Numeric_Value,MUIV_EveryTime,TimeString,3,MUIM_Set,MUIA_Time_MidnightSecs,MUIV_TriggerValue);
 ...
 static ULONG App_New(struct IClass *cl, Object *obj, struct opSet *msg)
  {
   ...
   obj = (Object *)DoSuperNew(cl,obj,
                              ...
                              MUIA_Application_Copyright,       "© 1996-1997 Kai Hofmann",
                              MUIA_Application_Version,         "$VER: TimeString-Demo 12.4 " __AMIGADATE__,
     ...
     if (retstat == RETURN_OK)
      {
       ...
       if (ts != NULL)
       ...
       else
        {
         /*retstat =*/ muiclasses_Cleanup();
         CloseLibrary(MUIMasterBase);
         OpenReq("Missing TimeString.mcc!");
         retstat = RETURN_FAIL;
        }
      }
     else
