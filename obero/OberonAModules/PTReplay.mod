...
*     $Author: phf $
*
* Description: OberonA interface to ptreplay.library.
*
*   Copyright: Copyright (c) 1995 by Morten Bjergstrøm [phf].
*              All rights reserved.
*
...
This module was converted by Morten Bjergstrøm to make it work with
Oberon-A 1.6.
...
PROCEDURE OnChannel*    [base,-132](module[8]: ModulePtr; channels[0]: SET);
PROCEDURE OffChannel*   [base,-138](module[8]: ModulePtr; channels[0]: SET);
