...
PalRgb(1, 255, 0, 0)        ; Change the colour 1 of the used palette to red

Rgb(*ScrID, 1, 255, 255, 0) ; Change the display colour 1 to yellow !

CreatePalette(0,1 LSL ScreenDepth()) ; Create a blank palette with the number of colour of the screen
...
PrintN("Colour 3:"+Str(Red(3))+","+Str(Green(3))+","+Str(Blue(3)))
