...
SetSoundChannels(1, 1)            ; ...only on the 2nd channel

LoadSound(2, SoundPath$+"Explosion")
SetSoundChannels(2, 1)            ; ...only the 3nd channel
SetSoundVolume(2, 48)
...
If OpenScreen(1, 320, 25, 8, *TagList)
...
If OpenScreen(0,320,240,5, *TagList)
  ...
  AllocateAudioChannels(15) ; All Channels are reserved for Waponez II
  UseAsSoundChannels(15)    ; Now, tell than the sound library can use all !
