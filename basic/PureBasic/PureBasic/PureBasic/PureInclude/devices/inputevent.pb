...
;EndStructure   iepp_Position

Structure IEPointerPixel
    *iepp_Screen.l ; Was .Screen ;  pointer to an open screen
    X.w
    Y.w
EndStructure
...
;
    ient_ScaledX.w
    ient_ScaledY.w
    ient_ScaledXFraction.w
    ient_ScaledYFraction.w
