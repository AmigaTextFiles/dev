...
Structure Screen
    ...
    *FirstWindow.Window  ;  linked list Screen's Windows
    ...
    MouseY.w
    MouseX.w  ;  position relative to upper-left
...
#SHOWTITLE = $0010 ;  this gets set by a call to ShowTitle()

#BEEPING  = $0020 ;  set when Screen is beeping (private)
...
;
#SCREENHIRES = $0200 ;  do not use lowres gadgets  (private)
...
Structure NewScreen
    ...
    Type.w   ;  the Screen type (see defines above)
