...
Structure NewGadget
    ...
    ng_LeftEdge.w
    ng_TopEdge.w ;  gadget position
    ng_Width.w
    ng_Height.w  ;  gadget size
...
;#GTMENU_USERDATA(menu) = (* ( (APTR *)(((*)menu)+1) ) ).Menu
;#GTMENUITEM_USERDATA(menuitem) = (* ( (APTR *)(((*)menuitem)+1) ) ).MenuItem

;  Here is an old one for compatibility.  Do not use in new code!
;#MENU_USERDATA(menuitem) = (* ( (APTR *)(menuitem+1) ) )
