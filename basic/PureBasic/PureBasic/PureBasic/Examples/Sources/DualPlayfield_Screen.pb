...
; Window...
;
PaletteRGB(1, 100,100,100)
PaletteRGB(2, 255,255,255)
PaletteRGB(3, 0,0,155)
...
If OpenScreen(0, 320, 200, 4, *TagList)  ; Open a standard 16 colours screen
  ...
  SetWindowTagList(*TagList)
  If OpenWindow(0, 0, 10, 50, 50, #WFLG_DRAGBAR, "Hello")
