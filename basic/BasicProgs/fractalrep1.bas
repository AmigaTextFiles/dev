...
50    mx = ds-1: my = mx/2: pii = pi: rh = pii/6: vt = -pii/5
51    rc = cos(rh): rs = sin(rh)
52    vc = cos(vt): vs = sin(vt)
55    sl = 1000
...
470   if zz > sl or z2 > sl then pena 2
471   if (zz > 0 and z2 <= sl) or (z2 > 0 and z2 <= sl) then pena 8
...
1130  getkey a$
1140  end
60000 '   This program comes from "Creative Computing" July 1985 pp 78-82
...
60130 ' 470 return.   (check the next paragraph about line 470)
60140 '   Lines 470-471 have been added and the original line 470 is now
60150 ' line 472.  This will put white into the mountains when sl > 1000
60160 ' Also the lines 770-800, 860-890 have been changed.  The original
60170 ' lines 810-840, 900-920 deleted and lines 51-52 have been added.
60180 ' The new additions are from letters to the editor from the 
60190 ' Nov. 85 "Creative Computing" p. 6
