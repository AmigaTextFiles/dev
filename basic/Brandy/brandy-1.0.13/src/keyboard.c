...
/* ================================================================== */
/* ====== DOS/Linux/NetBSD/FreeBSD/MacOS versions of functions ====== */
/* ================================================================== */

#if defined(TARGET_LINUX) | defined(TARGET_NETBSD) | defined(TARGET_MACOSX) | defined(TARGET_DJGPP) | defined(TARGET_FREEBSD)
#include <sys/time.h>
#include <sys/types.h>
#include <errno.h>
#include <unistd.h>
...
#if defined(TARGET_LINUX) | defined(TARGET_NETBSD) | defined(TARGET_MACOSX) | defined(TARGET_FREEBSD)
...
/*
** 'pop_key' removes a key from the held key stack
*/
...
int32 emulate_get(void) {
  ...
  if (ch==NUL || ch==0xE0) {	/* DOS escape characters */
    ...
    push_key(ch);
    return NUL;		/* Return a null to indicate that a special key follows */
  }
  return ch & BYTEMASK;
}
...
#ifdef __SASC
long __stack = 67000;
const char *VERsion = "$VER: Brandy 1.13 "__AMIGADATE__" $";
#endif
