...
** Copyright (C) 2000, 2001, 2002 David Daniels
**
...
** to be added safely whe the line is executed
*/
...
static token tokens [] = {
  ...
  {"TOP",	3, 3, TYPE_FUNCTION,	TOKEN_TOP,	TYPE_FUNCTION, TOKEN_TOP,	FALSE,	FALSE},
  ...
  {"UNTIL",	5, 1, TYPE_ONEBYTE,	TOKEN_UNTIL,	TYPE_ONEBYTE, TOKEN_UNTIL,	FALSE,	FALSE},	/* 142 */
  {"USR",	3, 2, TYPE_FUNCTION,	TOKEN_USR,	TYPE_FUNCTION, TOKEN_USR,	FALSE,	FALSE},
  {"VAL",	3, 2, TYPE_FUNCTION,	TOKEN_VAL,	TYPE_FUNCTION, TOKEN_VAL,	FALSE,	FALSE},	/* 144 */
  ...
  {"WAIT",	4, 2, TYPE_ONEBYTE,	TOKEN_WAIT,	TYPE_ONEBYTE, TOKEN_WAIT,	TRUE,	FALSE},	/* 150 */
  ...
  {"XLATE$(",	7, 2, TYPE_FUNCTION,	TOKEN_XLATEDOL,	TYPE_FUNCTION, TOKEN_XLATEDOL,	FALSE,	FALSE},	/* 154 */
/*
...
*/
  {"APPEND",	6, 2, TYPE_COMMAND,	TOKEN_APPEND,	TYPE_COMMAND, TOKEN_APPEND,	FALSE,	FALSE},	/* 155 */
  {"AUTO",	4, 2, TYPE_COMMAND,	TOKEN_AUTO,	TYPE_COMMAND, TOKEN_AUTO,	FALSE,	FALSE},
  {"CRUNCH",	6, 2, TYPE_COMMAND,	TOKEN_CRUNCH,	TYPE_COMMAND, TOKEN_CRUNCH,	FALSE,	FALSE},	/* 157 */
  {"DELETE",	6, 3, TYPE_COMMAND,	TOKEN_DELETE,	TYPE_COMMAND, TOKEN_DELETE,	FALSE,	FALSE},	/* 158 */
  {"EDITO",	5, 5, TYPE_COMMAND,	TOKEN_EDITO,	TYPE_COMMAND, TOKEN_EDITO,	FALSE,	FALSE},
  {"EDIT",	4, 2, TYPE_COMMAND,	TOKEN_EDIT,	TYPE_COMMAND, TOKEN_EDIT,	FALSE,	FALSE},	/* 160 */
  {"HELP",	4, 2, TYPE_COMMAND,	TOKEN_HELP,	TYPE_COMMAND, TOKEN_HELP,	TRUE,	FALSE},	/* 161 */
  {"INSTALL",	7, 5, TYPE_COMMAND,	TOKEN_INSTALL,	TYPE_COMMAND, TOKEN_INSTALL,	FALSE,	FALSE},	/* 162 */
  {"LISTB",	5, 5, TYPE_COMMAND,	TOKEN_LISTB,	TYPE_COMMAND, TOKEN_LISTB,	FALSE,	FALSE}, /* 163 */
  ...
  {"NEW",	3, 3, TYPE_COMMAND,	TOKEN_NEW,	TYPE_COMMAND, TOKEN_NEW,	TRUE,	FALSE},	/* 171 */
  {"OLD",	3, 1, TYPE_COMMAND,	TOKEN_OLD,	TYPE_COMMAND, TOKEN_OLD,	TRUE,	FALSE},	/* 172 */
  {"QUIT",	4, 1, TYPE_ONEBYTE,	TOKEN_QUIT,	TYPE_ONEBYTE, TOKEN_QUIT,	TRUE,	FALSE},	/* 173 */
  {"RENUMBER",	8, 3, TYPE_COMMAND,	TOKEN_RENUMBER, TYPE_COMMAND, TOKEN_RENUMBER,	FALSE,	FALSE},	/* 174 */
  {"RUN",	3, 2, TYPE_ONEBYTE,	TOKEN_RUN,	TYPE_ONEBYTE, TOKEN_RUN,	TRUE,	FALSE},
  {"SAVEO",	5, 5, TYPE_COMMAND,	TOKEN_SAVEO,	TYPE_COMMAND, TOKEN_SAVEO,	FALSE,	FALSE},	/* 176 */
  {"SAVE",	4, 2, TYPE_COMMAND,	TOKEN_SAVE,	TYPE_COMMAND, TOKEN_SAVE,	FALSE,	FALSE},
  {"TEXTLOAD",	8, 3, TYPE_COMMAND,	TOKEN_TEXTLOAD, TYPE_COMMAND, TOKEN_TEXTLOAD,	FALSE,	FALSE},	/* 178 */
...
static int start_letter [] = {
  ...
  105, 106, 118, 131, 142, 144, 150, 154, NOKEYWORD, NOKEYWORD
};
...
** in tje array given by 'tokenbuf'.
...
** It rutirms TRUE if the line is okay otherwise it returns FALSE.
...
#define ACORNLEN	320	/* Size of buffer to hold plain text version of line */
...
/*
 * nospace - Tokens that should not be followed by a space
 * if expanding crunched code
 */
static byte nospace [] = {
  ACORN_FN, ACORN_PROC, ACORN_TO, ACORN_TIME1, ACORN_TIME2, 0
};
