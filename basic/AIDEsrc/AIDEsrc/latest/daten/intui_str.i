...
*--------------------------------------
SOptWinFlags    dc.l    WFLG_RMBTRAP!WFLG_DRAGBAR!WFLG_DEPTHGADGET!WFLG_CLOSEGADGET!WFLG_ACTIVATE!WFLG_GIMMEZEROZERO
SOptWinIDCMP    dc.l    IDCMP_GADGETDOWN!IDCMP_GADGETUP!IDCMP_CLOSEWINDOW!IDCMP_REFRESHWINDOW!IDCMP_MOUSEBUTTONS
*--------------------------------------
* IntuiTextStruktur
*------------------
