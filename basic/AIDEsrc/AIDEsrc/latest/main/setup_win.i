...
*-----------------------
        Locale  #ID_SetupWinTitle,a1    ;Zeiger auf Titel eintragen
...
* SuperOptimizer version Setting
*-------------------------------

        add     #033,gng_TopEdge(a1)    ;TopEdge aufaddieren
        move.l  #_SOptGadTexte,4(a2)    ;Zeiger auf TextPtrTabelle eintragen
        move.l  SOptVersion,12(a2)      ;aktuellen Zustand einstellen
        bsr     create_mx_gad           ;anlegen
...
create_button_gad
        ...
        Locale  gng_GadgetText(a1),gng_GadgetText(a1)
...
setup_beschriftung_ausgeben
        ...
        move.w  #250,4(a1)              ;LeftEdge
        move.w  #004,6(a1)              ;TopEdge
        move.l  0(a2),12(a1)            ;Zeiger auf Text eintragen
...
.loop1
        ...
        move.l  0(a2,d2),12(a1)         ;Zeiger auf Text eintragen
        bsr     print_locale            ;ausgeben
...
tabelle_setup_uprge
        ...
        dc.l    set_pubscreen,set_requester,set_cleanup,set_superoptversion
...
asl_dir_setup
        ...
        move.l  #IDdirname_Text,ASLReqTitel
                                        ;setze Titel für ASLFileRequester
        move.l  #1,_ASLonlydir          ;set flag
        bsr     asl_req_laden           ;FileRequester ausgeben
        move.l  #0,_ASLonlydir          ;del flag
...
asl_file_setup
        ...
        move.l  #IDfilename_Text,ASLReqTitel
                                        ;setze Titel für ASLFileRequester
        bsr     asl_req_laden           ;FileRequester ausgeben
        tst.l   d0                      ;"Cancel" gewählt, oder DirectoryError!
        beq.s   .ende                   ;ja
...
set_superoptversion
        ...
        move.l  d1,SOptVersion      ;dto.
        move.l  d1,superopt_version(a2)
...
SetupTextTable
                ...
                dc.l    IDDirSetup_Titel_Text

                dc.l    IDNewSrcDir_Titel_Text
                dc.l    IDNewTmpDir_Titel_Text
                dc.l    IDNewBltDir_Titel_Text
                dc.l    IDNewDocDir_Titel_Text
                dc.l    IDNewModDir_Titel_Text
                dc.l    IDNewFDDir_Titel_Text

                dc.l    IDNewEditor_Titel_Text
                dc.l    IDNewViewer_Titel_Text
                dc.l    IDNewAGD_Titel_Text
                dc.l    IDNewFD2BMAP_Titel_Text
                dc.l    IDNewAB2ASCII_Titel_Text
                dc.l    IDNewUppercACEr_Titel_Text

                dc.l    IDNewCalc_Titel_Text
                dc.l    IDNewReqEd_Titel_Text
                dc.l    IDNewUtil0_Titel_Text
                dc.l    IDNewUtil1_Titel_Text
                dc.l    IDNewUtil2_Titel_Text
                dc.l    IDNewUtil3_Titel_Text

                dc.l    IDOther_Text

                dc.l    IDPubScreen_Text1
                dc.l    IDPubScreen_Text2
                dc.l    IDReqSet_Text
                dc.l    IDCleanup_Text
                dc.l    IDsoptversion_Text

*--------------------------------------
_Yes_No_Texte   dc.l    IDtext_no
                dc.l    IDtext_yes
                dc.l    0
*--------------------------------------
_ReqGadTexte    dc.l    IDAll_Text
                dc.l    IDError_Text
                dc.l    IDMin_Text
                dc.l    0
*--------------------------------------
