...
#DTSIF_LAYOUT  = (1  LSL  0)

;  Object needs to be layed out
#DTSIF_NEWSIZE  = (1  LSL  1)

#DTSIF_DRAGGING  = (1  LSL  2)
#DTSIF_DRAGSELECT = (1  LSL  3)

#DTSIF_HIGHLIGHT  = (1  LSL  4)

;  Object is being printed
#DTSIF_PRINTING  = (1  LSL  5)

;  Object is in layout process
#DTSIF_LAYOUTPROC = (1  LSL  6)
...
#FRAMEF_SPECIFY = (1 LSL 0) ;  Make do with the dimensions of FrameBox provided.
...
Structure dtPrint
    ...
    *dtp_PIO.printerIO     ;  Printer IO request
...
Structure dtWrite
    ...
    *dtw_FileHandle.l ;  File handle to write to
    dtw_Mode.l
