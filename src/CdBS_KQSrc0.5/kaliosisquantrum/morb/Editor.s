...
* $Id: Editor.s 0.16 1998/04/29 13:41:09 MORB Exp MORB $
*
...
CONAsciiKey:
	 ...
	 LBLOCKEAI ConsoleClass_ID,a0,a1
	 move.l    con_COND_GetSBuffer(a1),a2
	 beq.s     .Done
	 move.l    con_COND_CallBack(a1),a3

	 move.b    d0,d2
	 cmp.b     #$a,d2
	 bne.s     .NotLF

	 clr.l     con_COND_GetSBuffer(a1)
	 LBLOCKEAI RawEditorClass_ID,a0,a1
	 move.l    red_REDT_CursorLine(a1),a1
	 move.l    ble_String(a0),a1
	 move.l    a2,a4
...
;fe
;fs "GetS"
CONGetS: ; a2=buffer a3=callback
	 LBLOCKEAI ConsoleClass_ID,a0,a1
	 move.l    a2,con_COND_GetSBuffer(a1)
	 move.l    a3,con_COND_CallBack(a1)
	 rts
;fe
;fe
