...
REM addresses and word values. Addresses 0 to 3 are ENFORCER hits
REM so treat them as such!!!. Addresses 16252928 to 16777214
REM inclusive is the 1/2MB ROM area so don't bother poking around
REM that area.
REM $VER: pokew.b_Version_0.20.00_(C)14-01-2007_B.Walker_G0LCU.
...
REM Don't allow any errors for 'pokevalue$'. Force a word value
