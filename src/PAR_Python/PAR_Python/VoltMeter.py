...
# ---------------------------------------------------------------------------
# This is my second attempt at Python programming to create a stand alone
# running program that will obtain a single byte of data from an AMIGA
# parallel port and display the value on screen in volts.
...
# ---------------------------------------------------------------------------
# This is the simple extention to display 0 to 5.1 Volts as a DC Voltmeter.
# There is an A-D Converter in the above archive and when used with this
# program will produce a very basic single range DC Voltmeter.
# ---------------------------------------------------------------------------
...
version = '$VER: VoltMeter.py_V1.00.00_(C)15-01-2006_B.Walker_G0LCU.'
...
print
print '               The voltage, using the A-D Converter is:- 0.00 V.'
...
def main():
	...
	while 1:
		...
		pointer.close()
		# ===========================================================
		# Convert the grabbed binary data byte into volts.
		volts = (ord(mybyte) * 0.02)
		# Over print the printed line AND print the voltage read.
		print '\v','               The voltage, using the A-D Converter is:-',volts,'V.        '
