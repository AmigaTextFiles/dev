...
## Package name      : perl5
## Source directory  : .
## Configuration time: Mon Mar 17 17:47:55 GMT 2003
## Configured by     : root
## Target system     : amigaos amiga unknown 45.57 m68k 68040 
#
## Configure command line arguments.
## Variables propagated from previous config.sh file.

my $config_sh = <<'!END!';
archlibexp='/gg/lib/perl5/5.00503/m68k-amigaos'
archname='m68k-amigaos'
cc='gcc'
ccflags='-DAMIGAOS -mstackextend -m68020-60 -resident32'
cppflags='-DAMIGAOS -mstackextend -m68020-60 -resident32'
dlsrc='dl_none.xs'
dynamic_ext=''
extensions='B DB_File Data/Dumper Fcntl IO IPC/SysV NDBM_File Opcode POSIX SDBM_File Socket attrs re Errno'
installarchlib='/gg/lib/perl5/5.00503/m68k-amigaos'
installprivlib='/gg/lib/perl5/5.00503'
libpth='/gg/lib'
libs='-lm -ldld'
osname='amigaos'
osvers='unknown'
prefix='/gg'
privlibexp='/gg/lib/perl5/5.00503'
sharpbang='#!'
shsharp='true'
...
so=' '
startsh='#!/bin/sh'
static_ext='B DB_File Data/Dumper Fcntl IO IPC/SysV NDBM_File Opcode POSIX SDBM_File Socket attrs re'
Author=''
CONFIG='true'
Date='$Date'
Header=''
...
apiversion='5.005'
ar='ar'
archlib='/gg/lib/perl5/5.00503/m68k-amigaos'
archobjs=''
awk='awk'
baserev='5.0'
bash=''
...
cccdlflags='none'
ccdlflags=''
ccsymbols='AMIGA=1 MCH_AMIGA=1 __AMIGA=1 __AMIGA__=1 __GNUC_MINOR__=95 __GNUC__=2 __MCH_AMIGA=1 __MCH_AMIGA__=1 __aligned=__attribute__((__aligned__(4))) __amiga__=1 __amigaos=1 __amigaos__=1 __chip=__attribute__((__chip__)) __interrupt=__attribute__((__interrupt__)) __ixemul=1 __ixemul__=1 __regargs=__attribute__((__regparm__)) __saveds=__attribute__((__saveds__)) __stackext=__attribute__((__stackext__)) __stdargs=__attribute__((__stkparm__)) amigaos=1 cpu=m68k ixemul=1 machine=m68k system=amigaos'
cf_by='root'
cf_email='root@man3dir.uucp'
cf_time='Mon Mar 17 17:47:55 GMT 2003'
chgrp=''
chmod=''
chown=''
clocktype='clock_t'
...
config_arg1='-ds'
config_arg2='-e'
config_arg3='-Dprefix=/gg'
config_argc='3'
config_args='-ds -e -Dprefix=/gg'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
cpp_stuff='42'
cppccsymbols='__amiga=1 __mc68000=1 __mc68000__=1 amiga=1 mc68000=1'
cpplast='-'
cppminus='-'
cpprun='gcc -E'
cppstdin='gcc -E'
...
installman3dir='/gg/lib/perl5/5.00503/man/man3'
installscript='/gg/bin'
installsitearch='/gg/lib/perl5/site_perl/5.005/m68k-amigaos'
installsitelib='/gg/lib/perl5/site_perl/5.005'
...
ld='ld'
lddlflags=''
ldflags='-m68020-60 -s -resident32'
less='less'
lib_ext='.a'
libc='/usr/lib/libc.a'
libperl='libperl.a'
...
man1ext='1'
man3dir='/gg/lib/perl5/5.00503/man/man3'
man3direxp='/gg/lib/perl5/5.00503/man/man3'
man3ext='3'
medium=''
mips=''
mips_type=''
...
mydomain='.uucp'
myhostname='man3dir'
myuname='amigaos amiga unknown 45.57 m68k 68040 '
n=''
netdb_hlen_type='int'
...
signal_t='void'
sitearch='/gg/lib/perl5/site_perl/5.005/m68k-amigaos'
sitearchexp='/gg/lib/perl5/site_perl/5.005/m68k-amigaos'
sitelib='/gg/lib/perl5/site_perl/5.005'
sitelibexp='/gg/lib/perl5/site_perl/5.005'
sizetype='size_t'
sleep=''
smail=''
small=''
