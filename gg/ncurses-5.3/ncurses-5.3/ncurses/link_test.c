...
extern int call_vwprintw (WINDOW * a1, char * a2, va_list z);
int call_vwprintw (WINDOW * a1, char * a2, va_list z)
{
	T((T_CALLED("vwprintw(%p,%s,%p)"), a1, _nc_visbuf2(1,a2), z)); returnCode(vwprintw(a1, a2, z));
}


extern int call_vw_printw (WINDOW * a1, char * a2, va_list z);
int call_vw_printw (WINDOW * a1, char * a2, va_list z)
{
