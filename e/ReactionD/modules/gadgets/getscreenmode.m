 ...
 */
#define GETSCREENMODE_Dummy         (REACTION_Dummy + $41000)
 ...
 */
#define GSM_REQUEST   ($610001)
/* The GSM_REQUEST method should be called whenever you want to open
 * a screenmode requester.
 */
OBJECT gsmRequest
  MethodID:ULONG,               /* GSM_REQUEST */
  gsmr_Window:PTR TO Window     /* The window that will be locked when the requester is active.
