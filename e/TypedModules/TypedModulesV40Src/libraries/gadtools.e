...
#define GTMENU_USERDATA(menu) (menu+SIZEOF menu)
#define GTMENUITEM_USERDATA(menuitem) (menuitem+SIZEOF menuitem)
#define MENU_USERDATA(menuitem) (menuitem+SIZEOF menuitem)
