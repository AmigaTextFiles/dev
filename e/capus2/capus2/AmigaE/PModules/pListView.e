/*"p_LockListView(gad,win)"*/
PROC p_LockListView(gad,win)
/*===============================================================================
...
ENDPROC
/**/
/*"p_UnLockListView(gad,win,list)"*/
PROC p_UnLockListView(gad,win,list) 
/*===============================================================================
 ...
 ==============================================================================*/
    ...
    ELSE
        Gt_SetGadgetAttrsA(gad,win,NIL,[GA_DISABLED,TRUE,GTLV_LABELS,NIL,TAG_DONE,0])
    ENDIF
ENDPROC
/**/
