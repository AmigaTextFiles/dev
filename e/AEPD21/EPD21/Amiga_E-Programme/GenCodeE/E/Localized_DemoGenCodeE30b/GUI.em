...
PROC create( display : PTR TO app_display ,
	...
	self.bt_put_constant_string := SimpleButton( getMBstring( cat.msg_BT_put_constant_string.getstr() ) )

	self.bt_put_variable := SimpleButton( getMBstring( cat.msg_BT_put_variable.getstr() ) )

	self.bt_return_id := SimpleButton( getMBstring( cat.msg_BT_return_id.getstr() ) )

	self.bt_call_hook := SimpleButton( getMBstring( cat.msg_BT_call_hook.getstr() ) )
	...
	self.bt_quit := SimpleButton( getMBstring( cat.msg_BT_quit.getstr() ) )
