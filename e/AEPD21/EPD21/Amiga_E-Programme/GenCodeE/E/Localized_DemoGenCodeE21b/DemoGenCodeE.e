...
PROC main() HANDLE
	...
	open_DemoGenCodeE_catalog( NIL , NIL )	/* see Locale.e */
	...
	string_var := get_DemoGenCodeE_string( msg_String_Variable_Put )
	...
	WHILE running
		...
		SELECT result_domethod
			...
			CASE ID_BUTTON_PRESSED	/* see GUI.em line 37 for the definition of this ID */
				...
				set( dgce.tx_result , MUIA_Text_Contents , get_DemoGenCodeE_string( msg_Modified_ID_Returned ) )
...
EXCEPT
	...
	SELECT exception
		...
		CASE "muim"
			...
			error_simple( get_DemoGenCodeE_string( msg_Missing_Muimaster_Library ) )

		CASE "icon"

			error_simple( get_DemoGenCodeE_string( msg_Missing_Icon_Library ) )

		CASE "MEM"

			error( get_DemoGenCodeE_string( msg_Not_Enough_Memory ) )
		...
		CASE "MUI"
			...
			SELECT mui_error
				...
				CASE MUIE_OutOfMemory
					...
					error_simple( get_DemoGenCodeE_string( msg_Not_Enough_Memory ) )

				CASE MUIE_OutOfGfxMemory

					error_simple( get_DemoGenCodeE_string( msg_Not_Enough_Chip_Memory ) )

				CASE MUIE_MissingLibrary

					error_simple( get_DemoGenCodeE_string( msg_Missing_Library ) )

				CASE MUIE_NoARexx

					error_simple( get_DemoGenCodeE_string( msg_Arexx_Port ) )

				DEFAULT

					error_simple( get_DemoGenCodeE_string( msg_Internal_Problem ) )
...
PROC error_simple( message : PTR TO CHAR ) RETURN EasyRequestArgs(	NIL , [ 20 , 0 ,
									get_DemoGenCodeE_string( msg_DGCE_Error ) ,
									message ,
									get_DemoGenCodeE_string( msg_Simple_OK ) ] , NIL , NIL )
...
PROC error( message : PTR TO CHAR ) RETURN Mui_RequestA(	dgce.app ,
								...
								NIL ,
								get_DemoGenCodeE_string( msg_DGCE_Error ) ,
								get_DemoGenCodeE_string( msg_OK ) ,
								message ,
								NIL )
...
//////////////////////////////////////////////////////////////////////////// */
PROC button_pressed( hook , obj , msg ) RETURN set( dgce.tx_result , MUIA_Text_Contents , get_DemoGenCodeE_string( msg_Modified_By_Hook ) )


/* ////////////////////////////////////////////////////////////////////////////
/////////////////////// Hook function called by ARexx command change_text /////
//////////////////////////////////////////////////////////////////////////// */
PROC change_text( hook , obj , msg ) RETURN set( dgce.tx_result , MUIA_Text_Contents , get_DemoGenCodeE_string( msg_Modified_By_Arexx ) )


/* ////////////////////////////////////////////////////////////////////////////
////////////////////////// Hook function called by ARexx in case of error /////
//////////////////////////////////////////////////////////////////////////// */
PROC arexx_error( hook , obj , msg ) RETURN error_simple( get_DemoGenCodeE_string( msg_Unknown_ARexx_Command ) )
