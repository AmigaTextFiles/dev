...
PROC put_header( application , locale ) OF gui_file
	...
	Fputs( self.file , 'OPT MODULE\n\n\n' )

	Fputs( self.file , '/*/////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , '///////////////////////////////////////////////////////////// Macro files /////\n' )
	Fputs( self.file , '///////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , 'MACROS ''MUI.pma''\n*/\n\n\n' )

	Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , '->////////////////////////////////////////////////////// External modules /////\n' )
	Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , 'MODULE ''muimaster'' , ''libraries/mui''\n' )
	Fputs( self.file , 'MODULE ''tools/boopsi''\n' )
...
PROC put_aux_objects( environment , application ) OF gui_file
	...
	IF environment
		...
		IF application
			...
			Fputs( self.file , 'EXPORT OBJECT app_arexx\n' )
			Fputs( self.file , '\tcommands :\tPTR TO mui_command\n' )
...
/********************************************************************************************************
** Write to the GUI file the definitions of the global variables (external ones used by notifications) **
********************************************************************************************************/
		...
		IF self.vars[ i ].type = TYPEVAR_EXTERNAL
			...
			IF first_global_var
				...
				IF environment
					...
					Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
					Fputs( self.file , '->/////////////////////////////////////////// Global variable definitions /////\n' )
					Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
...
PROC put_create_declaration( application ) OF gui_file
	...
	IF application
		...
		Fputs( self.file , ' icon  = NIL ,\n' )
		Fputs( self.file , '             arexx = NIL : PTR TO app_arexx ,\n' )
		Fputs( self.file , '             menu  = NIL ' )
...
PROC put_dispose_method() OF gui_file
	...
	Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , 'PROC dispose() OF ' )
	Fputs( self.file , self.main_object_ident )
...
PROC put_init_notifications_declaration() OF gui_file
	...
	Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , 'PROC init_notifications(' )
...
PROC put_aux_funcs() OF gui_file
	...
	Fputs( self.file , '->/////////////////////////////////////////////////////////////////////////////\n' )
	Fputs( self.file , 'PROC getMBstring( local_string : PTR TO CHAR ) RETURN ( IF local_string[ 1 ] = "\\0" THEN ( local_string + 2 ) ELSE local_string )\n' )
