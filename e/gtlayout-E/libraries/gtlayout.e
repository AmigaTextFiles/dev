/*
**	$VER: gtlayout.h 41.3 (15.5.97)
**	GadTools layout toolkit
**
**	Copyright © 1993-1997 by Olaf `Olsen' Barthel
**		Freely distributable.
**
**  E module conversion by Nuno Maltez (6.8.98)
*/
...
MODULE	'utility/tagitem', 'libraries/gadtools', 'intuition/screens', 
		'intuition/intuition'

/* Kinds of objects supported in addition to the normal GadTools kinds */
CONST 	HORIZONTAL_KIND = 45,
		VERTICAL_KIND = 46,
		END_KIND = 47,
		FRAME_KIND = 48,
		BOX_KIND = 49,
...
ENUM PLACE_LEFT, PLACE_RIGHT, PLACE_ABOVE, PLACE_IN, PLACE_BELOW

/* How to align text lines in BOX_KIND gadgets */
ENUM 	ALIGNTEXT_LEFT, ALIGNTEXT_CENTERED, ALIGNTEXT_RIGHT, ALIGNTEXT_PAD

/* The button images available for TAPEDECK_KIND gadgets. */
ENUM 	TDBT_BACKWARD, TDBT_FORWARD, TDBT_PREVIOUS, TDBT_NEXT, TDBT_STOP,
		TDBT_PAUSE, TDBT_RECORD, TDBT_REWIND, TDBT_EJECT, TDBT_PLAY, TDBTLAST

/* The frame types for groups. */
ENUM 	FRAMETYPE_NONE, FRAMETYPE_LABEL, FRAMETYPE_TAB

/* How to align the window opened by LT_Build() on the screen. */
#define ALIGNF_Right 		Shl(1,0)
#define ALIGNF_Left			Shl(1,1)
#define ALIGNF_Top			Shl(1,2)
#define ALIGNF_Bottom		Shl(1,3)
#define ALIGNF_ExtraRight	Shl(1,4)
#define ALIGNF_ExtraLeft	Shl(1,5)
#define ALIGNF_ExtraTop		Shl(1,6)
#define ALIGNF_ExtraBottom	Shl(1,7)

/* Generic tags, applicable for several object types */
CONST	LA_CHARS = TAG_USER+2,
...
/* BUTTON_KIND */
CONST	LABT_RETURNKEY = TAG_USER+34,
...
/* CYCLE_KIND */
CONST	LACY_FIRSTLABEL = TAG_USER+44,
...
/* FRACTION_KIND */
CONST	LAFR_INCREMENTERHOOK = TAG_USER+85

/* FRAME_KIND */
CONST	LAFR_INNERWIDTH = TAG_USER+9,
...
/* GAUGE_KIND */
CONST	LAGA_PERCENT = TAG_USER+36,
...
/* INTEGER_KIND */
CONST	LAIN_LASTGADGET = TAG_USER+28,
...
/* LISTVIEW_KIND */
CONST	LALV_EXTRALABELS = TAG_USER+26,
...
/* BOOPSI_KIND */
CONST	LABO_TAGCURRENT = TAG_USER+119,
...
/* MX_KIND */
CONST	LAMX_FIRSTLABEL = TAG_USER+44,
...
/* POPUP_KIND */
CONST	LAPU_FIRSTLABEL = TAG_USER+44,
...
/* SCROLLER_KIND */
CONST	LASC_THIN = TAG_USER+62,
		LASC_FULLSIZE = TAG_USER+188

/* STRING_KIND */
CONST	LAST_LASTGADGET = TAG_USER+28,
...
/* TAB_KIND */
CONST	LATB_FIRSTLABEL = TAG_USER+44,
...
/* TAPEDECK_KIND */
CONST	LATD_BUTTONTYPE = TAG_USER+86,
...
/* XBAR_KIND */
CONST	LAXB_FULLSIZE = TAG_USER+50,
		LAXB_FULLWIDTH = TAG_USER+50

/* Applicable for layout handle only */
CONST	LAHN_TEXTATTR = TAG_USER+41,
...
CONST	LAMN_FIRSTLABEL = LABX_FIRSTLABEL,
...
CONST	LA_PRIVATE1 = TAG_USER+100,
		LA_PRIVATE2 = TAG_USER+101

/* Last tag item value used */
CONST	LAST_TAG = TAG_USER+189
...
OBJECT layouthandle
	...
	visualinfo:PTR TO LONG
	amigaglyph:PTR TO image
	checkglyph:PTR TO image
	userdata:PTR TO LONG	/* Requires gtlayout.library V9 */
 ...
 * a LEVEL_KIND object.
 */
ENUM	TICKS_NONE  = 0,	/* No ticks please */
...
#define LAMN_Menu_Userdata(m)	(Long(m + SIZEOF menu))
#define LAMN_Menu_ID(m)			(Long(m + SIZEOF menu + 4))
#define LAMN_Item_Userdata(m)	(Long(m + SIZEOF menuitem))
#define LAMN_Item_ID(m)			(Long(m + SIZEOF menuitem + 4))


#ifdef GTLAYOUT_OBSOLETE
/* Obsolete tags, don't use in new code */
/*
CONST	LA_LINES = LABX_ROWS,
		LA_SPREAD = LAGR_SPREAD,
		LA_SAMESIZE = LAGR_SAMESIZE,
		LA_FULLCHECK = LASL_FULLCHECK,
		LA_EXTRALABELS = LALV_EXTRALABELS,
		LA_LASTGADGET = TAG_USER+28,
		LA_SMALLPALETTE = LAPA_SMALLPALETTE,
		LA_LABELS = LALV_LABELS,
		LA_PICKER = LATX_PICKER,
		LA_DRAWBOX = LAFR_DRAWBOX,
		LA_FIRSTLABEL = LABX_FIRSTLABEL,
		LA_LASTLABEL = LABX_LASTLABEL,
		LA_LABELTABLE = LABX_LABELTABLE,
		LA_MIN = TAG_USER+23,
		LA_MAX = TAG_USER+24,
		LA_LINK = LALV_LINK,
		LA_MENU = LAWN_MENU,
		LA_HISTORYLINES = LAST_HISTORYLINES,
		LA_HISTORYHOOK = LAST_HISTORYHOOK,
		LA_RETURNKEY = LABT_RETURNKEY,
		LA_EXTRAFAT = LABT_EXTRAFAT,
		LA_CURSORKEY = LALV_CURSORKEY,
		STORE_BYTE = TAG_USER+63,
		STORE_UBYTE = TAG_USER+64,
		STORE_WORD = TAG_USER+65,
		STORE_BOOL = TAG_USER+65,
		STORE_UWORD = TAG_USER+66,
		STORE_LONG = TAG_USER+67,
		STORE_ULONG = TAG_USER+68,
		STORE_STRPTR = TAG_USER+69,
		LAHN_FONT = TAG_USER+41,
		LH_FONT = TAG_USER+41,
		LH_AUTOACTIVATE = TAG_USER+42,
		LH_LOCALEHOOK = TAG_USER+4,
		LH_CLONINGPERMITTED = TAG_USER+61,
		LH_EDITHOOK = TAG_USER+74,
		LH_EXACTCLONE = TAG_USER+75,
		LH_MENUGLYPHS = TAG_USER+76,
		LH_PARENT = TAG_USER+83,
		LH_BLOCKPARENT = TAG_USER+84,
		LH_SIMPLECLONE = TAG_USER+90,
		LH_EXITFLUSH = TAG_USER+108,
		LH_USERDATA = TAG_USER+116,
		LH_RAWKEYFILTER = TAG_USER+142
...
CONST	PLACE_LEFT = PLACE_LEFT
		...
		ALIGNTEXT_LEFT		ALIGNTEXT_LEFT
		ALIGNTEXT_CENTERED	ALIGNTEXT_CENTERED
		ALIGNTEXT_RIGHT		ALIGNTEXT_RIGHT
		ALIGNTEXT_PAD		ALIGNTEXT_PAD

		TDBT_BACKWARD		TDBT_BACKWARD
		TDBT_FORWARD		TDBT_FORWARD
		TDBT_PREVIOUS		TDBT_PREVIOUS
		TDBT_NEXT		TDBT_NEXT
		TDBT_STOP		TDBT_STOP
		TDBT_PAUSE		TDBT_PAUSE
		TDBT_RECORD		TDBT_RECORD
		TDBT_REWIND		TDBT_REWIND
		TDBT_EJECT		TDBT_EJECT
		TDBT_PLAY		TDBT_PLAY

		ALIGNF_RIGHT		ALIGNF_RIGHT
		ALIGNF_LEFT		ALIGNF_LEFT
		ALIGNF_TOP		ALIGNF_TOP
		ALIGNF_BOTTOM		ALIGNF_BOTTOM
*/
CONST	ALIGNF_EXTRA_RIGHT = ALIGNF_EXTRARIGHT,
		ALIGNF_EXTRA_LEFT = ALIGNF_EXTRALEFT,
		ALIGNF_EXTRA_TOP = ALIGNF_EXTRATOP,
		ALIGNF_EXTRA_BOTTOM = ALIGNF_EXTRABOTTOM,
		HISTORYHOOK_DISCARD_OLDEST = HISTORYHOOK_DISCARDOLDEST
/*
		INCREMENTERMSG_DECREMENT	INCREMENTERMSG_DECREMENT
		INCREMENTERMSG_INITIAL		INCREMENTERMSG_INITIAL
		INCREMENTERMSG_INCREMENT	INCREMENTERMSG_INCREMENT
*/
