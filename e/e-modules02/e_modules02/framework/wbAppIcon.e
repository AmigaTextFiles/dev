...
-> drobna poprawka by Piotr Gapiïski (31.03.96)
...
ENDPROC self.handleDroppedIcons(appMsg.arglist,appMsg.numargs)
->---------------------------------------------^^^^^^^^^^^^^^
...
PROC handleDroppedIcons(argList:PTR TO wbarg,n=0) OF wbAppIcon IS PASS
->-------------------------------------------^^^
