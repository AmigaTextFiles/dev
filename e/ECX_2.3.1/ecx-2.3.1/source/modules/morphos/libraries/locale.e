...
CONST MS_ISO=0,
      ...
      OC_CODESET =  $80090005, /* V51 */
      SC_ASCII=0,
      SC_COLLATE1=1,
      SC_COLLATE2=2

CONST SC_UNICODE =  SC_ASCII
CONST UCF_IGNORE_CASE = (1 << 0)
...
CONST CODESET_LATIN1  = 0
CONST CODESET_UTF8    = 1
CONST CODESET_UTF32   = 2
CONST CODESET_COUNT   = 3

CONST CODESET_UCS4    = CODESET_UTF32
...
CONST UNICODE_INVALID = 0 /* ASCII or ISO-8859-1 */
CONST UNICODE_UTF8    = 1 /* UTF-8 */
CONST UNICODE_16_BE   = 2 /* UCS-2/UTF-16 big endian */
CONST UNICODE_16_LE   = 3 /* UCS-2/UTF-16 little endian */
CONST UNICODE_32_BE   = 4 /* UCS-4/UTF-32 big endian */
CONST UNICODE_32_LE   = 5 /* UCS-4/UTF-32 little endian */
