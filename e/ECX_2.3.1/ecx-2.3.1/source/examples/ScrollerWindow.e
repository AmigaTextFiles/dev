...
/* ScrollerWindow.e
   ...
   needs E v2.1b / v39 emodules with fixed icclass.m to compile

*/

-> if you run i on morphos with 3dlayers, it doesnt work anymore /LS
...
NewObjectA(NIL,'sysiclass', [SYSIA_DRAWINFO,dri,SYSIA_WHICH,which,SYSIA_SIZE,sysisize(),NIL])
...
PROC newbuttonobject(image:PTR TO object,taglist) IS NewObjectA(NIL,'buttongclass',
