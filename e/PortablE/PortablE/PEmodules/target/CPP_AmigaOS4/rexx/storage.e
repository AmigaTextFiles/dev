...
NATIVE {NexxStr} OBJECT nexxstr
    ...
    {ns_Buff}	buff[8]	:ARRAY OF BYTE /* buffer area for strings */
...
NATIVE {RexxArg} OBJECT rexxarg
    ...
    {ra_Buff}	buff[8]	:ARRAY OF BYTE /* buffer area */
ENDOBJECT                    /* size: 16 bytes (minimum) */
...
NATIVE {RXFB_SCRIPT} CONST RXFB_SCRIPT = 21 /* is a path to a script, not a string file */
...
NATIVE {RXFF_SCRIPT} CONST RXFF_SCRIPT = (1 SHL RXFB_SCRIPT)
