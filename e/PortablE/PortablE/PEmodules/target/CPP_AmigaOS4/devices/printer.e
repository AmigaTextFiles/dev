...
NATIVE {PRD_PRIVATECMD}     CONST PRD_PRIVATECMD     = (CMD_NONSTD+13)   /* PRIVATE: do not use! */

/* unimplemented commands */
NATIVE {PRD_LASTSAVEDPREFS} CONST PRD_LASTSAVEDPREFS = (CMD_NONSTD+14)   /* PRIVATE: do not use! */
