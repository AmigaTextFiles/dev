/* $Id: prtgfx.h,v 1.13 2005/11/10 15:31:33 hjfrieden Exp $ */
OPT NATIVE
...
NATIVE {WordColorEntry} OBJECT wordcolorentry
    {ColorWord}	colorword[4]	:ARRAY OF INT /* 1 entry for each of YMCB */
ENDOBJECT
