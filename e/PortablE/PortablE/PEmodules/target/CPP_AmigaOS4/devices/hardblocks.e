/* $Id: hardblocks.h,v 1.15 2005/11/10 15:31:33 hjfrieden Exp $ */
OPT NATIVE
...
NATIVE {RigidDiskBlock} OBJECT rigiddiskblock
    ...
    /* block list heads */
    {rdb_Obsolete1}	obsolete1	:ULONG         /* No longer used, was optional bad block list */
    ...
    {rdb_BootStrapCode}	bootstrapcode	:ULONG     /* Secondary bootstrap code. Uses sector type BOOT */
    {rdb_Reserved1}	reserved1[5]	:ARRAY OF ULONG      /* set to $ffffffff */
    ...
    {rdb_BootStrapName}	bootstrapname[108]	:ARRAY OF CHAR /* avallino: Filename for bootstrapper source
                                     as a terminated string. */
    {rdb_Reserved5}	reserved5[37]	:ARRAY OF ULONG
ENDOBJECT
...
NATIVE {PartitionBlock} OBJECT partitionblock
    ...
    {pb_DriveName}	drivename[32]	:ARRAY OF CHAR /*TEXT*/   /* preferred DOS device name: BSTR form */
...
NATIVE {BootstrapCodeBlock} OBJECT bootstrapcodeblock
    {bcb_ID}	id	:ULONG            /* 4 character identifier */
    {bcb_SummedLongs}	summedlongs	:ULONG   /* size of this checksummed structure */
    {bcb_ChkSum}	chksum	:VALUE        /* block checksum (longword sum to zero) */
    {bcb_HostID}	hostid	:ULONG        /* SCSI Target ID of host */
    {bcb_Next}	next	:ULONG          /* block number of the next BootstrapCodeBlock */
    {bcb_LoadData}	loaddata[123]	:ARRAY OF ULONG /* binary data of the bootstrapper */
    /* note [123] assumes 512 byte blocks */
ENDOBJECT

NATIVE {IDNAME_BOOTSTRAPCODE} CONST IDNAME_BOOTSTRAPCODE = $424f4f54 /* 'BOOT' */
