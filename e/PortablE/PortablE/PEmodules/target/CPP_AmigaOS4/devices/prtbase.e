...
NATIVE {PF_IOR0}      CONST PF_IOR0      = 1
NATIVE {PF_IOR1}      CONST PF_IOR1      = 2
NATIVE {PF_IOOPENDED} CONST PF_IOOPENDED = 4
NATIVE {PF_EXPUNGED}  CONST PF_EXPUNGED  = 128
...
NATIVE {PrtDriverPreferences} OBJECT prtdriverpreferences
    ...
    {pdp_PrinterID}	printerid[32]	:ARRAY OF CHAR /*TEXT*/              /* PRIVATE! driver specific id */
    {pdp_PrefName}	prefname[FILENAME_SIZE-16]	:ARRAY OF CHAR /*TEXT*/
