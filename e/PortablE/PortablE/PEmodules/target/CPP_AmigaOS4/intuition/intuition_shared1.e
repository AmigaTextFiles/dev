...
NATIVE {Screen} OBJECT screen
    ...
    {Title}	title	:/*STRPTR*/ ARRAY OF CHAR               /* null-terminated Title text */
    {DefaultTitle}	defaulttitle	:/*STRPTR*/ ARRAY OF CHAR        /* for Windows without ScreenTitle */
...
NATIVE {Menu} OBJECT menu
    ...
    {MenuName}	menuname	:/*STRPTR*/ ARRAY OF CHAR            /* text for this Menu Header */
...
NATIVE {MenuItem} OBJECT menuitem
    ...
    {SubItem}	subitem	:PTR TO menuitem  /* if non-zero, points to MenuItem
                                  for submenu */
...
NATIVE {IntuiText} OBJECT intuitext
    ...
    {IText}	itext	:/*STRPTR*/ ARRAY OF CHAR               /* pointer to null-terminated text */
...
NATIVE {Window} OBJECT window
    ...
    {ScreenTitle}	screentitle	:/*STRPTR*/ ARRAY OF CHAR /* if non-null, Screen title when Window is active */
