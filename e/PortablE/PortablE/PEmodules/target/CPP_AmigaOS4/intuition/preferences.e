...
NATIVE {Preferences} OBJECT preferences
    ...
    {PrinterFilename}	printerfilename[FILENAME_SIZE]	:ARRAY OF /*TEXT*/ CHAR/* file for printer       */
    ...
    {Pad}	pad[7 ]	:ARRAY OF UBYTE   /* This was UBYTE WorkName[FILENAME_SIZE];   */
                      /* (temp file for printer) in old versions.  */

    {PrinterDevPrivateFlags} printerdevprivateflags:UBYTE   /* system private (V51)         */
    {PrtDevOpenDeviceFlags} prtdevopendeviceflags:ULONG    /* flags for device below (V51) */
    {PrtDevName}	prtdevname[DEVNAME_SIZE]	:ARRAY OF /*TEXT*/ CHAR /* device used by printer.device
                                       * (omit the ".device")
                                       */
