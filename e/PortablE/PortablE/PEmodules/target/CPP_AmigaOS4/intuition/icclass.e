...
NATIVE {ICA_TARGET}     CONST ICA_TARGET     = (ICA_DUMMY + 1) /* interconnection target           */
NATIVE {ICA_MAP}        CONST ICA_MAP        = (ICA_DUMMY + 2) /* interconnection map tagitem list */
NATIVE {ICSPECIAL_CODE} CONST ICSPECIAL_CODE = (ICA_DUMMY + 3) /* a "pseudo-attribute", see below. */
