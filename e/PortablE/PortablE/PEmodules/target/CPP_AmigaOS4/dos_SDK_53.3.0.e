...
->NATIVE {Format} PROC
PROC Format(filesystem:/*CONST_STRPTR*/ ARRAY OF CHAR, volumename:/*CONST_STRPTR*/ ARRAY OF CHAR, dostype:ULONG) IS NATIVE {-(BOOLEAN)(0!=IDOS->Format(} filesystem {,} volumename {,} dostype {))} ENDNATIVE !!BOOL
->NATIVE {Relabel} PROC
...
PROC FormatPort(port:PTR TO mp, volumename:/*CONST_STRPTR*/ ARRAY OF CHAR, dostype:ULONG) IS NATIVE {IDOS->FormatPort(} port {,} volumename {,} dostype {)} ENDNATIVE !!VALUE
