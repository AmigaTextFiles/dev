...
NATIVE {FSB_ANTIALIASED} CONST FSB_ANTIALIASED = 4    /* this uses AATextFont structure (V48) */
NATIVE {FSF_ANTIALIASED} CONST FSF_ANTIALIASED = $10

NATIVE {FSB_COLORFONT}   CONST FSB_COLORFONT   = 6    /* this uses ColorTextFont structure */
NATIVE {FSF_COLORFONT}   CONST FSF_COLORFONT   = $40
NATIVE {FSB_TAGGED}      CONST FSB_TAGGED      = 7    /* the TextAttr is really a TTextAttr */
...
NATIVE {TextAttr} OBJECT textattr
    {ta_Name}	name	:NATIVE {CONST_STRPTR} ARRAY OF CHAR  /* name of the font */
...
NATIVE {TA_CharSet}   CONST TA_CHARSET   = (3 OR TAG_USER) /* New in V46: IANA Charset number */
 ...
 */
NATIVE {TA_Rebuild}   CONST TA_REBUILD   = (4 OR TAG_USER)
...
/*----- tfe_Flags1 (private) ---------------------------------------*/
NATIVE {TE1F_NOUNDERLINING}    CONST TE1F_NOUNDERLINING    = $01 /* Cant make this font underlined         */
NATIVE {TE1F_NOEMBOLDENING}    CONST TE1F_NOEMBOLDENING    = $02 /* Cant make this font bold               */
NATIVE {TE1F_NOSHEARING}       CONST TE1F_NOSHEARING       = $04 /* Cant make this font italic             */
NATIVE {TE1F_NODEUNDERLINING}  CONST TE1F_NODEUNDERLINING  = $08 /* Cant make this font non-underlined     */
NATIVE {TE1F_NODEEMBOLDENING}  CONST TE1F_NODEEMBOLDENING  = $10 /* Cant make this font non-bold           */
NATIVE {TE1F_NODESHEARING}     CONST TE1F_NODESHEARING     = $20 /* Cant make this font non-italic         */
NATIVE {TE1F_NOANTIALIASING}   CONST TE1F_NOANTIALIASING   = $40 /* Cant make this font antialiased        */
NATIVE {TE1F_GENFONT}          CONST TE1F_GENFONT          = $80 /* This font was generated via bullet API */

NATIVE {TextFontExtension} OBJECT textfontextension
    {tfe_MatchWord}	matchword	:UINT     /* a magic cookie */
    ...
    {tfe_OrigReplyPort}	origreplyport	:PTR TO mp /* original value in
                                              * tf_Extension */
    {tfe_Tags}	tags	:NATIVE {CONST struct TagItem *} ARRAY OF tagitem          /* Text Tags for the font */
    {tfe_OFontPatchS}	ofontpatchs	:APTR   /* (system private use) */
    {tfe_OFontPatchK}	ofontpatchk	:APTR   /* (system private use) */
...
->NATIVE {CTB_MAPCOLOR} CONST CTB_MAPCOLOR = 8      /* map ctf_FgColor to the rp_FgPen if it's */
->NATIVE {CTF_MAPCOLOR} CONST CTF_MAPCOLOR = $0100 /* is a valid color within ctf_Low..ctf_High */
->#endif
...
NATIVE {ColorTextFont} OBJECT colortextfont
    ...
    {ctf_FgColor}	fgcolor	:UBYTE         /* color that is remapped to
                                                  * FgPen */
    {ctf_Low}	low	:UBYTE             /* lowest color represented
                                                  * here */
    {ctf_High}	high	:UBYTE            /* highest color represented
                                                  * here */
    ...
    {ctf_CharData}	chardata[8]	:ARRAY OF APTR     /* pointers to bit planes
                                                  * ala tf_CharData */
ENDOBJECT

/*----- AATextFont -------------------------------------------------*/
NATIVE {AATextFont} OBJECT aatextfont
    {aatf_CTF}	ctf	:colortextfont
    {aatf_Modulo}	modulo	:UINT      /* Row modulo for the
                                              strike font data */
    {aatf_FreeMe}	freeme	:UINT      /* Private, defaults to 0 */
    {aatf_CharData}	chardata	:APTR    /* Chunky alpha maps
                                              for characters */
    {aatf_CharLoc}	charloc	:APTR     /* Pointer to location data for the
                                              strike font. Two words:
                                              pixel offset then size */
    {aatf_SelfPtr}	selfptr	:PTR TO aatextfont     /* Pointer to the structure itself
                                              to be able to detect modified
                                              TextFont copies that are no real
                                              AATextFonts */
    {aatf_Reserved}	reserved[2]	:ARRAY OF ULONG /* For future expansion,
                                              default to 0 */
ENDOBJECT

/****** TextExtent node *********************************************/
NATIVE {TextExtent} OBJECT textextent
     {te_Width}	width	:INT  /* same as TextLength */
