...
NATIVE {ExtSprite} OBJECT extsprite
    {es_SimpleSprite}	simplesprite	:simplesprite /* conventional simple sprite
                                          * structure */
    {es_wordwidth}	wordwidth	:UINT    /* graphics use only,
                                          * subject to change */
    {es_flags}	flags	:UINT        /* graphics use only,
                                          * subject to change */
ENDOBJECT
...
NATIVE {SPRITEA_OldDataFormat} CONST SPRITEA_OLDDATAFORMAT = $8100000a /* MUST pass in outputheight
                                          * if using this tag */
...
NATIVE {GSTAG_SCANDOUBLED}     CONST GSTAG_SCANDOUBLED     = $83000000 /* request "NTSC-Like" height
                                          * if possible. */
