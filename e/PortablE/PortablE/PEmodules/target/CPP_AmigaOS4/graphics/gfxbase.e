...
NATIVE {GfxBase} OBJECT gfxbase
    ...
    {UtilBase}	utilbase	:PTR TO ULONG              /* for hook and tag utilities */
    ...
    {SoftSprites}	softsprites	:BYTE           /* bit mask of size change             */
    ...
    {ClassicAmiga}	classicamiga	:UBYTE          /* Private - dont use */
    ...
    /* Added in V46 */
    {DefaultCharSet}	defaultcharset	:ULONG        /* Private - for diskfont.library */
    {RegionPool}	regionpool	:APTR            /* Private */
    {RegionPoolSemaphore}	regionpoolsemaphore	:PTR TO ss /* Private */
    /* Added in V47 */
    {DiskfontBase}	diskfontbase	:PTR TO lib /* Private - for diskfont.library */
    /* Added in V48 */
    {Antialiasing}	antialiasing	:ULONG          /* Private - for diskfont.library */
    /* Added in V51 */
    {RPPool}	rppool	:APTR                /* Private */
ENDOBJECT
...
NATIVE {QBOWNERn}       CONST QBOWNERN       = 1 /* blitter owned by blit queuer */
NATIVE {BLITMSG_FAULTn} CONST BLITMSG_FAULTN = 2

NATIVE {QBOWNER}        CONST QBOWNER        = $2
NATIVE {BLITMSG_FAULT}  CONST BLITMSG_FAULT  = $4

NATIVE {GBFLAGSB_TIMER} CONST GBFLAGSB_TIMER = 6
NATIVE {GBFLAGSF_TIMER} CONST GBFLAGSF_TIMER = $40
