...
NATIVE {View} OBJECT view
    ...
    {DyOffset}	dyoffset	:INT   /* for complete View positioning */
    {DxOffset}	dxoffset	:INT   /* offsets are +- adjustments to standard #s */
...
->"OBJECT vectable" is on-purposely missing from here (it can be found in 'graphics/gfx_shared1')
...
NATIVE {DBufInfo} OBJECT dbufinfo
    ...
    {dbi_SafeMessage}	safemessage	:mn /* replied to when safe
                                       to write to old bitmap */
    {dbi_UserData1}	userdata1	:APTR   /* first user data */

    {dbi_Link2}	link2	:APTR
    {dbi_Count2}	count2	:ULONG
    {dbi_DispMessage}	dispmessage	:mn /* replied to when new bitmap has been
