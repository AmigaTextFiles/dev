...
MODULE 'target/exec/types', 'target/utility/tagitem', 'target/intuition/intuition'
MODULE 'target/graphics/text', 'target/intuition/screens', 'target/graphics/gfx'
MODULE 'target/intuition/menuclass'		->a reminder for us to rename it's "NM_ITEM" to "NM_MENUITEM"
...
NATIVE {NewGadget} OBJECT newgadget
    {ng_LeftEdge}	leftedge	:INT   /* gadget position */
    {ng_TopEdge}	topedge	:INT    /* gadget position */
    {ng_Width}	width	:INT      /* gadget size */
    {ng_Height}	height	:INT     /* gadget size */
    {ng_GadgetText}	gadgettext	:/*STRPTR*/ ARRAY OF CHAR /* gadget label */
...
NATIVE {NewMenu} OBJECT newmenu
    ...
    {nm_Label}	label	:/*CONST_STRPTR*/ NATIVE {CONST_STRPTR} ARRAY OF CHAR       /* Menu's label */
    {nm_CommKey}	commkey	:/*CONST_STRPTR*/ NATIVE {CONST_STRPTR} ARRAY OF CHAR     /* MenuItem Command Key Equiv */
...
NATIVE {GTPA_IndicatorWidth}  CONST GTPA_INDICATORWIDTH  = GT_TAGBASE+19 /* Width of current-color
                                            * indicator */
NATIVE {GTPA_IndicatorHeight} CONST GTPA_INDICATORHEIGHT = GT_TAGBASE+20 /* Height of current-color
                                            * indicator */
...
NATIVE {GTST_String}          CONST GTST_STRING          = GT_TAGBASE+45 /* String gadget's displayed
                                            * string */
...
NATIVE {GTMN_Checkmark}       CONST GTMN_CHECKMARK       = GT_TAGBASE+65 /* ti_Data is checkmark image
                                              to use */
NATIVE {GTMN_AmigaKey}        CONST GTMN_AMIGAKEY        = GT_TAGBASE+66 /* ti_Data is Amiga-key image
                                              to use */
...
NATIVE {GTLV_CallBack}        CONST GTLV_CALLBACK        = GT_TAGBASE+83 /* general-purpose listview call
                                            * back
                                            */
NATIVE {GTLV_MaxPen}          CONST GTLV_MAXPEN          = GT_TAGBASE+84 /* maximum pen number used by call
                                            * back
                                            */
...
NATIVE {GTBB_EdgesOnly}       CONST GTBB_EDGESONLY       = GT_TAGBASE+90 /* Make BevelBox edges-only */

/* New to V51.4 GadTools.  Ignored by older versions */
NATIVE {GTMN_CharSet}         CONST GTMN_CHARSET         = GT_TAGBASE+91 /* Menu charset */
