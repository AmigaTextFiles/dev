...
PUBLIC MODULE 'target/intuition'  ->so that the End macro provided by Intuition's menuclass is visible by users of this module
...
/* Attributes */
NATIVE {MUIA_Dtpic_Alpha} CONST MUIA_Dtpic_Alpha = $8042b4db /* V20 isg LONG              */
NATIVE {MUIA_Dtpic_DarkenSelState} CONST MUIA_Dtpic_DarkenSelState = $80423247 /* V20 i.g BOOL              */
NATIVE {MUIA_Dtpic_Fade} CONST MUIA_Dtpic_Fade = $80420429 /* V20 isg LONG              */
NATIVE {MUIA_Dtpic_LightenOnMouse} CONST MUIA_Dtpic_LightenOnMouse = $8042966a /* V20 i.g BOOL              */
