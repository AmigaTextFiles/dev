/* $Id: button.h,v 1.13 2005/12/13 21:39:53 mtantignone Exp $ */
OPT NATIVE
...
NATIVE {BUTTON_Array}              CONST BUTTON_ARRAY              = (BUTTON_DUMMY+3)
...
NATIVE {BUTTON_Current}            CONST BUTTON_CURRENT            = (BUTTON_DUMMY+9)
...
NATIVE {BUTTON_EraseBackground}    CONST BUTTON_ERASEBACKGROUND    = (BUTTON_DUMMY+57)
...
NATIVE {BUTTON_HorizAlignment}     CONST BUTTON_HORIZALIGNMENT     = (BUTTON_DUMMY+58)
...
NATIVE {BUTTON_VertAlignment}      CONST BUTTON_VERTALIGNMENT      = (BUTTON_DUMMY+59)
 ...
 */
NATIVE {BALIGN_LEFT}   CONST BALIGN_LEFT   = 0
NATIVE {BALIGN_TOP}    CONST BALIGN_TOP    = 0
NATIVE {BALIGN_CENTER} CONST BALIGN_CENTER = 1  /* Default - center image */
NATIVE {BALIGN_RIGHT}  CONST BALIGN_RIGHT  = 2
NATIVE {BALIGN_BOTTOM} CONST BALIGN_BOTTOM = 2
