...
PROC Mui_RequestA(app:PTR TO INTUIOBJECT,win:PTR TO INTUIOBJECT,flags:LONGBITS,title:ARRAY OF CHAR,gadgets:ARRAY OF CHAR,format:ARRAY OF CHAR,params:APTR) IS NATIVE {IMUIMaster->MUI_RequestA(} app {,} win {,} flags {,} title {,} gadgets {,} format {,} params {)} ENDNATIVE !!VALUE
->NATIVE {MUI_Request} PROC
PROC Mui_Request(app:PTR TO INTUIOBJECT,win:PTR TO INTUIOBJECT,flags:LONGBITS,title:ARRAY OF CHAR,gadgets:ARRAY OF CHAR,format:ARRAY OF CHAR,format2=0:ULONG, ...) IS NATIVE {IMUIMaster->MUI_Request(} app {,} win {,} flags {,} title {,} gadgets {,} format {,} format2 {,} ... {)} ENDNATIVE !!VALUE
