/* $Id: bevel.h,v 1.13 2005/11/10 15:36:44 hjfrieden Exp $ */
OPT NATIVE
...
NATIVE {BVS_NONE}         CONST BVS_NONE         = 4 /* Do not render any bevel. */
 ...
 */
NATIVE {BVS_CONTAINER}   CONST BVS_CONTAINER   = 12 /* Scroller container. */
NATIVE {BVS_KNOB}        CONST BVS_KNOB        = 13 /* Scroller knob. */
NATIVE {BVS_DISPLAY}     CONST BVS_DISPLAY     = 14 /* Read-only area. */
