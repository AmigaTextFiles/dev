 ...
 */
NATIVE {GlyphWidthEntry32} OBJECT glyphwidthentry32
    {gwe32_Node}	node	:mln     /* on list returned by OT_WidthList32 inquiry */
    {gwe32_reserved}	reserved	:UINT /* for alignment and backwards compatibility */
    {gwe32_Width}	width	:FIXED    /* character advance, as fraction of em width */
    {gwe32_Code}	code	:ULONG     /* entry's character code value */
ENDOBJECT
