/* C++ module, $VER: utility_protos.h 40.1 (17.5.1996) */
...
NATIVE {_PROTO_UTILITY_H} CONST
NATIVE {PRAGMA_UTILITY_H} CONST
NATIVE {PRAGMAS_UTILITY_PRAGMAS_H} CONST
...
PROC AllocNamedObject( name:ARRAY OF CHAR, tag1:TAG, tag12=0:ULONG, ... ) IS NATIVE {AllocNamedObject(} name {,} tag1 {,} tag12 {,} ... {)} ENDNATIVE !!PTR TO namedobject
