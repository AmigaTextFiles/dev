...
NATIVE {_INLINE_IDENTIFY_H} CONST
NATIVE {PRAGMAS_IDENTIFY_PRAGMAS_H} CONST
...
->PROC IdAlertTags(param1:ULONG, param2:ULONG,param22=0:ULONG, ...) IS NATIVE {IdAlertTags(} param1 {,} param2 {,} param22 {,} ... {)} ENDNATIVE !!VALUE
...
->PROC IdEstimateFormatSizeTags(param1:/*STRPTR*/ ARRAY OF CHAR, param2:ULONG,param22=0:ULONG, ...) IS NATIVE {IdEstimateFormatSizeTags(} param1 {,} param2 {,} param22 {,} ... {)} ENDNATIVE !!ULONG
...
->PROC IdExpansionTags(param1:ULONG,param12=0:ULONG, ...) IS NATIVE {IdExpansionTags(} param1 {,} param12 {,} ... {)} ENDNATIVE !!VALUE
...
->PROC IdFormatStringTags(param1:/*STRPTR*/ ARRAY OF CHAR, param2:/*STRPTR*/ ARRAY OF CHAR, param3:ULONG, param32=0:ULONG, ...) IS NATIVE {IdFormatStringTags(} param1 {,} param2 {,} param3 {,} param32 {,} ... {)} ENDNATIVE !!ULONG
...
->PROC IdFunctionTags(param1:/*STRPTR*/ ARRAY OF CHAR, param2:VALUE, param3:ULONG,param32=0:ULONG, ...) IS NATIVE {IdFunctionTags(} param1 {,} param2 {,} param3 {,} param32 {,} ... {)} ENDNATIVE !!VALUE
...
->PROC IdHardwareTags(param1:ULONG, param2:ULONG,param22=0:ULONG, ...) IS NATIVE {IdHardwareTags(} param1 {,} param2 {,} param22 {,} ... {)} ENDNATIVE !!/*STRPTR*/ ARRAY OF CHAR
...
->PROC IdHardwareNumTags(param1:ULONG, param2:ULONG,param22=0:ULONG, ...) IS NATIVE {IdHardwareNumTags(} param1 {,} param2 {,} param22 {,} ... {)} ENDNATIVE !!ULONG
