...
NATIVE {LocaleBase} OBJECT localebase
    {lb_LibNode}	lib	:lib
    {lb_SysPatches}	syspatches	:INT   /* TRUE if locale installed its patches */
ENDOBJECT
...
NATIVE {Locale} OBJECT locale
    ...
    {loc_CodeSet}	codeset	:ULONG	      /* always 0 for now	     */
    ...
    {loc_MonIntCS}	monintcs	:/*STRPTR*/ ARRAY OF CHAR	      /* internationl (ISO 4217) code */
...
NATIVE {Catalog} OBJECT catalog
    ...
    {cat_CodeSet}	codeset	:ULONG	/* currently always 0	   */
