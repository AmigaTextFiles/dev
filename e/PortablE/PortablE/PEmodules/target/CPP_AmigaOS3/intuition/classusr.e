...
//work-around so don't need to modify the include file
typedef struct _Msg {
    ULONG MethodID;
};
}
...
OBJECT opnew OF opset
ENDOBJECT
OBJECT opnotify OF opupdate
ENDOBJECT
OBJECT opaddmember OF opmember
ENDOBJECT
OBJECT opremmember OF opmember
ENDOBJECT
