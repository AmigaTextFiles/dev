...
NATIVE {NotifyRequest} OBJECT notifyrequest
	{nr_Name}	name	:ARRAY OF UBYTE
	{nr_FullName}	fullname	:ARRAY OF UBYTE		/* set by dos - don't touch */
	{nr_UserData}	userdata	:ULONG		/* for applications use */
	{nr_Flags}	flags	:ULONG
	...
	{nr_stuff.nr_Signal.nr_pad}			pad[3]	:ARRAY OF UBYTE

	{nr_Reserved}	reserved[4]	:ARRAY OF ULONG		/* leave 0 for now */

	/* internal use by handlers */
	{nr_MsgCount}	msgcount	:ULONG		/* # of outstanding msgs */
	{nr_Handler}	handler		:PTR TO mp	/* handler sent to (for EndNotify) */
ENDOBJECT
