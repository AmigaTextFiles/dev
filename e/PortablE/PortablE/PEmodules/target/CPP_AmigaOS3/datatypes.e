...
PROC DrawDTObject( rp:PTR TO rastport, o:PTR TO INTUIOBJECT, x:VALUE, y:VALUE, w:VALUE, h:VALUE, th:VALUE, tv:VALUE, tag1:TAG, tag12=0:ULONG, ... ) IS NATIVE {DrawDTObject(} rp {,} o {,} x {,} y {,} w {,} h {,} th {,} tv {,} tag1 {,} tag12 {,} ... {)} ENDNATIVE !!VALUE
