...
NATIVE {MUI_NListview_MCC_H} CONST
...
NATIVE {MUIM_NListview_QueryBeginning}       CONST MUIM_NListview_QueryBegining = MUIM_NList_QueryBeginning /* obsolete */
...
NATIVE {MUIV_NListview_VSB_Left}        CONST MUIV_NListview_VSB_Left        = 6
