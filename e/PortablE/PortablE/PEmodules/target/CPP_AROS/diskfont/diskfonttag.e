...
NATIVE {OT_DeviceDPI}	    	CONST OT_DEVICEDPI	    	= (OT_LEVEL0 OR $01)
...
NATIVE {OT_GlyphMap8Bits}   	CONST OT_GLYPHMAP8BITS   	= (OT_LEVEL0 OR OT_INDIRECT OR $50)
...
NATIVE {OTS_UltraThin}	    	CONST OTS_ULTRATHIN	    	= 8
NATIVE {OTS_ExtraThin}	    	CONST OTS_EXTRATHIN	    	= 24
NATIVE {OTS_Thin}	    	CONST OTS_THIN	    	= 40
NATIVE {OTS_ExtraLight}	    	CONST OTS_EXTRALIGHT	    	= 56
NATIVE {OTS_Light}	       	CONST OTS_LIGHT	       	= 72
NATIVE {OTS_DemiLight}	    	CONST OTS_DEMILIGHT	    	= 88
NATIVE {OTS_SemiLight}	    	CONST OTS_SEMILIGHT	    	= 104
NATIVE {OTS_Book}	    	CONST OTS_BOOK	    	= 120
NATIVE {OTS_Medium}	    	CONST OTS_MEDIUM	    	= 136
NATIVE {OTS_SemiBold}	    	CONST OTS_SEMIBOLD	    	= 152
NATIVE {OTS_DemiBold}	    	CONST OTS_DEMIBOLD	    	= 168
NATIVE {OTS_Bold}	    	CONST OTS_BOLD	    	= 184
NATIVE {OTS_ExtraBold}	    	CONST OTS_EXTRABOLD	    	= 200
NATIVE {OTS_Black}	    	CONST OTS_BLACK	    	= 216
NATIVE {OTS_ExtraBlack}	    	CONST OTS_EXTRABLACK	    	= 232
NATIVE {OTS_UltraBlack}	    	CONST OTS_ULTRABLACK	    	= 248

NATIVE {OTS_Upright}	    	CONST OTS_UPRIGHT	    	= 0
NATIVE {OTS_Italic}	    	CONST OTS_ITALIC	    	= 1
NATIVE {OTS_LeftItalic}	    	CONST OTS_LEFTITALIC	    	= 2

NATIVE {OTH_UltraCompressed}	CONST OTH_ULTRACOMPRESSED	= 16
NATIVE {OTH_ExtraCompressed}	CONST OTH_EXTRACOMPRESSED	= 48
NATIVE {OTH_Compressed}		CONST OTH_COMPRESSED		= 80
NATIVE {OTH_Condensed}		CONST OTH_CONDENSED		= 112
NATIVE {OTH_Normal}		CONST OTH_NORMAL		= 144
NATIVE {OTH_SemiExpanded}	CONST OTH_SEMIEXPANDED	= 176
NATIVE {OTH_Expanded}		CONST OTH_EXPANDED		= 208
NATIVE {OTH_ExtraExpanded}	CONST OTH_EXTRAEXPANDED	= 240

NATIVE {OT_MAXAVAILSIZES}	CONST OT_MAXAVAILSIZES	= 20
