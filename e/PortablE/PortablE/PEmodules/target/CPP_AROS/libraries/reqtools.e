/* $Filename: libraries/reqtools.h $Release: 2.5 $Revision$ */
OPT NATIVE, PREPROCESS
MODULE 'target/exec/types', 'target/exec/lists', 'target/exec/libraries', 'target/exec/semaphores', 'target/libraries/dos', 'target/libraries/dosextens', 'target/libraries/diskfont', 'target/graphics/text', 'target/utility/tagitem', 'target/utility/utility', 'target/intuition/intuition'
...
NATIVE {RTPREFS_SIZE}		CONST ->RTPREFS_SIZE		= (4 + (RTPREF_NR_OF_REQ * (4 + 4 + 2 + 2 + 2 + 2)))	->SIZEOF reqtoolsprefs - SIZEOF signalsemaphore - 4
#define RTPREFS_SIZE (SIZEOF reqtoolsprefs - SIZEOF signalsemaphore - 4)
...
NATIVE {ReqToolsBase} OBJECT reqtoolsbase
    ...
    {UtilityBase}	utilitybase	:PTR TO utilitybase
