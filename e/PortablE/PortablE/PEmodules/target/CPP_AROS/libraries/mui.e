...
NATIVE {MUIA_Dtpic_Name} CONST MUIA_Dtpic_Name = $80423d72 /* V18 isg STRPTR */
...
NATIVE {MUIA_Group_Forward}                  CONST MUIA_Group_Forward                  = $80421422 /* V11 .s. BOOL              */
...
NATIVE {__dummyAreaData__} OBJECT __dummyxfc2__
	{mnd}	mnd	:mui_notifydata
	{mad}	mad	:mui_areadata
ENDOBJECT

NATIVE {muiNotifyData} PROC	->muiNotifyData(obj) (&(((struct __dummyAreaData__ *)(obj))->mnd))
NATIVE {muiAreaData} PROC	->muiAreaData(obj)   (&(((struct __dummyAreaData__ *)(obj))->mad))

NATIVE {muiGlobalInfo} PROC	->muiGlobalInfo(obj) (((struct __dummyAreaData__ *)(obj))->mnd.mnd_GlobalInfo)
NATIVE {muiUserData} PROC	->muiUserData(obj)   (((struct __dummyAreaData__ *)(obj))->mnd.mnd_UserData)
NATIVE {muiRenderInfo} PROC	->muiRenderInfo(obj) (((struct __dummyAreaData__ *)(obj))->mad.mad_RenderInfo)
