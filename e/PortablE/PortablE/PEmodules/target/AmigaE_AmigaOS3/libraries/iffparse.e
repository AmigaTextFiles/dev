...
NATIVE {iffhandle} OBJECT iffhandle
    {stream}	stream	:ULONG
    {flags}	flags	:ULONG
    {depth}	depth	:VALUE	/*  Depth of context stack */
ENDOBJECT
...
NATIVE {iffstreamcmd} OBJECT iffstreamcmd
    {command}	command	:VALUE	/* Operation to be performed (IFFCMD_) */
    {buf}	buf	:APTR	/* Pointer to data buffer	       */
    {nbytes}	nbytes	:VALUE	/* Number of bytes to be affected      */
ENDOBJECT
...
NATIVE {contextnode} OBJECT contextnode
    ...
    {id}	id	:VALUE
    {type}	type	:VALUE
    {size}	size	:VALUE	/*  Size of this chunk		   */
    {scan}	scan	:VALUE	/*  # of bytes read/written so far */
ENDOBJECT
...
NATIVE {collectionitem} OBJECT collectionitem
    {next}	next	:PTR TO collectionitem
    {size}	size	:VALUE
    {data}	data	:APTR
ENDOBJECT
