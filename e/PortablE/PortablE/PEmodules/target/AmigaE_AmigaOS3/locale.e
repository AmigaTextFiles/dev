...
NATIVE {localebase} DEF localebase:NATIVE {LONG} PTR TO lib		->AmigaE does not automatically initialise this
...
->PROC OpenCatalog( locale:PTR TO locale, name:/*STRPTR*/ ARRAY OF CHAR, tag1:TAG, tag12=0:ULONG, tag13=0:ULONG, tag14=0:ULONG, tag15=0:ULONG, tag16=0:ULONG, tag17=0:ULONG, tag18=0:ULONG ) IS NATIVE {OpenCatalog(} locale {,} name {,} tag1 {,} tag12 {,} tag13 {,} tag14 {,} tag15 {,} tag16 {,} tag17 {,} tag18 {)} ENDNATIVE !!PTR TO catalog
