...
{MODULE 'devices/bootblock'}

NATIVE {bb} OBJECT bb
	{id}	id[4]	:ARRAY OF UBYTE		/* 4 character identifier */
	{chksum}	chksum	:VALUE		/* boot block checksum (balance) */
	{dosblock}	dosblock	:VALUE		/* reserved for DOS patch */
ENDOBJECT
