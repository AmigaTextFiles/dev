...
NATIVE {ndi} OBJECT ndi
	{iostd}	iostd	:iostd	/* Standard IORB		*/
	...
	{chmasks}	chmasks	:PTR TO UBYTE		/* Pointer to audio alloc maps	*/
	{nmmasks}	nummasks	:UINT		/* Number of audio alloc maps	*/
...
NATIVE {mrb} OBJECT mrb
	{ndi}	ndi	:ndi	/* Speech IORB			*/
