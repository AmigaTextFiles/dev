...
NATIVE {intuitionbase} DEF intuitionbase:NATIVE {LONG} PTR TO lib		->this declaration shouldn't be allowed, because it's name clashes with an object's.  Have to use OPT FORCENATIVE to allow it.
...
->PROC ReportMouse1( window:PTR TO window, flag:VALUE ) IS NATIVE {ReportMouse1(} window {,} flag {)} ENDNATIVE
NATIVE {Request} PROC
...
->PROC EasyRequest( window:PTR TO window, easyStruct:ARRAY OF easystruct, idcmpPtr:ARRAY OF ULONG, idcmpPtr2=0:ULONG, idcmpPtr3=0:ULONG, idcmpPtr4=0:ULONG, idcmpPtr5=0:ULONG, idcmpPtr6=0:ULONG, idcmpPtr7=0:ULONG, idcmpPtr8=0:ULONG ) IS NATIVE {EasyRequest(} window {,} easyStruct {,} idcmpPtr {,} idcmpPtr2 {,} idcmpPtr3 {,} idcmpPtr4 {,} idcmpPtr5 {,} idcmpPtr6 {,} idcmpPtr7 {,} idcmpPtr8 {)} ENDNATIVE !!VALUE
...
->PROC BuildEasyRequest( window:PTR TO window, easyStruct:ARRAY OF easystruct, idcmp:ULONG, idcmp2=0:ULONG, idcmp3=0:ULONG, idcmp4=0:ULONG, idcmp5=0:ULONG, idcmp6=0:ULONG, idcmp7=0:ULONG, idcmp8=0:ULONG ) IS NATIVE {BuildEasyRequest(} window {,} easyStruct {,} idcmp {,} idcmp2 {,} idcmp3 {,} idcmp4 {,} idcmp5 {,} idcmp6 {,} idcmp7 {,} idcmp8 {)} ENDNATIVE !!PTR TO window
...
->PROC OpenWindowTags( newWindow:PTR TO nw, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {OpenWindowTags(} newWindow {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!PTR TO window
...
->PROC OpenScreenTags( newScreen:PTR TO ns, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {OpenScreenTags(} newScreen {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!PTR TO screen
...
NATIVE {GetAttr} PROC
PROC GetAttr( attrID:ULONG, object:APTR, storagePtr:ARRAY) IS NATIVE {GetAttr(} attrID {,} object {,} storagePtr {)} ENDNATIVE !!ULONG
...
->PROC SetGadgetAttrs( gadget:PTR TO gadget, window:PTR TO window, requester:PTR TO requester, tag1:ULONG, tag12=0:ULONG, tag13=0:ULONG, tag14=0:ULONG, tag15=0:ULONG, tag16=0:ULONG, tag17=0:ULONG, tag18=0:ULONG ) IS NATIVE {SetGadgetAttrs(} gadget {,} window {,} requester {,} tag1 {,} tag12 {,} tag13 {,} tag14 {,} tag15 {,} tag16 {,} tag17 {,} tag18 {)} ENDNATIVE !!ULONG
...
PROC DoGadgetMethodA( gad:PTR TO gadget, win:PTR TO window, req:PTR TO requester, message:PTR TO msg ) IS NATIVE {DoGadgetMethodA(} gad {,} win {,} req {,} message {)} ENDNATIVE !!ULONG
->NATIVE {DoGadgetMethod} PROC
->PROC DoGadgetMethod( gad:PTR TO gadget, win:PTR TO window, req:PTR TO requester, methodID:ULONG, methodID2=0:ULONG, methodID3=0:ULONG, methodID4=0:ULONG, methodID5=0:ULONG, methodID6=0:ULONG, methodID7=0:ULONG, methodID8=0:ULONG ) IS NATIVE {DoGadgetMethod(} gad {,} win {,} req {,} methodID {,} methodID2 {,} methodID3 {,} methodID4 {,} methodID5 {,} methodID6 {,} methodID7 {,} methodID8 {)} ENDNATIVE !!ULONG
...
->PROC SetWindowPointer( win:PTR TO window, tag1:ULONG, tag12=0:ULONG, tag13=0:ULONG, tag14=0:ULONG, tag15=0:ULONG, tag16=0:ULONG, tag17=0:ULONG, tag18=0:ULONG ) IS NATIVE {SetWindowPointer(} win {,} tag1 {,} tag12 {,} tag13 {,} tag14 {,} tag15 {,} tag16 {,} tag17 {,} tag18 {)} ENDNATIVE
