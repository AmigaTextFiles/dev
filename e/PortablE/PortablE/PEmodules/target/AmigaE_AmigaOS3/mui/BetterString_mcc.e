...
CONST MUIA_BetterString_NoInput               = $ad001007
CONST MUIA_BetterString_KeyUpFocus            = $ad001008
CONST MUIA_BetterString_KeyDownFocus          = $ad001009
CONST MUIA_BetterString_InactiveContents      = $ad00100a
CONST MUIA_BetterString_NoShortcuts           = $ad00100c
...
CONST MUIM_BetterString_DoAction              = $ad00100b
...
TYPE MUIV_BetterString_DoActions IS VALUE
CONST MUIV_BetterString_DoAction_Cut            = 1
CONST MUIV_BetterString_DoAction_CopY           = 2
CONST MUIV_BetterString_DoAction_Paste          = 3
CONST MUIV_BetterString_DoAction_SelectAll      = 4
CONST MUIV_BetterString_DoAction_SelectNone     = 5
CONST MUIV_BetterString_DoAction_Undo           = 6
CONST MUIV_BetterString_DoAction_Redo           = 7
CONST MUIV_BetterString_DoAction_Revert         = 8
CONST MUIV_BetterString_DoAction_ToggleCase     = 9
CONST MUIV_BetterString_DoAction_ToggleCaseWord = 10
CONST MUIV_BetterString_DoAction_IncreaseNum    = 11
CONST MUIV_BetterString_DoAction_DecreaseNum    = 12
CONST MUIV_BetterString_DoAction_HexToDec       = 13
CONST MUIV_BetterString_DoAction_DecToHex       = 14
CONST MUIV_BetterString_DoAction_NextFileComp   = 15
CONST MUIV_BetterString_DoAction_PrevFileComp   = 16
CONST MUIV_BetterString_DoAction_Delete         = 17
...
OBJECT muip_betterstring_doaction
	methodid	:ULONG
	action	:MUIV_BetterString_DoActions
ENDOBJECT
