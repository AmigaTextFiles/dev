/* AmigaE module, for $VER: dos_protos.h 40.2 (6.6.1998) */
...
NATIVE {dosbase} DEF dosbase:NATIVE {LONG} PTR TO lib

NATIVE {Open} PROC
PROC Open( name:ARRAY OF CHAR, accessMode:VALUE ) IS NATIVE {Open(} name {,} accessMode {)} ENDNATIVE !!BPTR
NATIVE {Close} PROC
PROC Close( file:BPTR ) IS NATIVE {(0<>Close(} file {))} ENDNATIVE !!BOOL
NATIVE {Read} PROC
...
->NATIVE {Input} PROC	->clashes with object member name in 'devices/ahi'
PROC Input( ) IS NATIVE {Input()} ENDNATIVE !!BPTR
->NATIVE {Output} PROC	->ditto
...
PROC DeleteFile( name:ARRAY OF CHAR ) IS NATIVE {(0<>DeleteFile(} name {))} ENDNATIVE !!BOOL
NATIVE {Rename} PROC
PROC Rename( oldName:ARRAY OF CHAR, newName:ARRAY OF CHAR ) IS NATIVE {(0<>Rename(} oldName {,} newName {))} ENDNATIVE !!BOOL
->NATIVE {Lock} PROC
...
NATIVE {Examine} PROC
PROC Examine( lock:BPTR, fileInfoBlock:PTR TO fileinfoblock ) IS NATIVE {(0<>Examine(} lock {,} fileInfoBlock {))} ENDNATIVE !!BOOL
NATIVE {ExNext} PROC
PROC ExNext( lock:BPTR, fileInfoBlock:PTR TO fileinfoblock ) IS NATIVE {(0<>ExNext(} lock {,} fileInfoBlock {))} ENDNATIVE !!BOOL
->NATIVE {Info} PROC
PROC Info( lock:BPTR, parameterBlock:PTR TO infodata ) IS NATIVE {(0<>Info(} lock {,} parameterBlock {))} ENDNATIVE !!BOOL
...
PROC SetComment( name:ARRAY OF CHAR, comment:ARRAY OF CHAR ) IS NATIVE {(0<>SetComment(} name {,} comment {))} ENDNATIVE !!BOOL
NATIVE {SetProtection} PROC
PROC SetProtection( name:ARRAY OF CHAR, protect:VALUE ) IS NATIVE {(0<>SetProtection(} name {,} protect {))} ENDNATIVE !!BOOL
->NATIVE {DateStamp} PROC
PROC DateStamp( date:PTR TO datestamp ) IS NATIVE {DateStamp(} date {)} ENDNATIVE !!PTR TO datestamp
->NATIVE {Delay} PROC	->clashes with object member name in 'devices/ahi'
PROC Delay( timeout:VALUE ) IS NATIVE {Delay(} timeout {)} ENDNATIVE
NATIVE {WaitForChar} PROC
PROC WaitForChar( file:BPTR, timeout:VALUE ) IS NATIVE {(0<>WaitForChar(} file {,} timeout {))} ENDNATIVE !!BOOL
NATIVE {ParentDir} PROC
PROC ParentDir( lock:BPTR ) IS NATIVE {ParentDir(} lock {)} ENDNATIVE !!BPTR
NATIVE {IsInteractive} PROC
PROC IsInteractive( file:BPTR ) IS NATIVE {(0<>IsInteractive(} file {))} ENDNATIVE !!BOOL
NATIVE {Execute} PROC
PROC Execute( string:ARRAY OF CHAR, file:BPTR, file2:BPTR ) IS NATIVE {(0<>Execute(} string {,} file {,} file2 {))} ENDNATIVE !!BOOL
...
->PROC AllocDosObjectTags( type:ULONG, tag1type:ULONG, tag1type2=0:ULONG, tag1type3=0:ULONG, tag1type4=0:ULONG, tag1type5=0:ULONG, tag1type6=0:ULONG, tag1type7=0:ULONG, tag1type8=0:ULONG ) IS NATIVE {AllocDosObjectTags(} type {,} tag1type {,} tag1type2 {,} tag1type3 {,} tag1type4 {,} tag1type5 {,} tag1type6 {,} tag1type7 {,} tag1type8 {)} ENDNATIVE !!APTR2
...
PROC LockRecord( fh:BPTR, offset:ULONG, length:ULONG, mode:ULONG, timeout:ULONG ) IS NATIVE {(0<>LockRecord(} fh {,} offset {,} length {,} mode {,} timeout {))} ENDNATIVE !!BOOL
NATIVE {LockRecords} PROC
PROC LockRecords( recArray:ARRAY OF recordlock, timeout:ULONG ) IS NATIVE {(0<>LockRecords(} recArray {,} timeout {))} ENDNATIVE !!BOOL
NATIVE {UnLockRecord} PROC
PROC UnLockRecord( fh:BPTR, offset:ULONG, length:ULONG ) IS NATIVE {(0<>UnLockRecord(} fh {,} offset {,} length {))} ENDNATIVE !!BOOL
NATIVE {UnLockRecords} PROC
PROC UnLockRecords( recArray:ARRAY OF recordlock ) IS NATIVE {(0<>UnLockRecords(} recArray {))} ENDNATIVE !!BOOL
...
->NATIVE {Fwritef} PROC
->PROC Fwritef( fh:BPTR, format:ARRAY OF CHAR, format2=0:ULONG, format3=0:ULONG, format4=0:ULONG, format5=0:ULONG, format6=0:ULONG, format7=0:ULONG, format8=0:ULONG ) IS NATIVE {Fwritef(} fh {,} format {,} format2 {,} format3 {,} format4 {,} format5 {,} format6 {,} format7 {,} format8 {)} ENDNATIVE
...
->NATIVE {Fprintf} PROC
->PROC Fprintf( fh:BPTR, format:ARRAY OF CHAR, format2=0:ULONG, format3=0:ULONG, format4=0:ULONG, format5=0:ULONG, format6=0:ULONG, format7=0:ULONG, format8=0:ULONG ) IS NATIVE {Fprintf(} fh {,} format {,} format2 {,} format3 {,} format4 {,} format5 {,} format6 {,} format7 {,} format8 {)} ENDNATIVE !!VALUE
NATIVE {Flush} PROC
...
PROC ExamineFH( fh:BPTR, fib:PTR TO fileinfoblock ) IS NATIVE {(0<>ExamineFH(} fh {,} fib {))} ENDNATIVE !!BOOL
NATIVE {SetFileDate} PROC
PROC SetFileDate( name:ARRAY OF CHAR, date:PTR TO datestamp ) IS NATIVE {(0<>SetFileDate(} name {,} date {))} ENDNATIVE !!BOOL
NATIVE {NameFromLock} PROC
PROC NameFromLock( lock:BPTR, buffer:ARRAY OF CHAR, len:VALUE ) IS NATIVE {(0<>NameFromLock(} lock {,} buffer {,} len {))} ENDNATIVE !!BOOL
NATIVE {NameFromFH} PROC
PROC NameFromFH( fh:BPTR, buffer:ARRAY OF CHAR, len:VALUE ) IS NATIVE {(0<>NameFromFH(} fh {,} buffer {,} len {))} ENDNATIVE !!BOOL
...
NATIVE {SetMode} PROC
PROC SetMode( fh:BPTR, mode:VALUE ) IS NATIVE {(0<>SetMode(} fh {,} mode {))} ENDNATIVE !!BOOL
NATIVE {ExAll} PROC
PROC ExAll( lock:BPTR, buffer:ARRAY OF exalldata, size:VALUE, data:VALUE, control:PTR TO exallcontrol ) IS NATIVE {(0<>ExAll(} lock {,} buffer {,} size {,} data {,} control {))} ENDNATIVE !!BOOL
...
PROC MakeLink( name:ARRAY OF CHAR, dest:VALUE, soft:VALUE ) IS NATIVE {(0<>MakeLink(} name {,} dest {,} soft {))} ENDNATIVE !!BOOL
NATIVE {ChangeMode} PROC
PROC ChangeMode( type:VALUE, fh:BPTR, newmode:VALUE ) IS NATIVE {(0<>ChangeMode(} type {,} fh {,} newmode {))} ENDNATIVE !!BOOL
...
PROC ErrorReport( code:VALUE, type:VALUE, arg1:ULONG, device:PTR TO mp ) IS NATIVE {(0<>ErrorReport(} code {,} type {,} arg1 {,} device {))} ENDNATIVE !!BOOL
...
->PROC CreateNewProcTags( tag1type:ULONG, tag1type2=0:ULONG, tag1type3=0:ULONG, tag1type4=0:ULONG, tag1type5=0:ULONG, tag1type6=0:ULONG, tag1type7=0:ULONG, tag1type8=0:ULONG ) IS NATIVE {CreateNewProcTags(} tag1type {,} tag1type2 {,} tag1type3 {,} tag1type4 {,} tag1type5 {,} tag1type6 {,} tag1type7 {,} tag1type8 {)} ENDNATIVE !!PTR TO process
...
PROC SetArgStr( string:ARRAY OF CHAR ) IS NATIVE {(0<>SetArgStr(} string {))} ENDNATIVE !!BOOL
...
PROC SetCurrentDirName( name:ARRAY OF CHAR ) IS NATIVE {(0<>SetCurrentDirName(} name {))} ENDNATIVE !!BOOL
NATIVE {GetCurrentDirName} PROC
PROC GetCurrentDirName( buf:ARRAY OF CHAR, len:VALUE ) IS NATIVE {(0<>GetCurrentDirName(} buf {,} len {))} ENDNATIVE !!BOOL
NATIVE {SetProgramName} PROC
PROC SetProgramName( name:ARRAY OF CHAR ) IS NATIVE {(0<>SetProgramName(} name {))} ENDNATIVE !!BOOL
NATIVE {GetProgramName} PROC
PROC GetProgramName( buf:ARRAY OF CHAR, len:VALUE ) IS NATIVE {(0<>GetProgramName(} buf {,} len {))} ENDNATIVE !!BOOL
NATIVE {SetPrompt} PROC
PROC SetPrompt( name:ARRAY OF CHAR ) IS NATIVE {(0<>SetPrompt(} name {))} ENDNATIVE !!BOOL
NATIVE {GetPrompt} PROC
PROC GetPrompt( buf:ARRAY OF CHAR, len:VALUE ) IS NATIVE {(0<>GetPrompt(} buf {,} len {))} ENDNATIVE !!BOOL
...
->PROC SystemTags( command:ARRAY OF CHAR, tag1type:ULONG, tag1type2=0:ULONG, tag1type3=0:ULONG, tag1type4=0:ULONG, tag1type5=0:ULONG, tag1type6=0:ULONG, tag1type7=0:ULONG, tag1type8=0:ULONG ) IS NATIVE {SystemTags(} command {,} tag1type {,} tag1type2 {,} tag1type3 {,} tag1type4 {,} tag1type5 {,} tag1type6 {,} tag1type7 {,} tag1type8 {)} ENDNATIVE !!VALUE
NATIVE {AssignLock} PROC
PROC AssignLock( name:ARRAY OF CHAR, lock:BPTR ) IS NATIVE {(0<>AssignLock(} name {,} lock {))} ENDNATIVE !!BOOL
NATIVE {AssignLate} PROC
PROC AssignLate( name:ARRAY OF CHAR, path:ARRAY OF CHAR ) IS NATIVE {(0<>AssignLate(} name {,} path {))} ENDNATIVE !!BOOL
NATIVE {AssignPath} PROC
PROC AssignPath( name:ARRAY OF CHAR, path:ARRAY OF CHAR ) IS NATIVE {(0<>AssignPath(} name {,} path {))} ENDNATIVE !!BOOL
NATIVE {AssignAdd} PROC
PROC AssignAdd( name:ARRAY OF CHAR, lock:BPTR ) IS NATIVE {(0<>AssignAdd(} name {,} lock {))} ENDNATIVE !!BOOL
...
PROC RemDosEntry( dlist:PTR TO doslist ) IS NATIVE {(0<>RemDosEntry(} dlist {))} ENDNATIVE !!BOOL
...
PROC IsFileSystem( name:ARRAY OF CHAR ) IS NATIVE {(0<>IsFileSystem(} name {))} ENDNATIVE !!BOOL

/*	Handler Interface */
->NATIVE {Format} PROC
PROC Format( filesystem:ARRAY OF CHAR, volumename:ARRAY OF CHAR, dostype:ULONG ) IS NATIVE {(0<>Format(} filesystem {,} volumename {,} dostype {))} ENDNATIVE !!BOOL
NATIVE {Relabel} PROC
PROC Relabel( drive:ARRAY OF CHAR, newname:ARRAY OF CHAR ) IS NATIVE {(0<>Relabel(} drive {,} newname {))} ENDNATIVE !!BOOL
NATIVE {Inhibit} PROC
PROC Inhibit( name:ARRAY OF CHAR, onoff:VALUE ) IS NATIVE {(0<>Inhibit(} name {,} onoff {))} ENDNATIVE !!BOOL
...
PROC DateToStr( datetime:PTR TO datetime ) IS NATIVE {(0<>DateToStr(} datetime {))} ENDNATIVE !!BOOL
NATIVE {StrToDate} PROC
PROC StrToDate( datetime:PTR TO datetime ) IS NATIVE {(0<>StrToDate(} datetime {))} ENDNATIVE !!BOOL
...
PROC InternalUnLoadSeg( seglist:BPTR, freefunc:PTR /*VOID (*CONST freefunc)()*/ ) IS NATIVE {(0<>InternalUnLoadSeg(} seglist {,} freefunc {))} ENDNATIVE !!BOOL
...
->PROC NewLoadSegTags( file:ARRAY OF CHAR, tag1type:ULONG, tag1type2=0:ULONG, tag1type3=0:ULONG, tag1type4=0:ULONG, tag1type5=0:ULONG, tag1type6=0:ULONG, tag1type7=0:ULONG, tag1type8=0:ULONG ) IS NATIVE {NewLoadSegTags(} file {,} tag1type {,} tag1type2 {,} tag1type3 {,} tag1type4 {,} tag1type5 {,} tag1type6 {,} tag1type7 {,} tag1type8 {)} ENDNATIVE !!BPTR
...
PROC MatchPattern( pat:ARRAY OF CHAR, str:ARRAY OF CHAR ) IS NATIVE {(0<>MatchPattern(} pat {,} str {))} ENDNATIVE !!BOOL
...
NATIVE {AddPart} PROC
PROC AddPart( dirname:ARRAY OF CHAR, filename:ARRAY OF CHAR, size:ULONG ) IS NATIVE {(0<>AddPart(} dirname {,} filename {,} size {))} ENDNATIVE !!BOOL

/*	Notification */
NATIVE {StartNotify} PROC
PROC StartNotify( notify:PTR TO notifyrequest ) IS NATIVE {(0<>StartNotify(} notify {))} ENDNATIVE !!BOOL
NATIVE {EndNotify} PROC
PROC EndNotify( notify:PTR TO notifyrequest ) IS NATIVE {EndNotify(} notify {)} ENDNATIVE

/*	Environment Variable functions */
NATIVE {SetVar} PROC
PROC SetVar( name:ARRAY OF CHAR, buffer:ARRAY OF CHAR, size:VALUE, flags:VALUE ) IS NATIVE {(0<>SetVar(} name {,} buffer {,} size {,} flags {))} ENDNATIVE !!BOOL
NATIVE {GetVar} PROC
...
PROC DeleteVar( name:ARRAY OF CHAR, flags:ULONG ) IS NATIVE {(0<>DeleteVar(} name {,} flags {))} ENDNATIVE !!BOOL
NATIVE {FindVar} PROC
...
->NATIVE {Printf} PROC
->PROC Printf( format:ARRAY OF CHAR, format2=0:ULONG, format3=0:ULONG, format4=0:ULONG, format5=0:ULONG, format6=0:ULONG, format7=0:ULONG, format8=0:ULONG ) IS NATIVE {Printf(} format {,} format2 {,} format3 {,} format4 {,} format5 {,} format6 {,} format7 {,} format8 {)} ENDNATIVE !!VALUE
  PROC Printf( format:ARRAY OF CHAR, format2=0:ULONG, format3=0:ULONG, format4=0:ULONG, format5=0:ULONG, format6=0:ULONG, format7=0:ULONG, format8=0:ULONG ) IS NATIVE {PrintF(} format {,} format2 {,} format3 {,} format4 {,} format5 {,} format6 {,} format7 {,} format8 {)} ENDNATIVE !!VALUE
...
PROC MatchPatternNoCase( pat:ARRAY OF CHAR, str:ARRAY OF CHAR ) IS NATIVE {(0<>MatchPatternNoCase(} pat {,} str {))} ENDNATIVE !!BOOL
/* this was added for V37 dos, returned 0 before then. */
NATIVE {SameDevice} PROC
PROC SameDevice( lock1:BPTR, lock2:BPTR ) IS NATIVE {(0<>SameDevice(} lock1 {,} lock2 {))} ENDNATIVE !!BOOL
...
PROC SetOwner( name:ARRAY OF CHAR, owner_info:VALUE ) IS NATIVE {(0<>SetOwner(} name {,} owner_info {))} ENDNATIVE !!BOOL
