...
/* drawing modes */
NATIVE {RP_JAM1}	    CONST RP_JAM1	    = 0	      /* jam 1 color into raster */
NATIVE {RP_JAM2}	    CONST RP_JAM2	    = 1	      /* jam 2 colors into raster */
NATIVE {RP_COMPLEMENT}  CONST RP_COMPLEMENT  = 2	      /* XOR bits into raster */
NATIVE {RP_INVERSVID}   CONST RP_INVERSVID   = 4	      /* inverse video for drawing modes */
...
NATIVE {RPF_DBUFFER}     CONST RPF_DBUFFER     = $04      /* flag set when RastPorts
				 are double-buffered */

	     /* only used for bobs */

NATIVE {RPF_AREAOUTLINE} CONST RPF_AREAOUTLINE = $08      /* used by areafiller */
NATIVE {RPF_NOCROSSFILL} CONST RPF_NOCROSSFILL = $20      /* areafills have no crossovers */
