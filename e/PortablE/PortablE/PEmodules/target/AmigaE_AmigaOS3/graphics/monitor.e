...
NATIVE {monitorspec} OBJECT monitorspec
    ...
    {special}	special	:PTR TO specialmonitor
    {opencount}	opencount	:UINT
    {transform}	transform	:PTR /*LONG	(*ms_transform)()*/
    {translate}	translate	:PTR /*LONG	(*ms_translate)()*/
    {scale}	scale	:PTR /*LONG	(*ms_scale)()*/
    {xoffset}	xoffset	:UINT
    {yoffset}	yoffset	:UINT
    {legalview}	legalview	:rectangle
    {maxoscan}	maxoscan	:PTR /*LONG	(*ms_maxoscan)()*/	/* maximum legal overscan */
    {videoscan}	videoscan	:PTR /*LONG	(*ms_videoscan)()*/	/* video display overscan */
    ...
    {mrgcop}	mrgcop	:PTR /*LONG	(*ms_MrgCop)()*/
    {loadview}	loadview	:PTR /*LONG	(*ms_LoadView)()*/
    {killview}	killview	:PTR /*LONG	(*ms_KillView)()*/
ENDOBJECT
 ...
 * implemented.
 */
CONST VGA70_COLORCLOCKS = (STANDARD_COLORCLOCKS/2)
CONST VGA70_TOTAL_ROWS = 449
CONST VGA70_DENISE_MIN = 59
CONST MIN_VGA70_ROW	= 35
CONST VGA70_HBSTRT	= $08
CONST VGA70_HSSTRT	= $0E
CONST VGA70_HSSTOP	= $1C
CONST VGA70_HBSTOP	= $1E
CONST VGA70_VBSTRT	= $0000
CONST VGA70_VSSTRT	= $02A6
CONST VGA70_VSSTOP	= $0388
CONST VGA70_VBSTOP	= $0F73

->CONST ->#VGA70_BEAMCON	= (SPECIAL_BEAMCON XOR VSYNCTRUE)
...
NATIVE {specialmonitor} OBJECT specialmonitor
    {xln}	xln	:xln
    {flags}	flags	:UINT
    {do_monitor}	do_monitor	:PTR /*LONG	(*do_monitor)()*/
    {reserved1}	reserved1	:PTR /*LONG	(*reserved1)()*/
    {reserved2}	reserved2	:PTR /*LONG	(*reserved2)()*/
    {reserved3}	reserved3	:PTR /*LONG	(*reserved3)()*/
