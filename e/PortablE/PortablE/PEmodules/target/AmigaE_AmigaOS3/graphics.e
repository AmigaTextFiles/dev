...
NATIVE {gfxbase} DEF gfxbase:NATIVE {LONG} PTR TO lib		->this declaration shouldn't be allowed, because it's name clashes with an object's.  Have to use OPT FORCENATIVE to allow it.
...
PROC SetCollision( num:ULONG, routine:PTR /*VOID (*routine)(struct VSprite *gelA, struct VSprite *gelB)*/, gelsInfo:PTR TO gelsinfo ) IS NATIVE {SetCollision(} num {,} routine {,} gelsInfo {)} ENDNATIVE
...
->PROC VideoControlTags( colorMap:PTR TO colormap, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {VideoControlTags(} colorMap {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!INT
...
->PROC ExtendFontTags( font:PTR TO textfont, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {ExtendFontTags(} font {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!ULONG
...
->PROC ObtainBestPen( cm:PTR TO colormap, r:ULONG, g:ULONG, b:ULONG, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {ObtainBestPen(} cm {,} r {,} g {,} b {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!VALUE
...
->Not supported for some reason: PROC GetOutlinePen( rp:PTR TO rastport ) IS NATIVE {GetOutlinePen(} rp {)} ENDNATIVE !!ULONG
...
->PROC GetExtSprite( ss:PTR TO extsprite, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {GetExtSprite(} ss {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!VALUE
...
->PROC AllocSpriteData( bm:PTR TO bitmap, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {AllocSpriteData(} bm {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!PTR TO extsprite
...
->PROC ChangeExtSprite( vp:PTR TO viewport, oldsprite:PTR TO extsprite, newsprite:PTR TO extsprite, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {ChangeExtSprite(} vp {,} oldsprite {,} newsprite {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!VALUE
...
->PROC SetRPAttrs( rp:PTR TO rastport, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {SetRPAttrs(} rp {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE
...
->PROC GetRPAttrs( rp:PTR TO rastport, tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {GetRPAttrs(} rp {,} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE
...
->PROC BestModeID( tag1Type:ULONG, tag1Type2=0:ULONG, tag1Type3=0:ULONG, tag1Type4=0:ULONG, tag1Type5=0:ULONG, tag1Type6=0:ULONG, tag1Type7=0:ULONG, tag1Type8=0:ULONG ) IS NATIVE {BestModeID(} tag1Type {,} tag1Type2 {,} tag1Type3 {,} tag1Type4 {,} tag1Type5 {,} tag1Type6 {,} tag1Type7 {,} tag1Type8 {)} ENDNATIVE !!ULONG
