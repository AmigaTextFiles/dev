...
static ULONG dispentry_muicustomclass(void)  {
	struct IClass* iclass  = (struct IClass*) REG_A0;
	       Object* object2 =        (Object*) REG_A2;
	 struct _Msg_* message =  (struct _Msg_*) REG_A1;
	
	long methodid;
	data_muicustomclass* data2=NULL;
	
	data2 = (data_muicustomclass*) iclass->cl_UserData ;
	methodid = ((long (*)(struct IClass*,Object*,struct _Msg_*))data2->dispfunc )(iclass, object2, message );
	return methodid ;
} 

//static struct EmulLibEntry gate_muicustomclass = { //}
const struct {
	UWORD Trap;
	UWORD pad;
	APTR  Func;
...
try {
	...
	mcc = MUI_CreateCustomClass(base ,supername ,supermcc , (int) datasize ,(APTR) (long) (void*) &gate_muicustomclass);
...
NATIVE {gate_muicustomclass} DEF
