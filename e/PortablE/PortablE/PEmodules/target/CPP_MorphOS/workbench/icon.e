...
NATIVE {IconIdentifyMsg} OBJECT iconidentifymsg
	...
	{iim_FileHandle}	filehandle	:BPTR	/* If non-NULL, pointer to the file to examine,
						 * positioned right at the first byte, ready
						 * for you to use.
						 */
	{iim_Tags}	tags	:ARRAY OF tagitem	/* Tags passed to GetIconTagList(). */
ENDOBJECT
...
NATIVE {ICONA_LAST_TAG} CONST ICONA_LAST_TAG = (ICONA_DUMMY+89)
