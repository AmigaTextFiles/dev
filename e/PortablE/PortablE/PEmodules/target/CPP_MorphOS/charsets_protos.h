 ...
 *
 * Copyright © 2009-2011 The MorphOS Development Team, All Rights Reserved.
 */
...
LONG ConvertTags(APTR src, LONG srcbytes, APTR dst, LONG dstbytes, ULONG srcmib, ULONG dstmib, ULONG tag1, ...);
#endif
LONG ConvertTagList(APTR src, LONG srcbytes, APTR dst, LONG dstbytes, ULONG srcmib, ULONG dstmib, CONST struct TagItem *taglist);
