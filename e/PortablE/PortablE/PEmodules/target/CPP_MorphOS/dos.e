...
PROC InternalUnLoadSeg( seglist:BPTR, freefunc:PTR /*VOID (*CONST freefunc) __CLIB_PROTOTYPE((STRPTR,ULONG))*/ ) IS NATIVE {-(BOOLEAN)(0!=InternalUnLoadSeg(} seglist {, (VOID (*CONST) __CLIB_PROTOTYPE((STRPTR,ULONG))) } freefunc {))} ENDNATIVE !!BOOL
