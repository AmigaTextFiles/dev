...
NATIVE {SDTA_Mode}             CONST SDTA_MODE             = (SDTA_DUMMY + 33)
NATIVE {SDTA_PreciseVolume}    CONST SDTA_PRECISEVOLUME    = (SDTA_DUMMY + 34)
NATIVE {SDTA_Duration}         CONST SDTA_DURATION         = (SDTA_DUMMY + 35)
NATIVE {SDTA_SampleType}       CONST SDTA_SAMPLETYPE       = (SDTA_DUMMY + 36)
NATIVE {SDTA_Codec}            CONST SDTA_CODEC            = (SDTA_DUMMY + 37)

CONST SDTA_SAMPLESPERSEC = SDTA_FREQUENCY
