...
NATIVE {IECLASS_NEWMOUSE}		CONST IECLASS_NEWMOUSE		= $16

/* the last class */
NATIVE {IECLASS_MAX}			CONST IECLASS_MAX			= $16
 ...
 * NewMouse events.
 */
NATIVE {NM_WHEEL_UP}	CONST NM_WHEEL_UP      = $7a
NATIVE {NM_WHEEL_DOWN}	CONST NM_WHEEL_DOWN    = $7b
NATIVE {NM_WHEEL_LEFT}	CONST NM_WHEEL_LEFT    = $7c
NATIVE {NM_WHEEL_RIGHT}	CONST NM_WHEEL_RIGHT   = $7d
NATIVE {NM_WHEEL_FOURTH}	CONST NM_BUTTON_FOURTH = $7e
