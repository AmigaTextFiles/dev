...
-> Create the window object.
	...
	->work-around PortablE's unintuitive evaluation order
	but_object := ButtonObject,
...
-> Input Event Loop
            ...
            WHILE (done = FALSE)
               ...
               ELSE
                  ...
                  WHILE ((result := CA_HandleInput(win_object,ADDRESSOF code)) <> WMHI_LASTMSG)
