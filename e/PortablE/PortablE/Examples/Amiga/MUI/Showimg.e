...
PROC main()
  DEF signal, app:PTIO, wi_Master:PTIO
  DEF fixGroup:PTIO, freeGroup:PTIO, i
  ...
  */
  ...
  WHILE (doMethodA(app, [MUIM_Application_Input, ADDRESSOF signal]) <> MUIV_Application_ReturnID_Quit)
