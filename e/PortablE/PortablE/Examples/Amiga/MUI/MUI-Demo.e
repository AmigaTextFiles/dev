...
*/
DEF ap_Demo:PTIO
DEF wi_Master:PTIO, wi_Frames:PTIO, wi_Images:PTIO, wi_Notify:PTIO, wi_Listviews:PTIO, wi_Groups:PTIO, wi_Backfill:PTIO, wi_Cycle:PTIO, wi_String:PTIO
DEF bt_Notify:PTIO, bt_Frames:PTIO, bt_Images:PTIO, bt_Groups:PTIO, bt_Backfill:PTIO, bt_Listviews:PTIO, bt_Cycle:PTIO, bt_String:PTIO, bt_Quit:PTIO
DEF pr_PropA:PTIO, pr_PropH:PTIO, pr_PropV:PTIO, pr_PropL:PTIO, pr_PropR:PTIO, pr_PropT:PTIO, pr_PropB:PTIO
DEF lv_Volumes:PTIO, lv_Directory:PTIO, lv_Computer:PTIO, lv_Brian:PTIO
DEF cy_Computer:PTIO, cy_Printer:PTIO, cy_Display:PTIO
DEF mt_Computer:PTIO, mt_Printer:PTIO, mt_Display:PTIO
DEF st_Brian:PTIO
DEF ga_Gauge1:PTIO, ga_Gauge2:PTIO, ga_Gauge3:PTIO
...
menu := [ NM_TITLE,0, 'Project'  , NILA ,0,0,NILA,
	  NM_ITEM ,0, 'About...' ,'?',0,0,ID_ABOUT !!VALUE!!ARRAY,
	  NM_ITEM ,0, NM_BARLABEL, NILA ,0,0,NILA,
	  NM_ITEM ,0, 'Quit'	 ,'Q',0,0,MUIV_Application_ReturnID_Quit !!VALUE!!ARRAY,
	  NM_END  ,0, NILA	 , NILA ,0,0,NILA]:newmenu
...
*/
    ...
    ap_Demo := ApplicationObject,
	    ...
	    MUIA_Application_Menustrip,	  Mui_MakeObjectA(MUIO_MenustripNM,[menu,0,TAG_DONE]:tagitem),
...
*/
   ...
   WHILE running
      ...
      result := doMethod(ap_Demo, [MUIM_Application_Input, ADDRESSOF signal ])
	 ...
	 CASE ID_NEWVOL
	    doMethod(lv_Volumes, [MUIM_List_GetEntry, MUIV_List_GetEntry_Active, ADDRESSOF buf ])
	    set(lv_Directory, MUIA_Dirlist_Directory, buf)

	 CASE ID_NEWBRI
	    get(lv_Brian, MUIA_List_Active, ADDRESSOF buf )
	    set(st_Brian, MUIA_String_Contents, lvt_Brian[buf] )

	 CASE ID_ABOUT
	    Mui_RequestA(ap_Demo, wi_Master, 0, NILA, 'OK', 'MUI-Demo\n© 1992-94 by Stefan Stuntz',NIL)
...
PROC list(ftxt) RETURNS obj:ILIST
    obj :=  ListviewObject,
		MUIA_Weight, 50,
...
PROC image(nr) RETURNS obj:ILIST
    obj := ImageObject,
		MUIA_Image_Spec, nr,
    End
ENDPROC

PROC scaledImage(nr,s,x,y) RETURNS obj:ILIST
    obj := ImageObject,
		MUIA_Image_Spec, nr,
		MUIA_FixWidth, x,
		MUIA_FixHeight,y,
