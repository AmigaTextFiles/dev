...
**    Miscellaneous
*/
#define PALMLINK_NAME  'palmlink.library'
...
OBJECT pl_SLP_Header
    signature[3]:ARRAY OF CHAR         /* = will be set by palmlink.library */
    destSocket:CHAR                    /* Destination Socket ID */
    srcSocket:CHAR                     /* Source Socket ID */
    pckType:CHAR                       /* Packet Type */
    dataSize:INT                       /* = will be set by palmlink.library */
    transID:CHAR                       /* Current transaction ID */
    checksum:CHAR                      /* = calculated by palmlink.library */
ENDOBJECT
