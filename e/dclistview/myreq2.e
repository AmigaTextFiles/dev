...
MODULE 'tools/EasyGUI', 'tools/exceptions', 'amigalib/lists', 'utility',
       ...
       'dos/dos', 'dos/exall', 'dos/dosextens', 'plugins/dclistview', 'utility/tagitem'
...
EXCEPT DO
  ...
  -> Reattach list
  dclist.setA([DCLV_LIST,nameList,
               DCLV_TOP,0,
               TAG_DONE])
  ReThrow()
ENDPROC
...
vers: CHAR 0, '$VER: myreq2 1.5 (8.1.99)', 0
