...
CONST MAXPTS=12                    /* default maximum number of points allowed */

EXPORT PROC net3d(pts:PTR TO LONG,faces:PTR TO LONG,rast,colour=1)
  DEF i,j,k,npts,mfaces,nfaces,x,xpt[MAXPTS]:ARRAY,y,ypt[MAXPTS]:ARRAY,z,zpt[MAXPTS]:ARRAY
  DEF index:PTR TO LONG,coord:PTR TO point

  SetAPen(rast,colour)

  npts:=ListLen(pts)
  mfaces:=ListLen(faces)
