...
PROC screenmode(x)
  easygui_fallbackA('ScreenMode Preferences',
    [EQROWS,
      [COLS,
        [EQROWS,
...
PROC search(x)
  WriteF('result=\d\n',easyguiA('Enter Search/Replace text:',
    [ROWS,
      [ROWS,						-> ROWS
        [EQROWS,
