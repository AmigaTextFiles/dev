  ...
  img2:=[0,0,22,22,3,mem2,$0007,0,NIL]:image
   newguiA([
        ...
        NG_GUI,
                ...
                [BEVELR,
                [ROWS,
                        plugin1:=[PLUGIN,{dummy},NEW dnd1.dnd(DND_DROPBOX,img1,NIL,22,22,NIL,DND_ACT_XCHANGE,NIL)]]],
                [SPACEH],
                [BEVEL,
                [ROWS,
                        plugin2:=[PLUGIN,{dropped},NEW dnd2.dnd(DND_DRAGBOX,img2,NIL,22,22,NIL,DND_ACT_XCHANGE,NIL),'','',FALSE]]]
                ]
                ],
                [EQCOLS,
