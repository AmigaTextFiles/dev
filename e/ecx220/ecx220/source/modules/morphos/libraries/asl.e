...
CONST ASLFR_SetSortBy           = (ASL_TB + 124)
CONST ASLFR_GetSortBy           = (ASL_TB + 125)
CONST ASLFR_SetSortDrawers      = (ASL_TB + 126)
CONST ASLFR_GetSortDrawers      = (ASL_TB + 127)
CONST ASLFR_SetSortOrder        = (ASL_TB + 128)
CONST ASLFR_GetSortOrder        = (ASL_TB + 129)

/*** V44 ***/

CONST ASLFR_InitialShowVolumes  = (ASL_TB + 130)
CONST ASLFR_PopToFront          = (ASL_TB + 131)

/*** V45 ***/

CONST ASLFR_Activate            = (ASL_TB + 132)
...
CONST ASLFO_DoFrontPen       = (ASL_TB + 44)
CONST ASLFO_DoBackPen        = (ASL_TB + 45)
CONST ASLFO_DoStyle          = (ASL_TB + 46)
CONST ASLFO_DoDrawMode       = (ASL_TB + 47)

CONST ASLFO_FixedWidthOnly   = (ASL_TB + 48)

CONST ASLFO_FilterFunc       = (ASL_TB + 49)

CONST ASLFO_Locale           = (ASL_TB + 50)
CONST ASLFO_TextAttr         = (ASL_TB + 51)
CONST ASLFO_UserData         = (ASL_TB + 52)

CONST ASLFO_InitialDrawMode  = (ASL_TB + 59)

CONST ASLFO_FrontPens        = (ASL_TB + 64)
CONST ASLFO_BackPens         = (ASL_TB + 65)

CONST ASLFO_MaxFrontPen      = (ASL_TB + 66)
CONST ASLFO_MaxBackPen       = (ASL_TB + 67)

CONST ASLFO_IntuiMsgFunc     = (ASL_TB + 70)

/*** V44 ***/

CONST ASLFO_PopToFront       = (ASL_TB + 131)

/*** V45 ***/

CONST ASLFO_Activate         = (ASL_TB + 132)
CONST ASLFO_SampleText       = (ASL_TB + 133)

CONST FOB_DOFRONTPEN=0,
      FOB_DOBACKPEN=1,
      FOB_DOFONTSTYLE=2,
      FOB_DODRAWMODE=3,
...
CONST ASLSM_PopToFront        =    (ASL_TB + 131)

/*** V45 ***/

CONST ASLSM_Activate          =    (ASL_TB + 132)
...
CONST ASLPOS_CenterWindow     = 1
CONST ASLPOS_CenterScreen     = 2
CONST ASLPOS_WindowPosition   = 3
CONST ASLPOS_ScreenPosition   = 4
CONST ASLPOS_CenterMouse      = 5

CONST ASLPOS_MASK        =     $0F


CONST ASLSIZE_DefaultSize   = (0<<4)
CONST ASLSIZE_RelativeSize  = (1<<4)

CONST ASLSIZE_MASK          = $30


CONST ASLOPTION_ASLOverrides  = (1<<6)
