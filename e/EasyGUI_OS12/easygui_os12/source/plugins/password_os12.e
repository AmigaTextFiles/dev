...
#ifdef EASY_OS12
  MODULE 'tools/easygui_os12', 'hybrid/version'
#endif
#ifndef EASY_OS12
  OPT OSVERSION=37
...
#ifdef EASY_OS12
  IF libVersion(gadtoolsbase,37)=FALSE -> hook came with V37
    StrCopy(self.estr,self.password.specialinfo::stringinfo.buffer)
  ENDIF
#endif
ENDPROC TRUE
...
#ifdef EASY_OS12
      IF libVersion(gadtoolsbase,37) -> hook came with V37
#endif
        WHILE len DO p[len--]:="*"
#ifdef EASY_OS12
      ELSE
