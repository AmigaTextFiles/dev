/*   compleximage.e  translated from the RKRM libraries examples
     Translated by Eric Stringer    INTERNET #"NES@delphi.com"
     This program puts a two bitplane image of a box in a window.
*/
...
myimagedata:= [$FFFF,$FF00,    /* Image data plane 1 */
               $C000,$0300,
               $C000,$0300,
               $C000,$0300,
               $C000,$0300,
...
myimage := [ MYIMAGE_LEFT,   /* leftedge offset */
             ...
             $3,             /* plane on which data is to be put */
