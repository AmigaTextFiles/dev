...
RPROC OStrCmpNC(a0:PTR TO CHAR,a1:PTR TO CHAR,d0=-1)(LONG)
...
RPROC StrCmpNC(a0:PTR TO CHAR,a1:PTR TO CHAR,d0=-1)(BOOL)
RPROC StrCopy(a0:PTR TO CHAR,a1:PTR TO CHAR,d0=-1)(PTR TO CHAR)
RPROC StringF(a0:PTR TO CHAR,a1:PTR TO CHAR,a2=NIL:LIST OF LONG)(PTR TO CHAR)
RPROC VStringF(a0:PTR TO CHAR,a1:PTR TO CHAR,a2=NIL:PTR TO LONG)(PTR TO CHAR)
...
LPROC CStrCmp(stra:PTR TO CHAR,strb:PTR TO CHAR)(L)
...
RPROC Mod(d0:LONG,d1:LONG)(LONG)='divsl.l\td1,d1:d0\n\texg\td0,d1'
RPROC Div(d0:LONG,d1:LONG)(LONG)='divs.l\td1,d0'
RPROC Mul(d0:LONG,d1:LONG)(LONG)='muls.l\td1,d0'
RPROC Add(d0:LONG,d1:LONG)(LONG)='add.l\td1,d0'
RPROC Sub(d0:LONG,d1:LONG)(LONG)='sub.l\td1,d0'
...
//RPROC Rem(fp0:DOUBLE)(DOUBLE)='frem.x\tfp0,fp0'
RPROC Exp(fp0:DOUBLE)(DOUBLE)='fetox.x\tfp0'
...
RPROC UWord(a0:PTR TO WORD)(LONG)='move.w\t(a0),d0\n\tandi.l\t#$ffff,d0'
...
RPROC SizePooled(a0:PTR)(LONG)='move.l\t(-4,a0),d0'
...
RPROC SetColour(a0:PTR TO Screen,d0,d1,d2,d3)
...
RPROC Eval(a0:PTR)(L)
RPROC MapList(a0:PTR TO LONG,a1:PTR TO LONG,a2:PTR TO LONG,d0:LONG,a3:PTR TO LONG)
RPROC ForAll(a0:PTR TO LONG,a1:PTR TO LONG,d0:LONG,a2:PTR TO LONG)(L)
RPROC Exists(a0:PTR TO LONG,a1:PTR TO LONG,d0:LONG,a2:PTR TO LONG)(L)
RPROC SelectList(a0:PTR TO LONG,a1:PTR TO LONG,a2:PTR TO LONG,d0:LONG,a3:PTR TO LONG)(L)
