  ...
  (let ((symbolform
    ...
    `(block nil
       (unless (fboundp ,symbolform) ; Funktion überhaupt definiert?
         (warn 
          #L{
          DEUTSCH "~S: Funktion ~S ist nicht definiert."
       ...
       (when (special-form-p ,symbolform) ; Special-Form: nicht tracebar
         (warn 
          #L{
          DEUTSCH "~S: Special-Form ~S kann nicht getraced werden."
       ...
       (let* ((,old-function (symbol-function ,symbolform))
         ...
         (format t 
                 #L{
                 DEUTSCH "~&;; ~:[Funktion~;Macro~] ~S wird getraced."
      ...
      (if old-definition
        ...
        (progn
          (if (and (fboundp symbol)
            ...
            (warn 
             #L{
             DEUTSCH "~S: ~S war getraced und wurde umdefiniert!"
