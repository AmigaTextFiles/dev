...
# Zur Konstruktion konstanter DS: D(byte0,byte1,byte2,byte3,dummy) liefert
...
#if (defined(MC680X0) || defined(SPARC) || (defined(I80Z86) && !defined(WATCOM)) || defined(MIPS) || defined(VAX) || defined(ARM)) && (SAFETY < 3)
