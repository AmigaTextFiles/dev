...
#   MULU D1,D0
    ...
    #elif defined(I80Z86) && !defined(NO_ASM)
      #define mulu16(arg1,arg2)  \
...
#   MULU.L D1,D1:D0
    ...
    #endif
  #endif
  #if defined(WATCOM) && defined(I80Z86) && !defined(NO_ASM)
    #define mulu32(x,y,hi_zuweisung,lo_zuweisung)  \
      { var register uint32 _hi;                  \
        var register uint32 _lo;                  \
    ...
    extern uint32 mulu32_high_ (void);
    ...
    #if defined(MC680X0) || defined(SPARC) || defined(ARM) || (defined(I80Z86) && !defined(WATCOM) && !defined(MICROSOFT)) || defined(MIPS) || defined(HPPA) || defined(VAX)
          ...
          { var uint32 _x1 = _x; # x1 := x                                      \
            ...
            { var uint16 _y2 = low16(_y1)+1; # y1+1 bilden                      \
              if (_y2==0)                                                       \
                ...
                { divu_3216_1616(_x1,_y2,_q=,_EMA_); } # Division von x1 durch y1+1  \
            }                                                                   \
            # _q = q = floor(x1/(y1+1))                                         \
...
# < x = q*y+r
  ...
  extern uint32 divu_32_rest;                                       # -> Rest r
      ...
      #define divu_6432_3232_(xhi,xlo,y) \
        ({var reg1 uint32 ___q; divu_6432_3232(xhi,xlo,y,___q=,_EMA_); ___q; })
    #elif defined(SPARC)
      #define divu_6432_3232(xhi,xlo,y,q_zuweisung,r_zuweisung)  \
    ...
    extern uint32 divu_6432_3232_rest (void);
    ...
    #if defined(MC680Y0) || defined(SPARC) || defined(ARM) || (defined(I80Z86) && !defined(WATCOM) && !defined(MICROSOFT)) || defined(HPPA)
...
# < boolean sqrtp: /=0, falls x=y^2
    ...
    #define isqrt_64_32(xhi,xlo,y_zuweisung,sqrtp_zuweisung)  \
      { var reg4 uint32 _xhi = (xhi);                                        \
        ...
        isqrt_32_16(_xhi,_yhi=,_EMA_); # yhi := isqrt(xhi)                        \
