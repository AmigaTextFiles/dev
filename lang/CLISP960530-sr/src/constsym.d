...
# Expander für die Initialisierung der Symbol-Tabelle:
  ...
  #define LISPSYM_E(name,printname,package)  (uintB)enum_##package##_index,
...
#ifdef VCODE
# ---------- VCODE ---------
LISPSYM(vcode_compile,"VCODE-COMPILE",system)
#endif
# ---------- ARRAY ----------
...
LISPSYM(lisp_implementation_version_string,"LISP-IMPLEMENTATION-VERSION-STRING",system)
LISPSYM(software_version_string,"SOFTWARE-VERSION-STRING",system)
...
#ifdef ENABLE_NLS
LISPSYM(gettext,"GETTEXT",system)
#endif
...
LISPSYM(delete_package_aux,"DELETE-PACKAGE-AUX",system)
LISPSYM(find_all_symbols,"FIND-ALL-SYMBOLS",lisp)
LISPSYM(map_symbols,"MAP-SYMBOLS",system)
LISPSYM(map_symbols_aux,"MAP-SYMBOLS-AUX",system)
...
#endif
#ifdef XSOCKETS
LISPSYM(make_xsocket_stream,"MAKE-SOCKET-STREAM",system)
...
#ifdef DYNBIND_LIST
LISPSYM(dynamic_bindings,"*DYNAMIC-BINDINGS*",system)
LISPSYM(special_bindings,"*SPECIAL-BINDINGS*",system)
LISPSYM(dynamic_and_special_frames,"*DYNAMIC-AND-SPECIAL-FRAMES*",system)
LISPSYM(last_binding_type,"*LAST-BINDING-TYPE*",system)
LISPSYM(transitions_to_dynamic_bindings,"*TRANSITIONS-TO-DYNAMIC-BINDINGS*",system)
LISPSYM(transitions_to_special_bindings,"*TRANSITIONS-TO-SPECIAL-BINDINGS*",system)
LISPSYM(Kdynamic,"DYNAMIC",keyword)
LISPSYM(Kspecial,"SPECIAL",keyword)
#endif
# ---------- LISPARIT ----------
...
LISPSYM(stdwin_window_set_caret,"WINDOW-SET-CARET",stdwin)
...
LISPSYM(structure,"STRUCTURE",lisp) # als Typ für RECORD
...
LISPSYM(read_pathname_p,"*READ-PATHNAME-P*",lisp)
#ifdef LOGICAL_PATHNAMES
...
LISPSYM(load_input_stream,"*LOAD-INPUT-STREAM*",system) # in DEBUG
...
LISPSYM(closclass,"CLASS",clos) # als Marker in PREDTYPE
...
LISPSYM(image_pathname,"*IMAGE-PATHNAME*",lisp)
# ---------- FFI ----------
#ifdef DYNAMIC_FFI
