...
#endif
#if defined(WINDOWS) || defined(WIN32_WINDOWS) || defined(MAYBE_NEXTAPP)
PSEUDOFUN(wr_ch_terminal) PSEUDOFUN(rd_ch_terminal)
#endif
#if (defined(UNIX) || (defined(MSDOS) && !defined(WINDOWS) && !defined(WIN32_WINDOWS)) || defined(AMIGAOS) || defined(RISCOS))
...
#endif
#ifdef XSOCKETS
PSEUDOFUN(rd_ch_xsocket) PSEUDOFUN(wr_ch_xsocket) PSEUDOFUNSS(wr_ss_xsocket) PSEUDOFUN(rd_by_xsocket) PSEUDOFUN(wr_by_xsocket)
#endif
