       ...
       (LET ((,g (MULTIPLE-VALUE-LIST ,form)))
         (IF (SYS::%THE ,g ',typespec)
           ...
           (ERROR-OF-TYPE 'ERROR ; 'TYPE-ERROR ??
             #L{
             DEUTSCH "Die Form ~S lieferte ~:[keine Werte~;~:*~{~S~^ ; ~}~] , das ist nicht vom Typ ~S."
             ENGLISH "The form ~S yielded ~:[no values~;~:*~{~S~^ ; ~}~] , that's not of type ~S."
             FRANCAIS "La forme ~S a rendu ~:[aucune valeur~;~:*~{~S~^ ; ~}~] , ceci n'est pas de type ~S."
             }
             ',form ,g ',typespec
) )  ) ) ) )
;-------------------------------------------------------------------------------
