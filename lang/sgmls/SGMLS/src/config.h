/* amiga.cfg: Configuration file for sgmls on Amiga. */
/* Contributed by Kai Hofmann <i07m@zfn.uni-bremen.de>. */
...
#define DEFAULT_PATH "sgml:;%N.%D;%N.%X"
...
/* A macro that returns non-zero if the filename is relative to the
   current directory. */
#define FILE_IS_RELATIVE(p) (strchr(p,':') == NULL)
...
#define DEFAULT_CATALOG_FILES "CATALOG;sgml:CATALOG"
...
/* This says that slashes, brackets and : will be removed from filenames */
