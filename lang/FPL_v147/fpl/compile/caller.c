...
static struct CommandLine debug_flags[]={
  {"LINE",        DEBUG_LINE,  NULL, NULL, "Include line numbers in compilation result"},
  {NULL,          NULL,          NULL, NULL, NULL}
};

static struct CommandLine verbose_flags[]={
  {"PASS1",       VERBOSE_PASS1,  NULL, NULL, "Output from Pass1"},
  {"PASS2",       VERBOSE_PASS2,  NULL, NULL, "Output from Pass2"},
  {"PASS3",       VERBOSE_PASS3,  NULL, NULL, "Output from Pass3"},
  {"FINAL",       VERBOSE_FINAL,  NULL, NULL, "Output of final"},
  {"SYMBOL",      VERBOSE_SYMBOL, NULL, NULL, "Output use of external symbols"},
  {"FULL",        -1,  NULL, NULL,            "Full output"},
  {NULL,          NULL,           NULL, NULL, NULL}
};
...
long main(long argc, char **argv)
{
  ...
  if(!results[LINE_NOVERSION]) {
    fprintf(stderr,
           "FPLc and FPL library are (C) 1992-1996 by FrexxWare. "
           "All rights reserved.\n"
