 ...
 */
#define ARCHLIB_EXP "/gnu/lib/perl5/Amiga/5.002"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB_EXP "/gnu/lib/perl5"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH_EXP "/gnu/lib/perl5/site_perl/Amiga"		/**/

/* SITELIB_EXP:
 *	This symbol contains the ~name expanded version of SITELIB, to be used
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITELIB_EXP "/gnu/lib/perl5/site_perl"		/**/
