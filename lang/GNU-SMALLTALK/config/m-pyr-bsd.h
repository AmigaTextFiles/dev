...
/* Make sure to compile in the BSD environment */
#define EXTRA_CC_FLAGS -DBSD

/* use the assembler version of alloca from GNU Emacs */
#define NEED_ALLOCA 1
...
#define MACHINE_DEFINES "pyr", "unix"
