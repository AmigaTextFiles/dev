 ...
 */
Boolean			smalltalkInitialized = false;
...
static Boolean 		processFile(), okToLoadBinary(), findKernelFile();
...
static char	*smalltalkArgVec[] = { "mst", nil };
...
NULL
  ...
  for ( ; *++argv; ) {
	...
	case 'v':
	  ...
	  printf("Copyright (C) 1990, 1991, 1992 Free Software Foundation, Inc.\n");
