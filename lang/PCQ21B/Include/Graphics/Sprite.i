...
{$C+}
FUNCTION ChangeExtSprite(vp : ViewPortPtr; oldsprite, newsprite : ExtSpritePtr;...): Integer;
EXTERNAL;

FUNCTION GetExtSprite(ss : ExtSpritePtr; ...): Integer;
EXTERNAL;

FUNCTION AllocSpriteData(bm : BitMapPtr; ...): ExtSpritePtr;
EXTERNAL;
{$C-}
