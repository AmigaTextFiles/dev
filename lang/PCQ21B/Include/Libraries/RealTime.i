...
function LockRealTime( lockType: Integer ): ADDRESS;
EXTERNAL;
...
FUNCTION CreatePlayerA( tagList: ADDRESS ): PlayerPtr;
EXTERNAL;

PROCEDURE DeletePlayer( play : PlayerPtr );
EXTERNAL;

FUNCTION SetPlayerAttrsA( play : PlayerPtr; taglist : ADDRESS ): Boolean;
EXTERNAL;

FUNCTION SetConductorState( Play : PlayerPtr; state, time : Integer): Integer;
EXTERNAL;

FUNCTION ExternalSync( Play : PlayerPtr; minTime, maxTime: Integer ): Boolean;
EXTERNAL;

FUNCTION NextConductor( previousConductor : ConductorPtr ): ConductorPtr;
EXTERNAL;

FUNCTION FindConductor( name : String ): ConductorPtr;
EXTERNAL;

FUNCTION GetPlayerAttrsA( Play : PlayerPtr; tagList: ADDRESS ): Integer;
EXTERNAL;
...
{$C+}
FUNCTION GetPlayerAttrs(play : PlayerPtr; ...): INTEGER;
EXTERNAL;

FUNCTION SetPlayerAttrs(play : PlayerPtr; ...): BOOLEAN;
EXTERNAL;

FUNCTION CreatePlayer(...): PlayerPtr;
EXTERNAL;
{$C-}
