...
**  Current version :   $VER: triton.i 2.0 (14 May 1996)
**
...
{* ------------------------------------------------------------------------------ *}
     ...
     TR_Project = RECORD
         ...
         trp_Window                   : WindowPtr;            {* The default window *}
...
procedure TR_DrawFrame(project : TR_ProjectPtr; rp : RastPortPtr; left,top,width,height,thetype : word;inverted : BOOL);
external;
...
procedure TR_PrintText(project : TR_ProjectPtr; rp : RastPortPtr;
...
procedure TR_AreaFill(project : TR_Project; rp : RastPortPtr;
