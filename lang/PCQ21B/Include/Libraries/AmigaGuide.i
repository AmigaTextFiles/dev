...
{$I "Include:Libraries/AmigaGuideBaseVar.i"}
...
FUNCTION OpenAmigaGuideLib(vers : Integer): BOOLEAN;
external;

PROCEDURE CloseAmigaGuideLib;
external;

{ This are varargs functions, for use with PCQ Pascal vers. 2.0 and above }

{$C+}
FUNCTION AddAmigaGuideHost(h : HookPtr; name : STRING; ...) : address;
EXTERNAL;

FUNCTION OpenAmigaGuide(nag : NewAmigaGuidePtr; ...): AmigaGuideContext;
EXTERNAL;

FUNCTION OpenAmigaGuideAsync(nag : NewAmigaGuidePtr; ...): AmigaGuideContext;
EXTERNAL;

FUNCTION RemoveAmigaGuideHost(hh : Address; ...) : INTEGER;
EXTERNAL;

FUNCTION SendAmigaGuideCmd(cl : AmigaGuideContext; cmd : STRING; ...) : INTEGER;
EXTERNAL;

FUNCTION SendAmigaGuideContext(cl : Address; ...) : INTEGER;
EXTERNAL;

FUNCTION SetAmigaGuideAttrs(cl : AmigaGuideContext; ...) : INTEGER;
EXTERNAL;

FUNCTION SetAmigaGuideContext(cl : AmigaGuideContext; ID : INTEGER; ...): INTEGER;
EXTERNAL;
{$C-}
