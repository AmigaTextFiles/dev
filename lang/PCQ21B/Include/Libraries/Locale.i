...
{$I "Include:Libraries/LocaleBaseVar.i"}
...
FUNCTION GetLocaleStr(Loc : LocalePtr; StrNum : Integer) : String;
    External;
...
FUNCTION OpenLocaleLib(vers : Integer): BOOLEAN;
external;

PROCEDURE CloseLocaleLib;
external;
...
{$C+}
FUNCTION OpenCatalog(loc : LocalePtr; name : STRING; ...): CatalogPtr;
EXTERNAL;
{$C-}
