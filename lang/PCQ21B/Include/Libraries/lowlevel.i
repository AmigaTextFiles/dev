...
{ CONTROLLER HANDLING }
FUNCTION ReadJoyPort(Port : Integer) : Integer;
    External;
...
PROCEDURE QueryKeys(QueryArray : KeyQueryPtr; arraysize : Integer);
    External;

FUNCTION AddKBInt(intRoutine, intData : Address) : Address;
    External;
...
{ SYSTEM HANDLING }
FUNCTION SystemControlA(TagList : Address) : Integer;
    External;

{ TIMER HANDLING }
FUNCTION AddTimerInt(intRoutine, intData : Address) : Address;
    External;
...
PROCEDURE StartTimerInt(intHandle : Address; timeInterval, continuous : Integer);
    External;

FUNCTION ElapsedTime(context : Address) : Integer;
    External;

{ VBLANK HANDLING }
FUNCTION AddVBlankInt(intRoutine, intData : Address) : Address;
    External;

PROCEDURE RemVBlankInt(intHandle : Address);
    External;

{ MORE CONROLLER HANDLING }
FUNCTION SetJoyPortAttrsA(PortNumber : Integer; TagList : Address) : Boolean;
    External;
...
{$C+}
function SystemControl(...): Integer;
external;

function SetJoyPortAttrs(portnumber : Integer; ...): Boolean;
external;
{$C-}
