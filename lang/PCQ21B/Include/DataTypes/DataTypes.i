...
FUNCTION DoDTMethodA(o : ObjectPtr; Win : WindowPtr; Req : RequesterPtr; Data : Msg) : Integer;
    External;
...
FUNCTION PrintDTObjectA(o : ObjectPtr; Win : WindowPtr; Req : RequesterPtr; Msg : address) : Integer;
    External;
...
{$C+}
FUNCTION DoDTMethod(o : ObjectPtr; win : WindowPtr; req : RequesterPtr; ...): INTEGER;
EXTERNAL;

FUNCTION GetDTAttrs(o : ObjectPtr; ...): INTEGER;
EXTERNAL;

FUNCTION NewDTObject(name : ADDRESS; ...): ObjectPtr;
EXTERNAL;

FUNCTION ObtainDataType(typ : INTEGER; handle : ADDRESS; ...): DataTypePtr;
EXTERNAL;

FUNCTION PrintDTObject(o : ObjectPtr; win : WindowPtr; req : RequesterPtr; ...): INTEGER;
EXTERNAL;

PROCEDURE RefreshDTObject(o : ObjectPtr; win : WindowPtr; req : RequesterPtr; ...);
EXTERNAL;

FUNCTION SetDTAttrs(o : ObjectPtr; win : WindowPtr; req : RequesterPtr; ...): INTEGER;
EXTERNAL;
{$C-}
