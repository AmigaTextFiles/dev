...
{$I   "Include:DOS/DOS.i"}
{$I   "Include:Workbench/WorkbenchBaseVar.i"}
 ...
 * structures for code compatibility...
 ...
 FUNCTION AddAppMenuItemA(ID, UserData : Integer; Txt : String; Port : MsgPortPtr;
...
FUNCTION OpenWorkbenchLib(vers : Integer): Boolean;
external;

PROCEDURE CloseWorkbenchLib;
external;
...
{$C+}
FUNCTION AddAppMenuItem( ID, UserData : INTEGER; txt : STRING;
                         port : MsgPortPtr; ...): AppMenuItemPtr;
EXTERNAL;

function AddAppIcon( ID, UserData : INTEGER; txt : STRING; port : MsgPortPtr;
                     FL : FileLock; diskobj : DiskObjectPtr; ...): AppIconPtr;
EXTERNAL;

FUNCTION AddAppWindow( ID, UserData : INTEGER; win : WindowPtr;
                       port : MsgPortPtr; ...): AppWindowPtr;
EXTERNAL;
{$C-}
