...
FUNCTION Fault(Code : Integer; Txt : String; Buffer : String; BufferSize : Integer) : Integer;
    External;

FUNCTION FGetC(Datei : FileHandle) : Char;
    External;

FUNCTION FGets(Datei : FileHandle; Buffer : String; BufferSize : Integer) : String;
    External;
...
FUNCTION GetCurrentDirName(Buffer : String; BufferSize : Integer) : Boolean;
    External;

FUNCTION GetProgramDir : FileLock;
    External;

FUNCTION GetProgramName(Buffer : String; BufferSize : Integer) : Boolean;
    External;

FUNCTION GetPrompt(Buffer : String; BufferSize : Integer) : Boolean;
    External;
...
FUNCTION NameFromLock(Datei : FileLock; Buffer : String; BufferSize : Integer) : Boolean;
    External;
...
FUNCTION ReadLink(procID : Address; datei : FileLock; name : String;
                  buffer : String; buffersize : Integer) : Boolean;
...
FUNCTION SetVBuf(datei : FileHandle; Buffer : String; bufmode, buffersize : Integer) : Boolean;
    External;

FUNCTION SplitName(path : String; Separator : Char; Buffer : String; start : Short; BufferSize : Integer) : Short;
    External;

FUNCTION StrToLong(Str : String; L : Address) : Integer;
    External;
...
FUNCTION SetOwner(name : String; owner_info : Integer) : Boolean;
    External;

{
   This are varargs functions for use with PCQ Pascal vers. 2.0 and above
}


{$C+}
FUNCTION SystemTags(command : STRING; ...): INTEGER;
EXTERNAL;

PROCEDURE Printf(Str : STRING; ...);
EXTERNAL;

FUNCTION FWritef(datei : FileHandle; Str : STRING; ...): INTEGER;
EXTERNAL;

FUNCTION FPrintf(datei : FileHandle; Str : STRING; ...): INTEGER;
EXTERNAL;

FUNCTION AllocDosObjectTags(ObjectType : INTEGER; ...): ADDRESS;
EXTERNAL;
{$C-}
