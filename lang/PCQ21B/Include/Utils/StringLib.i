...
Function strneq(s1, s2 : String; n : Integer) : Boolean;
    external;
{
    ...
    external;
{
    ...
    Now uses the utility.library for the compare.
}

Function strnieq(s1, s2 : String; n : Integer) : Boolean;
    external;
{
...
Function strncmp(s1, s2 : String; n : Integer) : Integer;
    external;
{
    Same as strcmp(), but only considers the first n characters.
}

Function strnicmp(s1, s2 : String; n : Integer) : Integer;
    external;
