...
PROCEDURE SetKeyMapDefault( keyMap : KeyMapPtr);
EXTERNAL;

FUNCTION AskKeyMapDefault: KeyMapPtr;
EXTERNAL;

FUNCTION MapRawKey(event : InputEventPtr; buffer : string;
                   len : Integer; keyMap : KeyMapPtr): Short;
EXTERNAL;

FUNCTION MapANSI( str : string; count: Integer; buffer : string;
                  len : Integer; keyMap : KeyMapPtr): Integer;
EXTERNAL;
