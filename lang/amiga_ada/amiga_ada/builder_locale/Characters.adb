...
with Characters_App; use Characters_App;

procedure Characters is
...
Method_Result := DoMethodA(WI_Characters,temp_Msg);

ClearTagList(temp_TagList);
AddTag(temp_TagList, MUIA_Window_Open, True);

SetAttrs_Result := SetAttrsA(WI_Characters,temp_TagList);
