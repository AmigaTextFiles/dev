   ...
   char * argv[];
{
   ...
   locale___elabs ();
   locale___elabb ();
   characters_locale___elabs ();
   characters_locale___elabb ();
   mui___elabs ();
   mui___elabb ();
   characters_app___elabs ();
   characters_app___elabb ();
   characters___elabb ();
...
/gnu/lib/gcc-lib/amigados/2.5.8/adalib/s-strops.o
...
/work/projects/amiga_ada/dos_dos.o
...
/work/projects/amiga_ada/locale.o
characters_locale.o
