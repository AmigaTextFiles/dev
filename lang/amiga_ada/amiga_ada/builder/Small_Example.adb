...
with Small_Example_App; use Small_Example_App;

procedure Small_Example is
...
Method_Result := DoMethodA(WI_smallexample,temp_Msg);

ClearTagList(temp_TagList);
AddTag(temp_TagList, MUIA_Window_Open, True);

SetAttrs_Result := SetAttrsA(WI_smallexample,temp_TagList);
