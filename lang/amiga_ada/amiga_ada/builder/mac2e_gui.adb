...
with Mac2E_GUI_App; use Mac2E_GUI_App;

procedure Mac2E_GUI is
...
Method_Result := DoMethodA(WI_main,temp_Msg);

ClearTagList(temp_TagList);
AddTag(temp_TagList, MUIA_Window_Open, True);

SetAttrs_Result := SetAttrsA(WI_main,temp_TagList);
