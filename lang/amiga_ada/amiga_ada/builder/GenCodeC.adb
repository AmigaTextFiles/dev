...
with GenCodeC_App; use GenCodeC_App;

procedure GenCodeC is
...
Method_Result := DoMethodA(WI_GenCodeC,temp_Msg);

ClearTagList(temp_TagList);
AddTag(temp_TagList, MUIA_Window_Open, True);

SetAttrs_Result := SetAttrsA(WI_GenCodeC,temp_TagList);
