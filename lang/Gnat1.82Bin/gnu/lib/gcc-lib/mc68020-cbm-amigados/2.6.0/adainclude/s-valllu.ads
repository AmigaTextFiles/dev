...
--  ----------------------------
--  revision 1.1
--  date: Tue Aug  2 07:53:50 1994;  author: dewar
--  Initial revision
--  ----------------------------
--  revision 1.2
--  date: Sat Aug  6 17:02:14 1994;  author: dewar
--  Make into package for Rtsfind
--  Add pragma Pure
--  Change name from Value_LLU to Val_LLU
--  Name of function is now Scan_Long_Long_Unsigned
--  Move Scan_LLU here and rename Scan_Long_Long_Unsigned (was in sep package)
--  ----------------------------
--  revision 1.3
--  date: Wed Aug 31 00:06:43 1994;  author: dewar
--  (Scan_Long_Long_Unsigned): Change Max/Ptr to Positive'Base (null string)
--  (Scan_Long_Long_Unsigned): Document null string handling
--  ----------------------------
