...
/* Set to reflect the name of one of the variables defined above. */
#define SYS                     SYS_AMIGA
/* Set to 1 if you want to compile J along with some other source code */
#define LINKJ                   0

/* Set to 1 if your system requires double word allignment. */
#define SYS_DOUBLE              0
/* Set to 1 if your system supports the GETTOD function H. */
#define SYS_GETTOD              0
