...
;;; This file was modified 3-17-96 by Eric Van Zante at 5:21pm.
;;; Defined Shift Return. 

;;; This file was modified 8-03-96 by Eric Van Zante at 12:30pm.
;;; Added more key bindings that make more sense to the user.
;;; Took out some rather inconvenient key combinations for moving
;;; to the top and bottom of a file.
 

;;; This file was modified 8-06-96 by Eric Van Zante at 11:07pm.
;;; Added keypad characters for page up and page down
;;; removed annoying prev tab = shift tab and replaced it with meta tab
...
(bind-keys global-keymap
  ...
  "Shift-Up"    'goto-prev-line
  "Shift-Down"  'goto-next-line 
  "KP_7"	'(progn (set-auto-mark) (goto-char (pos nil 0)))
  "KP_1"	'(progn (set-auto-mark) (goto-char (pos nil (1- (buffer-length)))))
  ...
  "DEL"		'delete-char
  "Shift-Backspace" 'backspace-char
  "Shift-DEL"	'kill-line
  "Ctrl-DEL"	'kill-whole-line
  "Meta-DEL"	'kill-word
  "Meta-ESC"	'eval-and-print
  "Meta-TAB"	'goto-prev-tab
