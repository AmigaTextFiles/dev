...
begin
  ...
  if TR_OpenTriton(TRITON11VERSION,TRCA_Name,"ToolManagerGUIDemo2",
     TRCA_LongName,"ToolManager GUI demo 2",TRCA_Info,
     "Looks like the ToolManager demo 2 of GUIFront",TAG_END) then begin
