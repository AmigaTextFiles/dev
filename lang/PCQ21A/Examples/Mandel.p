...
{
    Changed const names to 2.0+.
    WritePixel is now a function and not a procedure.
    Fixed the prog so it will compile.
    12 May 1998.
...
CONST
   NW: NewWindow = (0,19,320,380,1,7,IDCMP_CLOSEWINDOW,
                    WFLG_DRAGBAR + WFLG_CLOSEGADGET + WFLG_SMART_REFRESH + WFLG_BORDERLESS + WFLG_ACTIVATE,
