...
const char *MyVersion = "$VER:bwbasic 3.22 PPC/OS 4.1 (5.5.2023) compiled for Amiga by M. Bergmann, © MB-SoftWorks\n";
...
static char *Banner[] = {
  ...
  "                                    ########  ##     ##  ######  ####  ###### ",
  "                                                                              ",
  "Bywater BASIC Interpreter, version 3.22                                       ",
  "Copyright (c) 1993, Ted A. Campbell                                           ",
  "Copyright (c) 1995-1997, Jon B. Volkoff                                       ",
  "Copyright (c) 2014-2017, Howard Wulf, AF5NE                                   ",
  "                                                                              ",
  "compiled for Amiga 68k/PPC by Micha B. 05/2023                                ",
  "                                                                              ",
  NULL
};
