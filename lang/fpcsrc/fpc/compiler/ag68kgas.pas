{
    $Id: ag68kgas.pas,v 1.1.1.1.2.5 1998/09/14 18:57:23 carl Exp $
...
{
  $Log: ag68kgas.pas,v $
  Revision 1.1.1.1.2.5  1998/09/14 18:57:23  carl
    * byte alignment

  Revision 1.1.1.1.2.4  1998/08/13 17:41:18  florian
    + some stuff for the PalmOS added

  Revision 1.1.1.1.2.3  1998/07/01 13:58:44  carl
     ?
