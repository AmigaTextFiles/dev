...
{$ifdef m68k}
   ...
   of_o :   begin
              if CallAssembler(FindAssembler(of_gas),' -o '+objfile+' '+asmfile) then
               RemoveAsm;
            end;
   of_gas : begin
             { !! Nothing yet !! }
...
{
  $Log: assemble.pas,v $
  Revision 1.1.1.1.2.2  1998/08/13 13:33:16  carl
    + assembling is automatically tried with -Ao switch (default)

  Revision 1.1.1.1.2.1  1998/04/08 11:38:43  peter
