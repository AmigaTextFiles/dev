...
{$endif GDB}
        ...
        ait_string : begin
                       ...
                       for i:=1 to pai_string(hp)^.len do
                        ...
                        #1..#31,
                        #48..#57,{ Bug with gas < 2.00 with reading octals followed by digits }
...
{
  $Log: ag68kmit.pas,v $
  Revision 1.1.1.1.2.4  1998/09/14 18:55:48  carl
    * alignment bugfix for bytes

  Revision 1.1.1.1.2.3  1998/07/21 12:10:12  carl
    * old MIT syntax does not like octal values by numeric digit strings
