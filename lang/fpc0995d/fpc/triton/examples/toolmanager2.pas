...
uses exec, triton, tritonmacros, linklist, vartags, utility;
...
begin
    ...
    Triton_App := TR_CreateApp(TAGS(
                          TRCA_Name,longstr('ToolManagerGUIDemo2'),
                          TRCA_LongName,longstr('ToolManager GUI demo 2'),
                          TRCA_Info,longstr('Looks like the ToolManager demo 2 of GUIFront'),
                          TAG_END));
