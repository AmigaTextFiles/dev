  ...
  HorizGroupA;
    ...
    SetTRTag(TRGR_Vert,                 TRGR_PROPSHARE OR TRGR_ALIGN OR TRGR_FIXHORIZ);
      ...
      SetTRTag(TRGR_Horiz,              TRGR_EQUALSHARE OR TRGR_CENTER);
        ...
        SetTRTag(TROB_Space,            Longint(NIL));
        SetTRTag(TROB_Text,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('Load')); SetTRTag(TRAT_Flags, TRTX_TITLE);
        SetTRTag(TROB_Space,            Longint(NIL));
        SetTRTag(TROB_Line,             TROF_HORIZ);
        SetTRTag(TRGR_End,              Longint(NIL));
      SetTRTag(TROB_Space,              Longint(NIL));
      SetTRTag(TROB_Button,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('_Sender...')); SetTRTag(TRAT_ID, 501);
      SetTRTag(TROB_Space,              TRST_SMALL);
      SetTRTag(TROB_Button,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('_Addressee...')); SetTRTag(TRAT_ID, 502);
      SetTRTag(TROB_Space,              TRST_SMALL);
      SetTRTag(TROB_Button,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('_Comment...')); SetTRTag(TRAT_ID, 503);
      SetTRTag(TROB_Space,              Longint(NIL));
      SetTRTag(TRGR_Horiz,              TRGR_EQUALSHARE OR TRGR_CENTER);
        SetTRTag(TROB_Line,             TROF_HORIZ);
        SetTRTag(TROB_Space,            Longint(NIL));
        SetTRTag(TROB_Text,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('Save')); SetTRTag(TRAT_Flags, TRTX_TITLE);
        SetTRTag(TROB_Space,            Longint(NIL));
        SetTRTag(TROB_Line,             TROF_HORIZ);
        SetTRTag(TRGR_End,              Longint(NIL));
      SetTRTag(TROB_Space,              Longint(NIL));
      SetTRTag(TROB_Button,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('S_ender...')); SetTRTag(TRAT_ID, 504);
      SetTRTag(TROB_Space,              TRST_SMALL);
      SetTRTag(TROB_Button,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('A_ddressee...')); SetTRTag(TRAT_ID, 505);
      SetTRTag(TROB_Space,              TRST_SMALL);
      SetTRTag(TROB_Button,             Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('C_omment...')); SetTRTag(TRAT_ID, 506);
      SetTRTag(TROB_Space,              TRST_BIG);
      SetTRTag(TROB_Line,               TROF_HORIZ);
      SetTRTag(TROB_Space,              TRST_BIG);
      SetTRTag(TRGR_Horiz,              TRGR_EQUALSHARE);
        SetTRTag(TROB_Button,           Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('_Print...')); SetTRTag(TRAT_ID, 507);
        SetTRTag(TROB_Space,            TRST_SMALL);
        SetTRTag(TROB_Button,           Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('S_wap')); SetTRTag(TRAT_ID, 508);
        SetTRTag(TRGR_End,              Longint(NIL));
      SetTRTag(TROB_Space,              TRST_SMALL);
      SetTRTag(TRGR_Horiz,              TRGR_EQUALSHARE);
        SetTRTag(TROB_Button,           Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('Pre_fs...')); SetTRTag(TRAT_ID, 509);
        SetTRTag(TROB_Space,            TRST_SMALL);
        SetTRTag(TROB_Button,           Longint(NIL)); SetTRTag(TRAT_Text,  LongStr('C_lear')); SetTRTag(TRAT_ID, 510);
        SetTRTag(TRGR_End,              Longint(NIL));
      SetTRTag(TROB_Space,              Longint(NIL));
    SetTRTag(TRGR_End,                  Longint(NIL));
...
begin
  Triton_App := TR_CreateApp(TAGS(
                TRCA_Name,longstr('Envprint'),
                TRCA_LongName,longstr('EnvPrint GUI demo'),
