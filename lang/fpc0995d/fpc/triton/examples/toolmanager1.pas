...
uses exec, triton, tritonmacros, amigalib, utility, vartags, linklist;
...
begin
    ...
    Triton_App := TR_CreateApp(TAGS(
                               TRCA_Name,longstr('ToolManagerGUIDemo1'),
                               TRCA_LongName,longstr('ToolManager GUI demo 1'),
                               TRCA_Info,longstr('Looks like the original ToolManager'),
                               TAG_END));
