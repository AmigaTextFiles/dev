...
FUNCTION MUI_AddClipping(mri : pMUI_RenderInfo; l : INTEGER; t : INTEGER; w : INTEGER; h : INTEGER) : POINTER;
...
function OBJ_Left(obj : APTR) : INTEGER;           (* valid during MUIM_Draw *)
function OBJ_Top(obj : APTR) : INTEGER;            (* valid during MUIM_Draw *)
function OBJ_Width(obj : APTR) : INTEGER;          (* valid during MUIM_Draw *)
function OBJ_Height(obj : APTR) : INTEGER;         (* valid during MUIM_Draw *)
function OBJ_Right(obj : APTR) : INTEGER;          (* valid during MUIM_Draw *)
function OBJ_Bottom(obj : APTR) : INTEGER;         (* valid during MUIM_Draw *)
function OBJ_AddLeft(obj : APTR) : INTEGER;        (* valid during MUIM_Draw *)
function OBJ_AddTop(obj : APTR) : INTEGER;         (* valid during MUIM_Draw *)
function OBJ_SubWidth(obj : APTR) : INTEGER;       (* valid during MUIM_Draw *)
function OBJ_SubHeight(obj : APTR) : INTEGER;      (* valid during MUIM_Draw *)
function OBJ_MLeft(obj : APTR) : INTEGER;          (* valid during MUIM_Draw *)
function OBJ_MTop(obj : APTR) : INTEGER;           (* valid during MUIM_Draw *)
function OBJ_MWidth(obj : APTR) : INTEGER;         (* valid during MUIM_Draw *)
function OBJ_MHeight(obj : APTR) : INTEGER;        (* valid during MUIM_Draw *)
function OBJ_MRight(obj : APTR) : INTEGER;         (* valid during MUIM_Draw *)
function OBJ_MBottom(obj : APTR) : INTEGER;        (* valid during MUIM_Draw *)
...
function OBJ_Between(a,x,b : Integer): boolean;
function OBJ_IsInObject(x,y : Integer; obj : pObject_): boolean;
    ...
    IF MUIMasterBase <> NIL THEN begin
        ...
        ExitProc := @CloseMuiMasterLibrary;
         ...
         MessageBox('FPC Pascal Error',
                    'Can''t open muimaster.library version ' + 
                    VERSION +
                    chr(10) + 
