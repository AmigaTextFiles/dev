...
FUNCTION ReadArgs(arg_template : pCHAR; var arra : pLONGINT; args : pRDArgs) : pRDArgs;
...
FUNCTION DOSRename(oldName : string; newName : pChar) : LONGINT;
FUNCTION DOSRename(oldName : pCHAR; newName : string) : LONGINT;
FUNCTION DOSRename(oldName : string; newName : string) : LONGINT;
