...
USES Intuition, Exec, Graphics, GadTools, Utility, vartags,pastoc;
...
begin
   ...
   gad := CreateGadgetA(CYCLE_KIND,gad,@ng,TAGS(
                                         GTCY_Labels,long(thearr),
                                         TAG_END));
   CycleGadget := gad;
end;
...
BEGIN
  ...
  wp := OpenWindowTagList(NIL,TAGS(
                WA_Gadgets, LONG(glist),
                WA_Title, longstr('Test of EasyGadtools'),
                WA_Left,100,
                WA_Top,100,
