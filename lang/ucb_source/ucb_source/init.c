...
#ifdef AMIGA
      {"am.version", 0, 0, 0, PREFIX_PRIORITY, lam_version},
      {"am.prefs", 0, 0, 0, PREFIX_PRIORITY, lam_prefs},
#endif
...
#ifdef AMIGA
      {"mm.screensize", 0, 0, 0, PREFIX_PRIORITY, lmm_screensize},
      {"mm.pixel", 1, 1, 1, PREFIX_PRIORITY, lmm_pixel},
      {"mm.turtle", 1, 1, 1, PREFIX_PRIORITY, lmm_turtle},
      {"mm.alert", 2, 2, 2, PREFIX_PRIORITY, lmm_alert},
      {"mm.getlist", 2, 2, 3, PREFIX_PRIORITY, lmm_getlist},
      {"mm.getint", 2, 2, 5, PREFIX_PRIORITY, lmm_getint},
      {"mm.filerequest", 1, 1, 2, PREFIX_PRIORITY, lmm_filerequest},
      {"mm.waitclick", 0, 0, 0, PREFIX_PRIORITY, lmm_waitclick},
      {"mm.waitkey", 0, 0, 0, PREFIX_PRIORITY, lmm_waitkey},
      /* {"mm.showimage", 3, 3, 3, PREFIX_PRIORITY, lmm_showimage}, */
#endif
