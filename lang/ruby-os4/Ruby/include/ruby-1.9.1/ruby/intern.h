...
RUBY_DEPRECATED(void rb_quad_pack(char*,VALUE));
RUBY_DEPRECATED(VALUE rb_quad_unpack(const char*,int));
...
RUBY_DEPRECATED(void rb_gc_mark_threads(void));
...
RUBY_DEPRECATED(int rb_thread_select(int, fd_set *, fd_set *, fd_set *, struct timeval *));
...
RUBY_DEPRECATED(VALUE rb_struct_iv_get(VALUE, const char*));
