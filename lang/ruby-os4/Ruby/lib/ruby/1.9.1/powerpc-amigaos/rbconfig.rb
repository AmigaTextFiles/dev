...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/powerpc-amigaos")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/RUBY")
  ...
  CONFIG["configure_args"] = " '--prefix=/RUBY' '--target=ppc-amigaos' '--host=ppc-amigaos' '--disable-largefile' '--disable-install-doc' '--disable-install-rdoc' '--disable-install-capi' 'LDFLAGS=-use-dynld' 'CFLAGS=-I/SDK/local/newlib/include/aos4util' 'LIBS=-laos4util -lunix -lauto' 'host_alias=ppc-amigaos' 'target_alias=ppc-amigaos' 'CC=ppc-amigaos-gcc'"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "powerpc-amigaos"
  CONFIG["RI_BASE_NAME"] = "ri"
  CONFIG["ridir"] = "$(datarootdir)/$(RI_BASE_NAME)"
  CONFIG["rubylibprefix"] = "$(libdir)/$(RUBY_BASE_NAME)"
  CONFIG["MAKEFILES"] = "Makefile"
  CONFIG["PLATFORM_DIR"] = ""
  CONFIG["THREAD_MODEL"] = "amigaos4"
  ...
  CONFIG["LIBRUBY_LDSHARED"] = "ppc-amigaos-gcc -shared"
  ...
  CONFIG["setup"] = "Setup"
  CONFIG["EXTSTATIC"] = ""
  CONFIG["STRIP"] = "ppc-amigaos-strip"
  CONFIG["TRY_LINK"] = ""
  ...
  CONFIG["DLEXT2"] = ""
  CONFIG["DLEXT"] = "so"
  CONFIG["LDSHAREDXX"] = "ppc-amigaos-g++ -shared"
  CONFIG["LDSHARED"] = "ppc-amigaos-gcc -shared"
  CONFIG["CCDLFLAGS"] = "-fno-common -fPIC -DPIC"
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = ""
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["SET_MAKE"] = ""
  CONFIG["LN_S"] = "ln -s"
  CONFIG["NM"] = "ppc-amigaos-nm"
  CONFIG["DLLWRAP"] = ""
  CONFIG["WINDRES"] = ""
  CONFIG["OBJCOPY"] = ":"
  CONFIG["OBJDUMP"] = "ppc-amigaos-objdump"
  CONFIG["ASFLAGS"] = ""
  CONFIG["AS"] = "ppc-amigaos-as"
  CONFIG["AR"] = "ppc-amigaos-ar"
  CONFIG["RANLIB"] = "ppc-amigaos-ranlib"
  CONFIG["try_header"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["CXX"] = "ppc-amigaos-g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -use-dynld"
  CONFIG["CFLAGS"] = ""
  CONFIG["CC"] = "ppc-amigaos-gcc"
  CONFIG["target_os"] = "amigaos"
  CONFIG["target_vendor"] = "unknown"
  CONFIG["target_cpu"] = "powerpc"
  CONFIG["target"] = "powerpc-unknown-amigaos"
  CONFIG["host_os"] = "amigaos"
  CONFIG["host_vendor"] = "unknown"
  CONFIG["host_cpu"] = "powerpc"
  CONFIG["host"] = "powerpc-unknown-amigaos"
  ...
  CONFIG["target_alias"] = "ppc-amigaos"
  CONFIG["host_alias"] = "ppc-amigaos"
  CONFIG["build_alias"] = ""
  CONFIG["LIBS"] = "-ldl"
  CONFIG["ECHO_T"] = ""
  CONFIG["ECHO_N"] = "-n"
