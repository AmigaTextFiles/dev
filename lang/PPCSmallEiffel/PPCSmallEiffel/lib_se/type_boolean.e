...
feature 
   ...
   make(sp: like start_position) is
      do
	 !!base_class_name.make(us_boolean,sp);
      end;
...
feature
   ...
   jvm_to_reference is
	 ...
	 ca.opcode_dup_x1;
	 ca.opcode_swap;
	 idx := constant_pool.idx_fieldref4(idx,us_item,fz_73);
   ...
   to_reference is
      do
	 cpp.to_reference(Current,type_boolean_ref);
      end;

   to_expanded is
      do
	 cpp.to_expanded(type_boolean_ref,Current);
      end;
