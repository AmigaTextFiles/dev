...
feature 
   ...
   make is
	 ...
	 if argument_count < 1 then
	    echo.w_put_string("Bad use of command `pretty'.%N");
	    print_help("pretty");
...
feature {NONE}
   ...
   pretty_for(name: STRING) is
	 ...
	 e_class: BASE_CLASS;
      do
	 e_class := small_eiffel.load_class(name);
