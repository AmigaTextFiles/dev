 ...
 */
#define ARCHLIB_EXP "/ade/lib/perl5/m68k-cbm-amigaos/5.003"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB_EXP "/ade/lib/perl5"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH_EXP "/ade/lib/perl5/site_perl/m68k-cbm-amigaos"		/**/

/* SITELIB_EXP:
 *	This symbol contains the ~name expanded version of SITELIB, to be used
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITELIB_EXP "/ade/lib/perl5/site_perl"		/**/
