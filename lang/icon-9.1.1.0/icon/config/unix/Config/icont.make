...
PGMS=		amigahdr.hdr icont

all:		$(PGMS)

hdr.h:		newhdr.c amigahdr.hdr tproto.h
		$(CC) $(CFLAGS) -o newhdr newhdr.c
		./newhdr <amigahdr.hdr >hdr.h

common:
		cd ../common; $(MAKE) $(ICOBJS)

icont:		hdr.h amigahdr.hdr $(OBJS) common
