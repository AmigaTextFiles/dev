...
#define SEGMENT_HEADER_MIN_SIZE    44       /* Taille de la partie fixe du Header */
#define SEGMENT_HEADER_SIZE        64       /* Taille habituelle (pourait être plus grande) */
...
struct omf_segment_header
{
  ...
  WORD DispNameOffset;         /* Offset où se situe le LoadName */
  WORD DispDataOffset;         /* Offset où commence le Segment Body */

  int TempOrgLength;           /* Usually nothing here */
...
struct omf_file *LoadOMFFile(char *);
void mem_free_omf(struct omf_file *);
