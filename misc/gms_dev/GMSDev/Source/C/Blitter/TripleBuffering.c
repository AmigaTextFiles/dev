/* Dice: 1> dcc -l0 -mD dpk.o tags.o TripleBuffering.c -o TripleBuffering
**
** This version of the PixelList demo is triple buffered.
*/

#include <proto/dpkernel.h>

BYTE *ProgName      = "Pixel-List Demo (Triple Buffered)";
