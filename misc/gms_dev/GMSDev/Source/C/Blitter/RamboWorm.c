/* Dice: 1> dcc -l0 -mD dpk.o tags.o RamboWorm.c -o RamboWorm
**
  ...
  */
  ...
  if (FastRandom(3) IS 1) {
     ...
     while (x1 < screen->Width) {
        DrawLine(screen->Bitmap,x1++,y1,x2,y2,0,0xaaaaaaaa);   /* Up/Right */
        DrawLine(screen->Bitmap,ax1,ay1,ax2--,ay2,0,0xaaaaaaaa); /* Down/Left */
