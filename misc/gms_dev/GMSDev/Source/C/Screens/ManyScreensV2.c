/* Dice: 1> dcc -l0 -mD dpk.o ManyScreens2.c -o ManyScreens2
**
...
**
** In this version a screen is shown, then a second screen is shown
** on top of that, then they are both removed at the same time.
*/

#include <proto/dpkernel.h>
#include <clib/colours_protos.h>

BYTE *ProgName      = "Multiple Screens V2";
