...
#define IOBLIX_Z2_NUM_ETHERNETUNITS 1       /* max. Ethernet modules on Z2 board        */
...
#define IOBLIX_CP_NUM_ETHERNETUNITS 0       /* max. Ethernets on clock port board       */
...
struct IOBlixBoardNode {
    ...
    /* new for V37.11 */
    UWORD ibn_FirmwareVersion;              /* the board's ISP firmware version         */
                                            /* only valid for Z2 boards                 */
};
...
struct IOBlixChipNode {
    ...
    union {
        ...
        struct EthernetChipProperties {
            ULONG ecp_ChipType;
            ULONG ecp_MBitPerSecond;
            UBYTE ecp_MACAddress[8]; // should be SANA2_MAX_ADDR_BYTES, but this way I avoid to include "devices/sana2.h"
        } icn_EthernetChipProperties;
...
#define icne_ChipType               icn_Properties.icn_EthernetChipProperties.ecp_ChipType
#define icne_MBitPerSecond          icn_Properties.icn_EthernetChipProperties.ecp_MBitPerSecond
#define icne_MACAddress             icn_Properties.icn_EthernetChipProperties.ecp_MACAddress
...
/* ecp_Flags */
/* unknown Ethernet chip */
#define ECPT_UNKNOWN                0
/* SMC 91C92 */
#define ECPT_SMC91C92               1
/* SMC 91C94 */
#define ECPT_SMC91C94               2
