...
svn_prop_is_amiga_prop (const char *prop_name)
{
  return strncmp (prop_name, "amiga:", strlen("amiga:"))
         ? FALSE 
         : TRUE;
}
...
#else
  return svn_prop_is_svn_prop (propname) || svn_prop_is_amiga_prop (propname);
#endif /* AMIGA */
}
