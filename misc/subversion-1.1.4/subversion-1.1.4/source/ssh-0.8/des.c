...
static uint32_t 
bitsel (uint32_t *input, const int *bitnums, int size)
{
  uint32_t ret = 0;
  while (size--)
  {
...
void 
des_set_key (uint8_t *key, DESCon * sched)
{
  uint32_t key_msw = GET_32BIT_MSB_FIRST (key);
  uint32_t key_lsw = GET_32BIT_MSB_FIRST (key + 4);
...
static void 
des_encipher (uint32_t *output, uint32_t L, uint32_t R, DESCon * sched)
{
...
static void 
des_decipher (uint32_t *output, uint32_t L, uint32_t R, DESCon * sched)
{
  uint32_t swap, s0246, s1357;
...
static void 
des_cbc_encrypt (uint8_t *dest, const uint8_t *src, unsigned int len, DESCon * sched)
{
...
static void 
des_cbc_decrypt (uint8_t *dest, const uint8_t *src, unsigned int len, DESCon * sched)
{
...
void 
des_3cbc_encrypt (uint8_t *dest, const uint8_t *src, unsigned int len, DESCon * scheds)
{
...
void 
des_3cbc_decrypt (uint8_t *dest, const uint8_t *src, unsigned int len, DESCon * scheds)
{
