...
{ 
    ...
    /* This is a kludge because the standard Amiga file system semantics
       work out so that a directory is always readable, writable and
       accessible, no matter what its attributes say. */
...
#ifdef AMIGA
    mode |= S_IRUSR|S_IWUSR; /* enable read/write */
#endif /* AMIGA */
