...
unsigned byte *Wall[NbrWallBMPs];
...
static char *version = "$VER: WOLF3D V0.3 (12 Jan 94) Copyright ©1994 Terence Russell. All rights reserved.";

struct Rectangle MyRect = { 0,0,320,200 };
