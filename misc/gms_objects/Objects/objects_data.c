...
#define OBJMOD_VERSION  2
#define OBJMOD_REVISION 0
...
struct ModHeader ModHeader = {
  ...
  OBJMOD_VERSION,   /* Version of this module */
  OBJMOD_REVISION,  /* Revision of this module */
...
struct SysObject *OFObject;
struct ModPublic *Public;
struct Module    *ConfigModule;
struct Module    *StrModule;
