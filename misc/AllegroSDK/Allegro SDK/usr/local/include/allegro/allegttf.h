...
/* Load a ttf font from a file */
	struct FONT *load_ttf_font_ex2(const char *filename, const int points_w, const int points_h, const int begin, const int end,
								   const int smooth);
...
/* Load a ttf font from a file using TTF2PCX on the path, saves memory! */
	struct FONT *load_ttf_font_ex2_mem(const char *filename, const int pw, const int ph, const int begin, const int end,
									   const int smooth);
