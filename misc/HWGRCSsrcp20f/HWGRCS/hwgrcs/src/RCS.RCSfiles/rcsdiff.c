...
#ifdef _AMIGA
char HWGversion[] = "$" "VER: " PRGPREFIX "rcsdiff " PRGVERSION "." PRGREVISION " (" PRGDATE ")" PRGVERTEXT;
#endif /* _AMIGA */
mainProg(rcsdiffId, "rcsdiff", "$Id: rcsdiff.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
{
