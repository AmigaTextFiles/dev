...
1.2
date	96.03.03.10.56.59;	author heinz;	state Exp;
branches;
next	1.1;
...
#define RCSBASE "$Id: rcsbase.h 1.1 1996/03/02 16:37:23 heinz Exp heinz $"
...
#ifdef _AMIGA
/* Workingfiles alwas have the delete bit set! */

#define WORKMODE(RCSmode, writable) ((RCSmode)&~(S_IWUSR|S_IWGRP|S_IWOTH) | ((writable)?S_IWUSR:0) | S_IDUSR)
#else
...
#define STATE           "State"
#ifdef _AMIGA
/* We handle C= style version strings and the special Amiga Protection bits
   this way. */
#define CBMVERSION      "VER"
#define CBMREVISION     "AmigaREV"
#define CBMDATE         "AmigaDATE"
#define CBMPROTECTION   "AmigaProtection"
#define keylength 15 /* max length of any of the above keywords */

enum markers { Nomatch, Author, Date, Header, Id,
               Locker, Log, Name, RCSfile, Revision, Source, State,
               CBMVersion, CBMRevision, CBMDate, CBMProtection };
#else
...
/* rcsedit */
#ifdef _AMIGA
/* We need this flag to tell expandline when to increment the special
   revision numbers for our Amiga keywords. It is only set in ci */
extern struct hshentry *CBMRevIncDelta;
#endif /* _AMIGA */
