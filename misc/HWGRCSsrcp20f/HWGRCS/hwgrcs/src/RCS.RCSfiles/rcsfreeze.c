...
1.2
date	96.03.25.06.23.48;	author heinz;	state Exp;
branches;
next	1.1;
...
desc
@AMIGA specific rcsfreeze implementation.
@


1.2
log
@Will now accept a second argument. A date to be passed to "rcs" via "-d".
This allows for selectively freezing old revisions..
@
text
@/*------------------------------------------------------------------------*/
/*                                                                        *
 *  $Id: rcsfreeze.c 1.1 1996/03/03 10:57:16 heinz Exp heinz $
 *                                                                        */
/*------------------------------------------------------------------------*/
...
@d3 1
a3 1
 *  $Id: rcsfreeze.c,v 1.15 1995/01/21 18:01:02 heinz Exp $
d27 6
d80 1
d84 4
a87 1
#define PRGVER "$" "VER: "PRGPREFIX "rcsfreeze " PRGVERSION "." PRGREVISION " (" PRGDATE ")" PRGVERTEXT
d100 2
a101 1
...
d276 1
a276 1
                error = freeze_revs(SysBase, DOSBase, symrevname, rcsdir);
d448 1
d481 6
a486 2
