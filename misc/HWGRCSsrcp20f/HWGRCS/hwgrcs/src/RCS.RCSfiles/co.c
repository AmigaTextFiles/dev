...
1.3
date	96.03.25.06.23.05;	author heinz;	state Exp;
branches;
next	1.2;
...
1.3
log
@Removed setmode hack. setmode is now a macro in conf.h.amiga.
@
text
...
#endif /* _AMIGA */
mainProg(coId, "co", "$Id: co.c 1.2 1996/03/03 10:57:16 heinz Exp heinz $")
{
...
d204 1
a204 1
mainProg(coId, "co", "$Id: co.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
a362 4
#ifdef _AMIGA
/* BUG! No prototype, no portability! We use an SAS/C function */
                        VOID iomode(STDOUT_FILENO, (newmode == OPEN_O_BINARY));
#else
a363 1
#endif /* _AMIGA */
@
