...
#ifdef _AMIGA
char HWGversion[] = "$" "VER: " PRGPREFIX "rcsclean " PRGVERSION "." PRGREVISION " (" PRGDATE ")" PRGVERTEXT;
#endif /* _AMIGA */
mainProg(rcscleanId, "rcsclean", "$Id: rcsclean.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
{
...
#			if has_dirent
#ifdef _AMIGA
/* The Amiga uses an empty string for the current directory */
