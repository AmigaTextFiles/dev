 ...
 * Initial revision
 *
 * Revision 1.1  1995/12/25  16:20:54  heinz
 * Initial revision
 *
...
libId(fcmpId, "$Id: rcsfcmp.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
...
#ifdef _AMIGA
/* For the CBMVersion keyword, we have to allow a trailing '\n' compared
   to a KDELIM.
*/
              if(match1 == CBMVersion)
              {
                  xc = uc = KDELIM;
              }
              else
...
d128 1
a128 1
libId(fcmpId, "$Id: rcsfcmp.c,v 1.1 1995/12/25 16:20:54 heinz Exp $")
d263 14
d279 1
@
