...
libId(genId, "$Id: rcsgen.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
...
#ifdef _AMIGA
/* As standard buffering is line buffering with SAS/C, it is wise to flush
   this output channel before reading in a user response. The user wants to
   see some text, I guess. I am not sure if this is a bug fix or an "Amiga
   only" patch. Anyway, it can't hurt, I guess.
*/
