...
#ifdef _AMIGA
char HWGversion[] = "$" "VER: " PRGPREFIX "ident " PRGVERSION "." PRGREVISION " (" PRGDATE ")" PRGVERTEXT;
#endif /* _AMIGA */
mainProg(identId, "ident", "$Id: ident.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
