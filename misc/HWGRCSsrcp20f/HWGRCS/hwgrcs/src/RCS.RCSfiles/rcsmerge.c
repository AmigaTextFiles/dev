...
#ifdef _AMIGA
char HWGversion[] = "$" "VER: " PRGPREFIX "rcsmerge " PRGVERSION "." PRGREVISION " (" PRGDATE ")" PRGVERTEXT;
#endif /* _AMIGA */
mainProg(rcsmergeId, "rcsmerge", "$Id: rcsmerge.c 1.1 1996/03/02 16:37:23 heinz Exp heinz $")
{
