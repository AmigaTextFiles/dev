...
/* Define to an ED compatible program */
#undef ED_PROG

#ifndef ED_PROG
#define ED_PROG "/bin/ed"
#endif

/* Define to your temporary directory. Trailing slash is needed. */
#define TMPDIRECTORY  "T:"

#ifndef TMPDIRECTORY
#define TMPDIRECTORY "/tmp/"
#endif

/* Define to your NULL device */
#define NULL_DEVICE "NIL:"

#ifndef NULL_DEVICE
#define NULL_DEVICE "/dev/nul"
#endif
