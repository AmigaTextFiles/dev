...
{ return (v==e->s) ? graph::adj_succ(e) : graph::in_succ(e); }

edge adj_pred(edge e,node v) const 
{ return (v==e->s) ? graph::adj_pred(e) : graph::in_pred(e); }

edge cyclic_adj_succ(edge e,node v)  const
{ return (v==e->s) ? graph::cyclic_adj_succ(e) : graph::cyclic_in_succ(e); }

edge cyclic_adj_pred(edge e,node v) const
{ return (v==e->s) ? graph::cyclic_adj_pred(e) : graph::cyclic_in_pred(e); }
...
ugraph& operator=(const ugraph& a) { graph::operator=(a); 
                                     undirected = true;
                                     return *this; }
