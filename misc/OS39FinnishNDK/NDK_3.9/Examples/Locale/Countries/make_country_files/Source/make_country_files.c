 ...
 * :ts=4
 *
 * $VER: make_country_files 44.2 (6.9.1999)
 *
 * Revision 44.1 (22.8.1999) olaf
 * - initial source
 *
 * Revision 44.2 (6.9.1999) jp
 * - new: czech_republic.country
 * - new: slovakia.country
 * - added pragmas and library bases
 *
 ...
 * version (e.g. "44.1 (22.8.1999)") and the actual country data as
...
struct CountryData czech_republic_prefs =
{
	"czech_republic",
	"44.1 (6.9.1999)",
	...
	{
	/* cp_Reserved              */ { 0 },
	/* cp_CountryCode           */ MAKE_ID('C','Z',0,0),
...
struct CountryData slovakia_prefs =
{
	"slovakia",
	"44.1 (6.9.1999)",
	...
	{
	/* cp_Reserved              */ { 0 },
	/* cp_CountryCode           */ MAKE_ID('S','K',0,0),
...
struct CountryData suomi_prefs =
{
	"suomi",
	"44.3 (11.5.2002)",
	...
	/* cp_MeasuringSystem       */ MS_ISO,
	/* cp_DateTimeFormat        */ "%e. %Bta %Y klo %q.%M,%S",
	/* cp_DateFormat            */ "%e. %Bta %Y",
	/* cp_TimeFormat            */ "%q.%M,%S",
	/* cp_ShortDateTimeFormat   */ "%e.%m.%y klo %q.%M",
	/* cp_ShortDateFormat       */ "%e.%m.%y",
...
struct CountryData suomi_euro_prefs =
{
	"suomi",
	"44.3 (11.5.2002)",
