* 
* $VER: suomi.language.asm 1.1 (23.4.2002)
* 
* 
* AUTHOR
*     Janne Peräaho
...
* 
* COMPILING
*     In order to compile the suomi.language.asm, PhxAss macro assembler 
*     (version 4.39), PhxLnk linker (version 4.32), and 3.x Amiga include 
*     files and libs are required.
*     You can find three scripts included in this package: make, phx_ass, and 
*     phx_lnk. By executing the "make" script, you can build the final 
*     suomi.language library.
* 
* REQUIREMENTS
*     · 3.x Amiga include files and libs    (C compilers, Developer CD,...)
*     · PhxLnk linker version 4.32          (Aminet:dev/asm)
*     · PhxAss macro assembler version 4.39 (Aminet:dev/asm)
* 
* NOTES
*     Script "phx_ass" uses SAS/C's include files for compiling. You can 
*     change the include files path (parameter "i") by editing the "phx_ass" 
*     script.
* 
*     suomi.language library is based on following source codes:
* 
*     · english.language.asm     - Developer CD V2.1
*     · english.language_rev.h   - Developer CD V2.1
*     · english.language_rev.i   - Developer CD V2.1
*     · english.language_rev.rev - Developer CD V2.1
*     · languagedrivers.h        - Developer CD V2.1
*     · languagedrivers.i        - Developer CD V2.1
*
...
Strings:
S000 DC.B   "",0
S001 DC.B   "sunnuntai",0   ; Sunday
S002 DC.B   "maanantai",0   ; Monday
S003 DC.B   "tiistai",0     ; Tuesday
S004 DC.B   "keskiviikko",0 ; Wednesday
S005 DC.B   "torstai",0     ; Thursday
S006 DC.B   "perjantai",0   ; Friday
S007 DC.B   "lauantai",0    ; Saturday
...
S015 DC.B   "tammikuu",0    ; January
S016 DC.B   "helmikuu",0    ; February
S017 DC.B   "maaliskuu",0   ; March
S018 DC.B   "huhtikuu",0    ; April
S019 DC.B   "toukokuu",0    ; May
S020 DC.B   "kesäkuu",0     ; June
S021 DC.B   "heinäkuu",0    ; July
S022 DC.B   "elokuu",0      ; August
S023 DC.B   "syyskuu",0     ; September
S024 DC.B   "lokakuu",0     ; October
S025 DC.B   "marraskuu",0   ; November
S026 DC.B   "joulukuu",0    ; December
...
S047 DC.B   "eilen",0       ; Yesterday
S048 DC.B   "tänään",0      ; Today
S049 DC.B   "huomenna",0    ; Tomorrow
S050 DC.B   "myöhemmin",0   ; Future
S051 DC.B   "",0
