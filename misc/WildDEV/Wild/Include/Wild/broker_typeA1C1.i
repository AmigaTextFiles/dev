	IFND	WILDBROKERTYPE1
WILDBROKERTYPE1	SET	1
...
*****OBSOLETE		APTR	t1bs_HighPoint		; the point high NB: POINTS TO THE TMPSTRUCT,NOT TO THE POINTSTRUCT
*****Those		APTR	t1bs_MidPoint		; the mid point
*****are		APTR	t1bs_LowPoint
*****useless		APTR	t1bs_LongEdge		; the long edge
*****so			APTR	t1bs_ShortHiEdge	; if some of this is 0, means it is a bad edge
*****CUT THEM!!!	APTR	t1bs_ShortLoEdge	
			WORD	t1bs_topY
			LONG	t1bs_hiXa
