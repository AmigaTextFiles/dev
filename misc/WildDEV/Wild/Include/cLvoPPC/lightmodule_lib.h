...
CallModule68kc(_LVOSetModuleTags,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#endif

#ifndef _LVOGetModuleTags	
#define _LVOGetModuleTags			-36
#define GetModuleTags(A0,A1) \
CallModule68kc(_LVOGetModuleTags,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#endif

#ifndef _LVOSetupModule	
#define _LVOSetupModule			-42
#define SetupModule(A0,A1) \
CallModule68kc(_LVOSetupModule,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#endif

#ifndef _LVOCloseModule	
#define _LVOCloseModule			-48
#define CloseModule(A0) \
CallModule68kc(_LVOCloseModule,LightModuleBase,0,0,((LONG *)A0),0)
#endif

#ifndef _LVORefreshModule	
#define _LVORefreshModule			-54
#define RefreshModule(A0) \
CallModule68kc(_LVORefreshModule,LightModuleBase,0,0,((LONG *)A0),0)
#endif

#ifndef _LVOLIGIlluminate	
#define _LVOLIGIlluminate			-60
#define LIGIlluminate(A0,A1) \
CallModule68kc(_LVOLIGIlluminate,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#endif
