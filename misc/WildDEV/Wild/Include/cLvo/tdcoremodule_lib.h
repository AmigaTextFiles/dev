...
CallModulePPCc(_LVOSetModuleTags,TDCoreModuleBase,0,0,((LONG *)A0),((LONG *)A1))
...
CallModulePPCc(_LVOGetModuleTags,TDCoreModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#ifdef USE_TAGS_STUBS
...
CallModulePPCc(_LVOSetupModule,TDCoreModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#ifdef USE_TAGS_STUBS
...
CallModulePPCc(_LVOCloseModule,TDCoreModuleBase,0,0,((LONG *)A0),0)
#endif

#ifndef _LVORefreshModule	
#define _LVORefreshModule			-54
#define RefreshModule(A0) \
CallModulePPCc(_LVORefreshModule,TDCoreModuleBase,0,0,((LONG *)A0),0)
#endif

#ifndef _LVOTDCRealyzeFrame	
#define _LVOTDCRealyzeFrame			-60
#define TDCRealyzeFrame(A0) \
CallModulePPCc(_LVOTDCRealyzeFrame,TDCoreModuleBase,0,0,((LONG *)A0),0)
#endif
