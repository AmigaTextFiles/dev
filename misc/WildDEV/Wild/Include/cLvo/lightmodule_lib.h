...
CallModulePPCc(_LVOSetModuleTags,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
...
CallModulePPCc(_LVOGetModuleTags,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#ifdef USE_TAGS_STUBS
...
CallModulePPCc(_LVOSetupModule,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#ifdef USE_TAGS_STUBS
...
CallModulePPCc(_LVOCloseModule,LightModuleBase,0,0,((LONG *)A0),0)
#endif

#ifndef _LVORefreshModule	
#define _LVORefreshModule			-54
#define RefreshModule(A0) \
CallModulePPCc(_LVORefreshModule,LightModuleBase,0,0,((LONG *)A0),0)
#endif

#ifndef _LVOLIGIlluminate	
#define _LVOLIGIlluminate			-60
#define LIGIlluminate(A0,A1) \
CallModulePPCc(_LVOLIGIlluminate,LightModuleBase,0,0,((LONG *)A0),((LONG *)A1))
#endif
