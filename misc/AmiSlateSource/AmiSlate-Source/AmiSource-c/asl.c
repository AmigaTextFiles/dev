...
int FileRequest(char *szMessage, char *szBuffer, char *szOKMessage, char *szDefaultDirParam, char *szDefaultFile, BOOL BSaveIt)
{
	...
	LONG lFlags = 0L;
	static char szDefaultDefaultDir[400] = "\0";
	char * szDefaultDir;
	...
	if (AslRequest(fr, NULL))
	{
		*szBuffer = '\0';
		...
		/* set default dir for next time, if it was not specified this time */
		if (szDefaultDirParam == NULL) strncpy(szDefaultDefaultDir,fr->rf_Dir,sizeof(szDefaultDefaultDir));
