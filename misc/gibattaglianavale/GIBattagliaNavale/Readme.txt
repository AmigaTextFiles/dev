Short:  GI Battaglia Navale 
Author: (http://www.iacosoft.com) (c) 2023, Giovanni Iacobelli 
Uploader: info@iacosoft.com Giovanni Iacobelli 
Type: dev/misc 
Architecture: m68k-amigaos >= 3.0
URL: http://www.iacosoft.com/home/amiga.asp#GIBATTAGLIA
Date: 2023-10-03
Version: 1.0
Kurz: GI Battaglia Navale


GI Battaglia Navale v1.0


INTRODUCTION

Battaglia Navale is a very popular pencil and paper game
all over the world.
Players must place their ships on the table
and each ship occupies a certain number of adjacent squares in
straight line (horizontal or vertical).
In this digital version the player will fight against
the PC.
The object of the game is to hit all of your opponent's ships.


USE
To launch it, just double click on its icon.
The software was written in C ++ and requires no installation.
The software, once launched, will open a window.

Tutorial:
https://youtu.be/ajrpk3csTrI
...
Battaglia Navale e' un gioco di carta e matita molto popolare 
in tutto il mondo.
I giocatori devono posizionare le proprie navi nella tabella 
e ogni nave occupa un certo numero di quadretti adiacenti in 
linea retta (orizzontale o verticale).
In questa versione digitale il giocatore combattera' contro 
il PC.
Lo scopo del gioco e' colpire tutte le navi dell’avversario.

USO
Per lanciarlo bastera' effettuare il consueto doppio click sulla sua 
icona. 
Il software e' stato scritto in C++ e non richiede installazione. 
Il software, una volta lanciato, aprira' una finestra. 
