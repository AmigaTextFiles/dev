...
#ifndef _NEURAL_NETWORK2_H_
#define _NEURAL_NETWORK2_H_
...
private:
  ...
  //  3 Matrices for each weight's gaussian offset - Mod. Random Optimization
  //  3 Matrices for each weight's bias - Modified Random Optimization
...
public:
  ...
  Neural_network2 (int number_inputs = 1, int number_hidden1 = 1,
                   int number_hidden2 = 1,
                   int number_outputs = 1, int backpropagation_flag = 1,
                   int random_optimization_flag = 0,
                   double range = 1.0, double variance = 0.01,
                   ...
                   double hdec = 0.0);
  Neural_network2 (String& filename, int& file_error, int backpropagation_flag = 1,
                   ...
                   double theta = 1.0, double phi = 0.0, double K = 0.0,
                   double hdec = 0.0);
  ~Neural_network2 () { deallocate_all_matrices ();}
