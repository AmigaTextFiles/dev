 ...
 */
typedef BOOL __asm (*DS_UPDATE_FCT)(register __a0 struct DataServer *, register __d0 ULONG, register __a1 APTR);
 ...
 */
typedef BOOL __asm (*DC_CONVERT)(register __a0 struct DataColumn *, register __a1 APTR);
 ...
 * If the function fails, FALSE is returned.
 */
typedef BOOL __asm (*DC_REVERT) (register __a0 struct DataColumn *, register __a1 STRPTR, register __a2 APTR);
 ...
 * A pointer to such a function can be passed using the Tag DBF_Validate to
 * the DBF_InitA() function.
 */
typedef BOOL __asm (*VALIDATE_RECORD)(register __a0 struct DataServer *);
