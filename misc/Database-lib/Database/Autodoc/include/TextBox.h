@DATABASE "TextBox.h"
@MASTER   "include:joinOS/misc/TextBox.h"
...
@{"MSF_BUTTONS" LINK File 53}  @{"MSF_TYPE" LINK File 40}   @{"MSG_ABORT" LINK File 44}        @{"MSG_ABORTRETRYIGNORE" LINK File 50}  @{"MSG_ASK" LINK File 36}
@{"MSG_INFO" LINK File 34}     @{"MSG_OK" LINK File 43}     @{"MSG_OKCANCEL" LINK File 46}     @{"MSG_RETRYCANCEL" LINK File 47}       @{"MSG_STOP" LINK File 37}
@{"MSG_WARN" LINK File 35}     @{"MSG_YESNO" LINK File 48}  @{"MSG_YESNOCANCEL" LINK File 49}  
