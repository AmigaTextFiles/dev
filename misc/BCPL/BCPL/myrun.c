...
/*
/* Author: Bill Kinnersley - Dec 18, 1987
/* Date: Mar 12, 1988
/* Mail: Physics Dept.
...
/* Here's where RUN finds the command line when called by EXECUTE
   ...
   Therefore this version of myrun.c will not work with EXECUTE */
	res2 = 0;
...
newsegarray[1],newsegarray[2],newsegarray[3],newsegarray[4]);*/
...
/* cli_init is passed to the newly created CLI, which calls it ala BCPL */
