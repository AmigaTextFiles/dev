...
/* Missing prototypes added by Matti Rintala 10.2.1994 */
int Push_dir ANSI((char *, char *, int));
void Error ANSI((char *, ...));
void Fatal ANSI((char *, ...));
void Warning ANSI((char *, ...));
int Make ANSI((CELLPTR, CELLPTR));

/* Amiga specific prototypes */
int touch_arch ANSI((char *, char *));
int utime ANSI((char *, time_t *));
void void_lcache ANSI((char *, char *));
int getpid ANSI((void));
