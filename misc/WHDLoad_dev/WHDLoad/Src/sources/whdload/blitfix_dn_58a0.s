...
;  :Version.	$Id: blitfix_dn_58a0.s 1.4 2000/04/16 16:46:17 jah Exp wepl $
;  :History.	15.03.99 created from blitfix_dn_58a5.s
...
.wait_d0	move.w	d0,($58,a0)
		bra.b	.wait
.wait_d1	move.w	d1,($58,a0)
		bra.b	.wait
.wait_d2	move.w	d2,($58,a0)
		bra.b	.wait
.wait_d3	move.w	d3,($58,a0)
		bra.b	.wait
.wait_d4	move.w	d4,($58,a0)
		bra.b	.wait
.wait_d5	move.w	d5,($58,a0)
		bra.b	.wait
.wait_d6	move.w	d6,($58,a0)
		bra.b	.wait
.wait_d7	move.w	d7,($58,a0)
.wait		BLITWAIT a0
	IFD INTBLITCHECK
		move.l	d0,-(a7)
		move	sr,d0
