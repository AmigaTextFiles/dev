...
;  :Version.	$Id: blitfix_dn_58a5.s 1.5 2000/04/16 16:46:17 jah Exp wepl $
;  :History.	14.09.98 created from blitfix_dn_58a6.s
;		14.09.98 now all registers are preserved
...
.wait_d0	move.w	d0,($58,a5)
		bra.b	.wait
.wait_d1	move.w	d1,($58,a5)
		bra.b	.wait
.wait_d2	move.w	d2,($58,a5)
		bra.b	.wait
.wait_d3	move.w	d3,($58,a5)
		bra.b	.wait
.wait_d4	move.w	d4,($58,a5)
		bra.b	.wait
.wait_d5	move.w	d5,($58,a5)
		bra.b	.wait
.wait_d6	move.w	d6,($58,a5)
		bra.b	.wait
.wait_d7	move.w	d7,($58,a5)
.wait		BLITWAIT a5
	IFD INTBLITCHECK
		move.l	d0,-(a7)
		move	sr,d0
