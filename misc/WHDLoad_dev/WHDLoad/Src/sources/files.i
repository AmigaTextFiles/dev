...
;  :Version.	$Id: files.i 1.5 2005/05/27 08:51:20 wepl Exp wepl $
...
*##	_AppendOnFile	buflen(d0) buffer(a0) filename(a1)
*##	_CheckFileExist	filename(a0) -> bool

	dc.b	"$Id: files.i 1.5 2005/05/27 08:51:20 wepl Exp wepl $"
	EVEN
